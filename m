...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 3806C767345
	for <lists+qemu-devel@lfdr.de>; Fri, 28 Jul 2023 19:27:16 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qPR5a-0007xA-ED; Fri, 28 Jul 2023 13:17:18 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <outgoing@sr.ht>) id 1qPR5Y-0007wO-4i
 for qemu-devel@nongnu.org; Fri, 28 Jul 2023 13:17:16 -0400
Received: from mail-b.sr.ht ([173.195.146.151])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <outgoing@sr.ht>) id 1qPR5V-0004n8-DO
 for qemu-devel@nongnu.org; Fri, 28 Jul 2023 13:17:15 -0400
Authentication-Results: mail-b.sr.ht; dkim=none 
Received: from git.sr.ht (unknown [173.195.146.142])
 by mail-b.sr.ht (Postfix) with ESMTPSA id BF0C511EF23;
 Fri, 28 Jul 2023 17:17:11 +0000 (UTC)
From: ~hyman <hyman@git.sr.ht>
Date: Thu, 08 Jun 2023 00:46:45 +0800
Subject: [PATCH QEMU 1/3] tests: Add migration dirty-limit capability test
MIME-Version: 1.0
Message-ID: <169056463135.22823.13693920045521586976-1@git.sr.ht>
X-Mailer: git.sr.ht
