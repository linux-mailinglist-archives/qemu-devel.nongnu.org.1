...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 961429105C6
	for <lists+qemu-devel@lfdr.de>; Thu, 20 Jun 2024 15:26:19 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1sKHnV-0000Ut-Kn; Thu, 20 Jun 2024 09:25:53 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <chalapathi.v@linux.ibm.com>)
 id 1sKHnS-0000So-97; Thu, 20 Jun 2024 09:25:50 -0400
Received: from mx0b-001b2d01.pphosted.com ([148.163.158.5])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <chalapathi.v@linux.ibm.com>)
 id 1sKHnM-0002VW-Es; Thu, 20 Jun 2024 09:25:50 -0400
Received: from pps.filterd (m0353722.ppops.net [127.0.0.1])
 by mx0a-001b2d01.pphosted.com (8.18.1.2/8.18.1.2) with ESMTP id 45KCdN4B003447;
 Thu, 20 Jun 2024 13:25:34 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com; h=
 message-id:date:mime-version:subject:to:cc:references:from
 :in-reply-to:content-type:content-transfer-encoding; s=pp1; bh=9
 BpFuqED613gN0vWBrGTuluYBJ8igIyxBGd2ghorP5s=; b=tjRNPFVlvFpONiUee
 
Received: from pps.reinject (localhost [127.0.0.1])
 by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 3yvk50gca4-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Thu, 20 Jun 2024 13:25:34 +0000 (GMT)
Received: from m0353722.ppops.net (m0353722.ppops.net [127.0.0.1])
 by pps.reinject (8.18.0.8/8.18.0.8) with ESMTP id 45KDNt7l018558;
 Thu, 20 Jun 2024 13:25:33 GMT
Received: from ppma22.wdc07v.mail.ibm.com
 (5c.69.3da9.ip4.static.sl-reverse.com [169.61.105.92])
 by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 3yvk50gca2-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Thu, 20 Jun 2024 13:25:33 +0000 (GMT)
Received: from pps.filterd (ppma22.wdc07v.mail.ibm.com [127.0.0.1])
 by ppma22.wdc07v.mail.ibm.com (8.17.1.19/8.17.1.19) with ESMTP id
 45KC5irB019567; Thu, 20 Jun 2024 13:25:33 GMT
Received: from smtprelay06.fra02v.mail.ibm.com ([9.218.2.230])
 by ppma22.wdc07v.mail.ibm.com (PPS) with ESMTPS id 3ysnp1phx1-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Thu, 20 Jun 2024 13:25:32 +0000
Received: from smtpav03.fra02v.mail.ibm.com (smtpav03.fra02v.mail.ibm.com
 [10.20.54.102])
 by smtprelay06.fra02v.mail.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id
 45KDPQ2T13107610
 (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
 Thu, 20 Jun 2024 13:25:28 GMT
Received: from smtpav03.fra02v.mail.ibm.com (unknown [127.0.0.1])
 by IMSVA (Postfix) with ESMTP id B553320043;
 Thu, 20 Jun 2024 13:25:26 +0000 (GMT)
Received: from smtpav03.fra02v.mail.ibm.com (unknown [127.0.0.1])
 by IMSVA (Postfix) with ESMTP id 04AC12004B;
 Thu, 20 Jun 2024 13:25:24 +0000 (GMT)
Received: from [9.43.35.209] (unknown [9.43.35.209])
 by smtpav03.fra02v.mail.ibm.com (Postfix) with ESMTP;
 Thu, 20 Jun 2024 13:25:23 +0000 (GMT)
Message-ID: <4f6c9668-aa12-426e-a03b-a6563c6b6b97@linux.ibm.com>
Date: Thu, 20 Jun 2024 18:55:21 +0530
MIME-Version: 1.0
User-Agent: Mozilla Thunderbird
Subject: Re: [PATCH v4 2/5] ppc/pnv: Extend SPI model
...
References: <20240617165419.8388-1-chalapathi.v@linux.ibm.com>
 <20240617165419.8388-3-chalapathi.v@linux.ibm.com>
 <b5660fa21aa653eb9522c797eb926586ccdae3cb.camel@linux.ibm.com>
Content-Language: en-US
From: Chalapathi V <chalapathi.v@linux.ibm.com>
In-Reply-To: <b5660fa21aa653eb9522c797eb926586ccdae3cb.camel@linux.ibm.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 7bit
X-TM-AS-GCONF: 00
X-Proofpoint-GUID: 9m8zU_2p4HcYOqGAzm6razwqQ5qz3iE8
X-Proofpoint-ORIG-GUID: yz1b103hoYgGFKu5S9muoQv6ghlWqj2o
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0
 ...
 scancount=1 engine=8.19.0-2405170001 definitions=main-2406200089
...
>> +         */
>> +        ecc_count = 0;
> I think you're not using the SPI_CLK_CFG_ECC_CTRL mask here because it
> also includes bit 28 and you only need bits 29 and 30.  It would be
> better if you split the SPI_CLK_CFG_ECC_CTRL mask into two masks like
> this:
>
> #define SPI_CLK_CFG_ECC_EN    PPC_BIT(28)
> #define SPI_CLK_CFG_ECC_CTRL  PPC_BITMASK(29, 30)
>
> Then, use SPI_CLK_CFG_ECC_CTRL below.
>
>> +        ecc_control = GETFIELD(PPC_BITMASK(29, 30), s-
...
>> @@ -36,6 +1067,10 @@ static uint64_t pnv_spi_xscom_read(void *opaque,
...
>>       case SPI_SEQ_OP_REG:
>>           val = 0;
>> @@ -97,6 +1132,8 @@ static void pnv_spi_xscom_write(void *opaque,
>> hwaddr addr,
...
>>   };
>>   
>> @@ -180,6 +1218,7 @@ static void pnv_spi_class_init(ObjectClass
>> *klass, void *data)
>>   
>>       dc->desc = "PowerNV SPI";
