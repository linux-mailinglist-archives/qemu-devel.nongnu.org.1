...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id D0B0487B1E9
	for <lists+qemu-devel@lfdr.de>; Wed, 13 Mar 2024 20:33:00 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rkUKM-0007O9-5a; Wed, 13 Mar 2024 15:31:50 -0400
...
Received: from mail-pf1-x42d.google.com ([2607:f8b0:4864:20::42d])
 ...
 (Exim 4.90_1) (envelope-from <dbarboza@ventanamicro.com>)
 id 1rkUJw-0002SQ-ID
 for qemu-devel@nongnu.org; Wed, 13 Mar 2024 15:31:32 -0400
Received: by mail-pf1-x42d.google.com with SMTP id
 d2e1a72fcca58-6e6c8b1ccd7so93829b3a.0
 for <qemu-devel@nongnu.org>; Wed, 13 Mar 2024 12:31:24 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=ventanamicro.com; s=google; t=1710358282; x=1710963082; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=WAQtiEYaEmXoE54cweN4qIPvZeaMFXARcRJhZYrN3gg=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1710358282; x=1710963082;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=WAQtiEYaEmXoE54cweN4qIPvZeaMFXARcRJhZYrN3gg=;
 b=
X-Gm-Message-State: AOJu0YyQkqaG+IioHmdJJ0jgYlGfKWWOoUOyLVqYkfbFtjd4iDCKT3Mq
 fprQXgo5E5ZIk7mTBEsCrYOZgia+IBgA0eRK1xHvXOwbT0ALFeyIeaXVYb4gVE3pwWy+HBFK+cX
 b
X-Google-Smtp-Source: AGHT+IH73gHALp7tGuzB4e+SGYuUVKutFVxnxFr9+okWFnLTXgl4hyLfD/Hp2YpP4MUqubYaLP/E5g==
X-Received: by 2002:a05:6a21:2d8d:b0:1a2:ba3f:1a70 with SMTP id
 ty13-20020a056a212d8d00b001a2ba3f1a70mr13420767pzb.60.1710358282300; 
 Wed, 13 Mar 2024 12:31:22 -0700 (PDT)
Received: from grind.dc1.ventanamicro.com ([177.94.15.159])
 by smtp.gmail.com with ESMTPSA id
 k10-20020a628e0a000000b006e5a915a9e7sm8912421pfe.10.2024.03.13.12.31.19
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 13 Mar 2024 12:31:21 -0700 (PDT)
...
Subject: [PATCH for-9.0 v13 5/8] target/riscv: remove 'over' brconds from
 vector trans
Date: Wed, 13 Mar 2024 16:30:56 -0300
Message-ID: <20240313193059.405329-6-dbarboza@ventanamicro.com>
...
-        gen_set_label(over);
     ...
     return false;
@@ -3695,8 +3593,6 @@ static bool int_ext_op(DisasContext *s, arg_rmr *a, uint8_t seq)
 {
     uint32_t data = 0;
...
-    tcg_gen_brcond_tl(TCG_COND_GEU, cpu_vstart, cpu_vl, over);
     ...
     static gen_helper_gvec_3_ptr * const fns[6][4] = {
         {
@@ -3741,7 +3637,6 @@ static bool int_ext_op(DisasContext *s, arg_rmr *a, uint8_t seq)
                        s->cfg_ptr->vlenb, data, fn);
