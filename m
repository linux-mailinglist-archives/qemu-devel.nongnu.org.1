...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id E14377EA4C1
	for <lists+qemu-devel@lfdr.de>; Mon, 13 Nov 2023 21:26:01 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1r2dUd-0002Ag-91; Mon, 13 Nov 2023 15:25:11 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from
 <BATV+4b2d4fa8b3c13737bab4+7386+infradead.org+dwmw2@casper.srs.infradead.org>)
 id 1r2dUR-00029k-Rv
 for qemu-devel@nongnu.org; Mon, 13 Nov 2023 15:25:01 -0500
Received: from casper.infradead.org ([2001:8b0:10b:1236::1])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from
 <BATV+4b2d4fa8b3c13737bab4+7386+infradead.org+dwmw2@casper.srs.infradead.org>)
 id 1r2dUO-0005UA-Ju
 for qemu-devel@nongnu.org; Mon, 13 Nov 2023 15:24:59 -0500
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 d=infradead.org; s=casper.20170209; h=MIME-Version:Content-Type:References:
 In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
 Content-Transfer-Encoding:Content-ID:Content-Description;
 bh=OK9GzqHp7Q1VdHxGxeuaRz5k0TWab3oktG9MJF/HByc=; b=FivzjXr56m7Xslkh3pRR+n6ag2
 ;
Received: from [12.186.190.1] (helo=u3832b3a9db3152.ant.amazon.com)
 by casper.infradead.org with esmtpsa (Exim 4.94.2 #2 (Red Hat Linux))
 id 1r2dUB-00GGOE-SB; Mon, 13 Nov 2023 20:24:44 +0000
Message-ID: <8cc48dd19e33be3c40ef6ff96bf7dd5d492186ae.camel@infradead.org>
Subject: Re: [QEMU][PATCHv2 0/8] Xen: support grant mappings.
From: David Woodhouse <dwmw2@infradead.org>
To: Juergen Gross <jgross@suse.com>, Stefano Stabellini
 <sstabellini@kernel.org>
Cc: Vikram Garhwal <vikram.garhwal@amd.com>, qemu-devel@nongnu.org, paul
 <paul@xen.org>
Date: Mon, 13 Nov 2023 15:24:40 -0500
...
> > > >=20
> > > > > This seems like a lot of code to replace that simpler option... i=
s
> > > > > there a massive performance win from doing it this way? Would we =
want
> > > > > to use this trick for the Xen PV backends (qdisk, qnic) *too*? Mi=
ght it
> > > > > make sense to introduce the simple version and *then* the optimis=
ation,
> > > > > with some clear benchmarking to show the win?
> > > >=20
> > > > This is not done for performance but for safety (as in safety
> > > > certifications, ISO 26262, etc.). This is to enable unprivileged vi=
rtio
> > > > backends running in a DomU. By unprivileged I mean a virtio backend=
 that
> > > > is unable to map arbitrary memory (the xenforeignmemory interface i=
s
> > > > prohibited).
> > > >=20
...
> > > > traditional Dom0 in the system at all. If you=C2=A0 would like to k=
now more:
> > > > https://www.youtube.com/watch?v=3DtisljY6Bqv0&list=3DPLYyw7IQjL-zHt=
pYtMpFR3KYdRn0rcp5Xn&index=3D8
> > >=20
> > > Yeah, I understand why we're using grant mappings instead of just
> > > directly having access via foreignmem mappings. That wasn't what I wa=
s
> > > confused about.
> > >=20
...
DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMxMTEzMjAyNDQwWjAvBgkqhkiG9w0BCQQxIgQgPnA+Vc6+
zV4jxp3yAehUxUQuGH3uzFqJN3nBhfMCl/kwgb0GCSsGAQQBgjcQBDGBrzCBrDCBljELMAkGA1UE
...

