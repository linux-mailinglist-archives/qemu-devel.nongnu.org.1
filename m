...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B97F98CA2E
	for <lists+qemu-devel@lfdr.de>; Wed,  2 Oct 2024 03:05:14 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1svnmI-0006sL-B0; Tue, 01 Oct 2024 21:03:42 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <dbarboza@ventanamicro.com>)
 id 1svnmF-0006rl-ES
 for qemu-devel@nongnu.org; Tue, 01 Oct 2024 21:03:39 -0400
...
Received: by mail-pl1-x636.google.com with SMTP id
 d9443c01a7336-20b0b5cdb57so2512865ad.1
 for <qemu-devel@nongnu.org>; Tue, 01 Oct 2024 18:03:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=ventanamicro.com; s=google; t=1727831013; x=1728435813; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=eSphQ8j9HfNw1y2Ei51gqEM3sRJkoD+aD4CFf5NioNA=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1727831013; x=1728435813;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=eSphQ8j9HfNw1y2Ei51gqEM3sRJkoD+aD4CFf5NioNA=;
 b=
X-Gm-Message-State: AOJu0YxCPWC1ZBqhOgzrneNTmLvD98999kKUB8gKk2SJ2xqR17rXJ2o1
 cse7ULtvvwIlvHje+5jk+SW3yfKMCC5pk+IlorODKPFP1t7cc1ufHVE46ug6HQyQIWjvz3OZDyN
 F
X-Google-Smtp-Source: AGHT+IEI1QefeuhVomkJXEuqAR3K08aRPPHFAjzy61uHkYqvR+PZYBBFqNZrvRE/GiBFf94gP2Fslw==
X-Received: by 2002:a17:902:e891:b0:205:8763:6c2d with SMTP id
 d9443c01a7336-20bc5b7a5eamr23329235ad.9.1727831012548; 
 Tue, 01 Oct 2024 18:03:32 -0700 (PDT)
Received: from grind.. (200-206-229-93.dsl.telesp.net.br. [200.206.229.93])
 by smtp.gmail.com with ESMTPSA id
 d9443c01a7336-20b37d63971sm76061295ad.4.2024.10.01.18.03.28
...
Subject: [PATCH v8 03/12] hw/riscv: add RISC-V IOMMU base emulation
Date: Tue,  1 Oct 2024 22:02:58 -0300
Message-ID: <20241002010314.1928515-4-dbarboza@ventanamicro.com>
...
---
 ...
 hw/riscv/riscv-iommu.c      | 2018 +++++++++++++++++++++++++++++++++++
 hw/riscv/riscv-iommu.h      |  126 +++
 hw/riscv/trace-events       |   14 +
 hw/riscv/trace.h            |    1 +
 include/hw/riscv/iommu.h    |   36 +
 meson.build                 |    1 +
 9 files changed, 2219 insertions(+)
...
index fbda17c987..32c5c8cde3 100644
--- a/meson.build
+++ b/meson.build
@@ -3416,6 +3416,7 @@ if have_system
     'hw/pci-host',
     'hw/ppc',
     'hw/rtc',
+    'hw/riscv',
