...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 62A4AB25C88
	for <lists+qemu-devel@lfdr.de>; Thu, 14 Aug 2025 09:04:02 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1umRyI-0002h8-F5; Thu, 14 Aug 2025 03:01:58 -0400
...
Received: from mail.loongson.cn ([114.242.206.163])
 ...
 (envelope-from <maobibo@loongson.cn>) id 1umRxv-0002ma-R1
 for qemu-devel@nongnu.org; Thu, 14 Aug 2025 03:01:40 -0400
Received: from loongson.cn (unknown [10.2.5.213])
 by gateway (Coremail) with SMTP id _____8BxnmvLiZ1oXaY_AQ--.15025S3;
 Thu, 14 Aug 2025 15:01:31 +0800 (CST)
Received: from localhost.localdomain (unknown [10.2.5.213])
 by front1 (Coremail) with SMTP id qMiowJAxT+a7iZ1o8s1KAA--.21880S7;
 Thu, 14 Aug 2025 15:01:30 +0800 (CST)
From: Bibo Mao <maobibo@loongson.cn>
To: Song Gao <gaosong@loongson.cn>,
 Richard Henderson <richard.henderson@linaro.org>
Cc: Jiaxun Yang <jiaxun.yang@flygoat.com>,
	qemu-devel@nongnu.org
Subject: [PATCH v2 5/8] target/loongarch: Use loongarch_tlb_search_cb in
 helper_invtlb_page_asid
Date: Thu, 14 Aug 2025 15:01:10 +0800
Message-Id: <20250814070113.351760-6-maobibo@loongson.cn>
...
X-CM-TRANSID: qMiowJAxT+a7iZ1o8s1KAA--.21880S7
...
index 913df7edf2..5864858ccf 100644
...
+
 ...
 {
     if (tlb_ps >= 64) {
@@ -542,30 +551,19 @@ void helper_invtlb_all_asid(CPULoongArchState *env, target_ulong info)
