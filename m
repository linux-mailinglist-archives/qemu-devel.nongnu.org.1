...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 4BE6CAF9B73
	for <lists+qemu-devel@lfdr.de>; Fri,  4 Jul 2025 22:01:48 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1uXma6-0005eU-0J; Fri, 04 Jul 2025 16:00:22 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <richard.henderson@linaro.org>)
 id 1uXma2-0005eE-7M
 for qemu-devel@nongnu.org; Fri, 04 Jul 2025 16:00:18 -0400
Received: from mail-oo1-xc34.google.com ([2607:f8b0:4864:20::c34])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <richard.henderson@linaro.org>)
 id 1uXmZt-0004qN-HH
 for qemu-devel@nongnu.org; Fri, 04 Jul 2025 16:00:16 -0400
Received: by mail-oo1-xc34.google.com with SMTP id
 006d021491bc7-61396c3f681so184557eaf.3
 for <qemu-devel@nongnu.org>; Fri, 04 Jul 2025 13:00:08 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linaro.org; s=google; t=1751659206; x=1752264006; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:message-id:date:subject:cc
 :to:from:from:to:cc:subject:date:message-id:reply-to;
 bh=mIgGwBXNBDif5gHgd9kys7ecrUDCdloEGad/wZrg5qg=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1751659206; x=1752264006;
 h=content-transfer-encoding:mime-version:message-id:date:subject:cc
 :to:from:x-gm-message-state:from:to:cc:subject:date:message-id
 :reply-to;
 bh=mIgGwBXNBDif5gHgd9kys7ecrUDCdloEGad/wZrg5qg=;
 b=
X-Gm-Message-State: AOJu0YwmM40fjaxXhT711BX4souppmcwqvg17mVI1U7i7huE2Y5q0NpH
 jn/6eg0m4QVQeokOnjtHr9pHbe3l4qNcbWmRbBRBnvJ7HjgQCaHIhQm6WSsBMbaz/c1Z+evBL0P
 Vx5gULpk=
X-Gm-Gg: 
 n3Bt8/Q/defeSlhTU4brLdfLoHejz4PCCk/3+Q/kek25okK4P
X-Google-Smtp-Source: AGHT+IGy7s1liJHxTBCj4ULix89uAV1up0fH+q3YhfvyahJZqLmuGPs+L+c6flX7CvsTY2O7GhGL/w==
X-Received: by 2002:a05:6820:1892:b0:613:872a:7b0b with SMTP id
 006d021491bc7-6138fd36602mr3132897eaf.1.1751659204822; 
 Fri, 04 Jul 2025 13:00:04 -0700 (PDT)
Received: from localhost.localdomain (fixed-187-189-51-143.totalplay.net.
 [187.189.51.143]) by smtp.gmail.com with ESMTPSA id
 006d021491bc7-6138e4ae2c6sm412259eaf.7.2025.07.04.13.00.02
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 04 Jul 2025 13:00:03 -0700 (PDT)
From: Richard Henderson <richard.henderson@linaro.org>
To: qemu-devel@nongnu.org
Cc: Fabiano Rosas <farosas@suse.de>
Subject: [PATCH] target/arm: Move cpregs code into cpregs.c
Date: Fri,  4 Jul 2025 14:00:01 -0600
Message-ID: <20250704200001.1058849-1-richard.henderson@linaro.org>
...
index 21a8d67edd..97d1adc960 100644
--- a/target/arm/internals.h
+++ b/target/arm/internals.h
@@ -1824,6 +1824,7 @@ void aarch64_max_tcg_initfn(Object *obj);
...
index c311d2df21..beb29d9977 100644
...
@@ -282,5201 +36,6 @@ static bool arm_pan_enabled(CPUARMState *env)
     }
 }
...
-
  ...
  */
@@ -5505,906 +64,6 @@ bool el_is_in_host(CPUARMState *env, int el)
...
@@ -6549,89 +208,6 @@ uint32_t sve_vqm1_for_el(CPUARMState *env, int el)
...
-
 ...
 {
@@ -6671,2844 +247,6 @@ void aarch64_set_svcr(CPUARMState *env, uint64_t new, uint64_t mask)
     }
 }
...
index 7aa81e30ab..eff711847b 100644
--- a/target/arm/meson.build
+++ b/target/arm/meson.build
@@ -23,6 +23,7 @@ arm_user_ss.add(when: 'TARGET_AARCH64', if_false: files(
 ))
