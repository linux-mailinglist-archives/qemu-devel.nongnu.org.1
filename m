...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 150407DEA24
	for <lists+qemu-devel@lfdr.de>; Thu,  2 Nov 2023 02:36:28 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qyMbi-0006uJ-LZ; Wed, 01 Nov 2023 21:34:51 -0400
...
Received: from mail-pl1-x62a.google.com ([2607:f8b0:4864:20::62a])
 ...
 (Exim 4.90_1) (envelope-from <richard.henderson@linaro.org>)
 id 1qyMb2-0001xN-Kw
 for qemu-devel@nongnu.org; Wed, 01 Nov 2023 21:34:13 -0400
Received: by mail-pl1-x62a.google.com with SMTP id
 d9443c01a7336-1cc58219376so3532325ad.1
 for <qemu-devel@nongnu.org>; Wed, 01 Nov 2023 18:34:08 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linaro.org; s=google; t=1698888847; x=1699493647; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=eE2aZpyuxb0N5OKnIBX+5KHEBhkmRjXaZfh5L77YXo0=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1698888847; x=1699493647;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=eE2aZpyuxb0N5OKnIBX+5KHEBhkmRjXaZfh5L77YXo0=;
 b=
X-Gm-Message-State: AOJu0YxupSnIVNfBhwxPQ+7E4k2KCJmTNETuMzamVzzT9IEbdKOFgsKe
 WkNqqc5n7diqGOZuLQ22xetl7ynjkSP2UvNb0IE=
X-Google-Smtp-Source: AGHT+IGOcyZaLsKdsFcHWStHtU6TWuuRS/z+fto9NtxmtKsf6zJM+c9LnLL1V9OmC4TmmtTx0VhhZA==
X-Received: by 2002:a17:903:1246:b0:1c7:495c:87e0 with SMTP id
 u6-20020a170903124600b001c7495c87e0mr21245685plh.37.1698888847231; 
 Wed, 01 Nov 2023 18:34:07 -0700 (PDT)
Received: from stoup.. ([71.212.149.95]) by smtp.gmail.com with ESMTPSA id
 t2-20020a1709027fc200b001a98f844e60sm1918125plb.263.2023.11.01.18.34.06
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 01 Nov 2023 18:34:06 -0700 (PDT)
From: Richard Henderson <richard.henderson@linaro.org>
To: qemu-devel@nongnu.org
Cc: deller@gmx.de
Subject: [PATCH v3 57/88] target/hppa: Remove TARGET_REGISTER_BITS
Date: Wed,  1 Nov 2023 18:29:45 -0700
Message-Id: <20231102013016.369010-58-richard.henderson@linaro.org>
...
index fcea715e7d..2c3e114b86 100644
...
@@ -3428,7 +3318,7 @@ static bool trans_shrp_imm(DisasContext *ctx, arg_shrp_imm *a)
...
+    } else if (width == TARGET_LONG_BITS) {
         ...
         assert(!a->d);
@@ -3538,7 +3428,7 @@ static bool trans_extr_imm(DisasContext *ctx, arg_extr_imm *a)
...
+    uint64_t mask0, mask1;
     ...
     if (!ctx->is_pa20 && a->d) {
@@ -3617,7 +3507,7 @@ static bool do_dep_sar(DisasContext *ctx, unsigned rt, unsigned c,
     unsigned rs = nz ? rt : 0;
...
+    uint64_t msb = 1ULL << (len - 1);
     ...
     shift = tcg_temp_new();
@@ -3734,7 +3624,7 @@ static bool trans_bl(DisasContext *ctx, arg_bl *a)
...
@@ -3862,7 +3752,7 @@ static bool trans_fid_f(DisasContext *ctx, arg_fid_f *a)
 {
     uint64_t ret;
