...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AB687B9E78
	for <lists+qemu-devel@lfdr.de>; Thu,  5 Oct 2023 16:07:29 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qoOqm-0000bT-Pm; Thu, 05 Oct 2023 09:57:12 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <vsementsov@yandex-team.ru>)
 id 1qoOqj-0000Vb-W7; Thu, 05 Oct 2023 09:57:10 -0400
Received: from forwardcorp1b.mail.yandex.net
 ([2a02:6b8:c02:900:1:45:d181:df01])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <vsementsov@yandex-team.ru>)
 id 1qoOqT-00023r-Jn; Thu, 05 Oct 2023 09:57:09 -0400
Received: from mail-nwsmtp-smtp-corp-main-11.iva.yp-c.yandex.net
 (mail-nwsmtp-smtp-corp-main-11.iva.yp-c.yandex.net
 [IPv6:2a02:6b8:c0c:7d8a:0:640:8fc3:0])
 by forwardcorp1b.mail.yandex.net (Yandex) with ESMTP id 16F8F61926;
 Thu,  5 Oct 2023 16:56:20 +0300 (MSK)
Received: from vsementsov-lin.. (unknown [2a02:6b8:b081:b584::1:2f])
 by mail-nwsmtp-smtp-corp-main-11.iva.yp-c.yandex.net (smtpcorp/Yandex) with
 ESMTPSA id qtYmoW4Oi4Y0-vULUFkeH; Thu, 05 Oct 2023 16:56:18 +0300
X-Yandex-Fwd: 1
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=yandex-team.ru;
 s=default; t=1696514178;
 bh=fen0Q3S5OyUDyMZwrcSY3D72b+KTbyp2RajCyBTNZUk=;
 h=Message-Id:Date:In-Reply-To:Cc:Subject:References:To:From;
 b=P35ZY5TA3Avyurntkb07nPPhXRMc7bpf8bwjhkRDU/+ugKeYQkL77hlnLEVXD4mGn
 YqQ5UptFf9dx5gbVpSSl4cVW9QfbNRvW2ZvxiqRpV8ZTI96JGjJdhKKSlJKQQZ2iub
 NpUEpyvYFjnPWf4eia1aXqjC1gl6ggL04fLILuRA=
...
Subject: [PATCH v6 14/14] python: use vm.cmd() instead of vm.qmp() where
 appropriate
Date: Thu,  5 Oct 2023 16:55:50 +0300
Message-Id: <20231005135550.331657-15-vsementsov@yandex-team.ru>
...
index 668d0c1e9c..d8c444ef35 100755
...
index 467faca43c..052d85fa00 100644
...
index 750e7d4d38..b57dd3a1d6 100755
...
index 478a1eaba2..5b74df799d 100755
--- a/tests/qemu-iotests/tests/nbd-multiconn
+++ b/tests/qemu-iotests/tests/nbd-multiconn
@@ -46,12 +46,11 @@ class TestNbdMulticonn(iotests.QMPTestCase):
...
-        self.assert_qmp(result, 'return', {})
     ...
     def tearDown(self):
         self.vm.shutdown()
@@ -72,12 +71,10 @@ class TestNbdMulticonn(iotests.QMPTestCase):
...
+        self.vm.cmd('nbd-server-stop')
     ...
     def add_export(self, name, writable=None):
         args = {
@@ -89,8 +86,7 @@ class TestNbdMulticonn(iotests.QMPTestCase):
