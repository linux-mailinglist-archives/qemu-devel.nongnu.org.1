...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id BA24DBFA59C
	for <lists+qemu-devel@lfdr.de>; Wed, 22 Oct 2025 08:54:41 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1vBSjV-0006JD-UL; Wed, 22 Oct 2025 02:54:06 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <ethan84@andestech.com>)
 id 1vBSjP-0006EC-HP; Wed, 22 Oct 2025 02:53:59 -0400
Received: from 60-248-80-70.hinet-ip.hinet.net ([60.248.80.70]
 helo=Atcsqr.andestech.com)
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <ethan84@andestech.com>)
 id 1vBSjD-0007P4-MG; Wed, 22 Oct 2025 02:53:59 -0400
Received: from mail.andestech.com (ATCPCS31.andestech.com [10.0.1.89])
 by Atcsqr.andestech.com with ESMTPS id 59M6qchP051690
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
 Wed, 22 Oct 2025 14:52:38 +0800 (+08)
 (envelope-from ethan84@andestech.com)
Received: from ethan84-VirtualBox (10.0.12.105) by ATCPCS31.andestech.com
 (10.0.1.89) with Microsoft SMTP Server (TLS) id 14.3.498.0; Wed, 22 Oct 2025
 14:52:38 +0800
Date: Wed, 22 Oct 2025 14:52:30 +0800
...
Message-ID: <aPh/LmPlKa92DHhN@ethan84-VirtualBox>
References: <20250312093735.1517740-1-ethan84@andestech.com>
 ...
 <6582f138-2ed3-45af-9fd1-99633b98532d@linux.alibaba.com>
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <6582f138-2ed3-45af-9fd1-99633b98532d@linux.alibaba.com>
User-Agent: Mutt/2.1.4 (2021-12-11)
X-Originating-IP: [10.0.12.105]
X-DKIM-Results: atcpcs31.andestech.com; dkim=none;
X-DNSRBL: 
X-SPAM-SOURCE-CHECK: pass
X-MAIL: Atcsqr.andestech.com 59M6qchP051690
...
On Tue, Oct 21, 2025 at 12:24:10PM +0800, LIU Zhiwei wrote:
> [EXTERNAL MAIL]
> 
> 
...
> 
> Thank you for your detailed explanation and for providing the supplementary information.
> 
> After a further review of the test cases, I agree that most of the functionalities in this implementation are well-covered.
> 
> My understanding now is that since the iopmp_translate() function does not have access to the length of the memory access, it's necessary to use an interface like dma_txn_info_push() to provide the transaction information, which is crucial for features such as partial-hit detection. This clarifies my previous confusion.
> 
> Regarding the cascading mode, I have one more question. When a transaction passes the check at stage 0, will the code proceed to check it against stage 1? I'm asking because I didn't see an explicit call to iopmp_translate() for the stage 1 IOPMP within the current logic. My assumption is that the actual memory access, after being approved by the stage 0, is what triggers the check at the stage 1 IOPMP . So it should check the stage 1 IOPMP entry array again. But I don't see it in the patch set. Could you please confirm if my understanding is correct?

Threre is no explicit call to iopmp_translate(). Similar to how a 
source device implicitly invokes iopmp_translate(). The downstream 
memory region of stage 0 IOPMP is the memory region of stage 1 
IOPMP in cascading mode. 

In other words, for a valid transaction, the memory access path would be:
stage 0 IOPMP → stage 1 IOPMP → destination memory region.

Since IOPMP layout can vary, I only included a single IOPMP device on the 
virt machine in this patch set. You can refer to my customized QEMU, which
demonstrates configurations with 2 IOPMP devices — either in parallel 
IOPMP(layout 1) or cascading IOPMP(layout 2) mode.
...
> 
> Signed-off-by: Ethan Chen <ethan84@andestech.com><mailto:ethan84@andestech.com><mailto:ethan84@andestech.com><mailto:ethan84@andestech.com>
> ---
> hw/misc/Kconfig               |    4 +
...
> + * this program.  If not, see <http://www.gnu.org/licenses/><http://www.gnu.org/licenses/><http://www.gnu.org/licenses/><http://www.gnu.org/licenses/>.
> + */
> +
