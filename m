...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A6A997C126
	for <lists+qemu-devel@lfdr.de>; Wed, 18 Sep 2024 23:06:33 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1sr1rW-0008C0-LZ; Wed, 18 Sep 2024 17:05:22 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <tavip@google.com>) id 1sr1rU-00088k-6n
 for qemu-devel@nongnu.org; Wed, 18 Sep 2024 17:05:20 -0400
Received: from mail-lf1-x12e.google.com ([2a00:1450:4864:20::12e])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <tavip@google.com>) id 1sr1rO-0001Lx-3r
 for qemu-devel@nongnu.org; Wed, 18 Sep 2024 17:05:19 -0400
Received: by mail-lf1-x12e.google.com with SMTP id
 2adb3069b0e04-5356a2460ceso39472e87.0
 for <qemu-devel@nongnu.org>; Wed, 18 Sep 2024 14:05:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=google.com; s=20230601; t=1726693511; x=1727298311; darn=nongnu.org;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:from:to:cc:subject:date
 :message-id:reply-to;
 bh=VhCs8U/VJl8+MzwezW0Tm/cPIE4WZMuPbkFb/jE8O3c=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1726693511; x=1727298311;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=VhCs8U/VJl8+MzwezW0Tm/cPIE4WZMuPbkFb/jE8O3c=;
 b=
X-Gm-Message-State: AOJu0YwfFEjY3yvYllZaATrJHtORHa9b55+lBzt3U8iRy8lbICnx8Sml
 PdeWAclu5BWk+CTNeq+sQ6YDWuVAgPHiNivssEuZAEsjbp+qOoBKEoTjE2dJoLx+PdfdEB9ZG/6
 sxE7hzndlcjLkdaCrwU9am5+zxig0t+nFx+Fy
X-Google-Smtp-Source: AGHT+IF+6Kc2jkxN3Ds5BjMQOM+FTflW5i8sv3DGmEsWnXALm+I0RMPUnEGlXA4ub82QfTAxb4+Ofi0DLiBRWBCHNSI=
X-Received: by 2002:a05:6512:2243:b0:530:baaa:ee10 with SMTP id
 2adb3069b0e04-536a6a505a8mr49460e87.3.1726693510587; Wed, 18 Sep 2024
 14:05:10 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <Zus1YzMOZD1ppO-2@mail.minyard.net>
From: Octavian Purdila <tavip@google.com>
Date: Wed, 18 Sep 2024 14:04:58 -0700
Message-ID: <CAGWr4cSvq+WnUQO3-8jyasQPhKGQCvzOYqRm5W8vRdhW9iU=xw@mail.gmail.com>
...
Received-SPF: pass client-ip=2a00:1450:4864:20::12e;
 envelope-from=tavip@google.com; helo=mail-lf1-x12e.google.com
...
On Wed, Sep 18, 2024 at 1:17=E2=80=AFPM Corey Minyard <corey@minyard.net> w=
rote:
>
...
> >
> > diff --git a/include/hw/arm/svd/flexcomm_i2c.h b/include/hw/arm/svd/fle=
xcomm_i2c.h
...
> > + *
> > + * Automatically generated by svd-gen-header.py from MIMXRT595S_cm33.x=
ml
> > + */
> > +#pragma once
> > +
...
> > +typedef enum {
> > +    /*
> > +     * Disabled. The I2C Master function is disabled. When disabled, t=
he Master
...
> > +typedef enum {
> > +    /*
> > +     * Disabled. The I2C slave function is disabled. When disabled, th=
e Slave
...
the
> > +     * Monitor function configuration settings are not changed, but th=
e Monitor
...
> > +    /*
> > +     * Enabled. The time-out function is enabled. Both types of time-o=
ut flags
...
> > +typedef enum {
> > +    /*
> > +     * Disabled. The Monitor function will not perform clock stretchin=
g.
...
> > +typedef enum {
> > +    /*
> > +     * In progress. Communication is in progress and the Master functi=
on is
> > +     * busy and cannot currently accept a command.
> > +     */
> > +    FLEXCOMM_I2C_STAT_MSTPENDING_IN_PROGRESS =3D 0,
> > +    /*
> > +     * Pending. The Master function needs software service or is in th=
e idle
...
> > +typedef enum {
> > +    /*
> > +     * Idle. The Master function is available to be used for a new tra=
nsaction.
> > +     */
> > +    FLEXCOMM_I2C_STAT_MSTSTATE_IDLE =3D 0,
> > +    /*
> > +     * Receive ready. Received data is available (in Master Receiver m=
ode).
> > +     * Address plus Read was previously sent and Acknowledged by a sla=
ve.
> > +     */
...
mode).
> > +     * Address plus Write was previously sent and Acknowledged by a sl=
ave.
> > +     */
...
> > +    /*
> > +     * Arbitration loss. The Master function has experienced an Arbitr=
ation
> > +     * Loss. At this point, the Master function has already stopped dr=
iving the
> > +     * bus and has gone into an idle state. Software can respond by do=
ing
> > +     * nothing, or by sending a Start (to attempt to gain control of t=
he bus
...
> > +     * specification. The Master interface has stopped driving the bus=
 and gone
> > +     * into an idle state; no action is required. A request for a Star=
t could
> > +     * be made, or software could attempt to make sure that the bus ha=
s not
> > +     * stalled.
> > +     */
...
> > +typedef enum {
> > +    /*
> > +     * In progress. The Slave function does not currently need softwar=
e
> > +     * service.
> > +     */
...
> > +    /* Slave receive. Received data is available (in Slave Receiver mo=
de). */
> > +    FLEXCOMM_I2C_STAT_SLVSTATE_SLAVE_RECEIVE =3D 1,
> > +    /* Slave transmit. Data can be transmitted (in Slave Transmitter m=
ode). */
...
> > +typedef enum {
> > +    /*
> > +     * Not deselected. The Slave function has not become deselected. T=
his does
...
> > +     * specifically caused by the SLVSEL flag changing from 1 to 0. Se=
e SLVSEL
...
> > +
> > +typedef enum {
> > +    /* No data. The Monitor function does not currently have data avai=
lable. */
...
> > +    /*
> > +     * Overrun. A Monitor data overrun has occurred. An overrun can on=
ly happen
> > +     * when Monitor clock stretching not enabled via the CFG[MONCLKSTR=
] bit.
...
> > +
> > +typedef enum {
> > +    /* Inactive. The Monitor function considers the I2C bus to be inac=
tive. */
...
> > +typedef enum {
> > +    /*
> > +     * Not idle. The I2C bus is not idle, or MONIDLE flag has been cle=
ared by
> > +     * software.
> > +     */
> > +    FLEXCOMM_I2C_STAT_MONIDLE_NOT_IDLE =3D 0,
> > +    /*
> > +     * Idle. The I2C bus has gone idle at least once, since the last t=
ime
...
> > +    /* A time-out will occur after 65,536 counts of the I2C function c=
lock. */
...
> > +typedef enum {
> > +    /* Not active */
> > +    FLEXCOMM_I2C_INTSTAT_EVENTTIMEOUT_EVENTTIMEOUT_ISNOTACTIVE =3D 0,
> > +    /* Active */
...
> > +    /*
> > +     * Continue. Informs the Master function to continue to the next o=
peration.
> > +     * This action must done after writing transmit data, reading rece=
ived
> > +     * data, or any other housekeeping related to the next bus operati=
on.
> > +     */
...
> > +    /*
> > +     * Start. A Start will be generated on the I2C bus at the next all=
owed
> > +     * time.
> > +     */
...
> > +    /*
> > +     * Stop. A Stop will be generated on the I2C bus at the next allow=
ed time,
...
> > +    /*
> > +     * Enable. A DMA request is generated for I2C master data operatio=
ns. When
> > +     * this I2C master is generating Acknowledge bits in Master Receiv=
er mode,
...
> > +typedef enum {
> > +    /*
> > +     * 2 clocks. Minimum SCL low time is 2 clocks of the I2C clock pre=
-divider.
> > +     */
> > +    FLEXCOMM_I2C_MSTTIME_MSTSCLLOW_MSTSCLLOW_2CLOCKS =3D 0,
> > +    /*
> > +     * 3 clocks. Minimum SCL low time is 3 clocks of the I2C clock pre=
-divider.
> > +     */
> > +    FLEXCOMM_I2C_MSTTIME_MSTSCLLOW_MSTSCLLOW_3CLOCKS =3D 1,
> > +    /*
> > +     * 4 clocks. Minimum SCL low time is 4 clocks of the I2C clock pre=
-divider.
> > +     */
> > +    FLEXCOMM_I2C_MSTTIME_MSTSCLLOW_MSTSCLLOW_4CLOCKS =3D 2,
> > +    /*
> > +     * 5 clocks. Minimum SCL low time is 5 clocks of the I2C clock pre=
-divider.
> > +     */
> > +    FLEXCOMM_I2C_MSTTIME_MSTSCLLOW_MSTSCLLOW_5CLOCKS =3D 3,
> > +    /*
> > +     * 6 clocks. Minimum SCL low time is 6 clocks of the I2C clock pre=
-divider.
> > +     */
> > +    FLEXCOMM_I2C_MSTTIME_MSTSCLLOW_MSTSCLLOW_6CLOCKS =3D 4,
> > +    /*
> > +     * 7 clocks. Minimum SCL low time is 7 clocks of the I2C clock pre=
-divider.
> > +     */
> > +    FLEXCOMM_I2C_MSTTIME_MSTSCLLOW_MSTSCLLOW_7CLOCKS =3D 5,
> > +    /*
> > +     * 8 clocks. Minimum SCL low time is 8 clocks of the I2C clock pre=
-divider.
> > +     */
> > +    FLEXCOMM_I2C_MSTTIME_MSTSCLLOW_MSTSCLLOW_8CLOCKS =3D 6,
> > +    /*
> > +     * 9 clocks. Minimum SCL low time is 9 clocks of the I2C clock pre=
-divider.
> > +     */
...
> > +    /*
> > +     * 3 clocks. Minimum SCL high time is 3 clocks of the I2C clock pr=
e-divider
> > +     * .
> > +     */
...
> > +    /*
> > +     * Continue. Informs the Slave function to continue to the next op=
eration,
...
> > +    /*
> > +     * NACK. Causes the Slave function to NACK the master when the sla=
ve is
...
> > +    /*
> > +     * Enabled. DMA requests are issued for I2C slave data transmissio=
n and
> > +     * reception.
> > +     */
...
> > +typedef enum {
> > +    /*
> > +     * Normal, non-automatic operation. If AUTONACK =3D 0, then a SlvP=
ending
...
> > +     * AUTOMATCHREAD will be ACKed immediately, allowing the master to=
 move on
> > +     * to the data bytes. If the address matches SLVADR0, but the dire=
ction
> > +     * does not match AUTOMATCHREAD, then the behavior will depend on =
the
> > +     * SLVADR0[AUTONACK] bit: if AUTONACK is set, then it will be Nack=
ed; if
...
> > +     * AUTOACK is set, and the address matches SLVADRn, and AUTOMATCHR=
EAD
...
> > +typedef enum {
> > +    /*
> > +     * No start detected. The Monitor function has not detected a Star=
t event
> > +     * on the I2C bus.
> > +     */
...
> > +typedef enum {
> > +    /*
> > +     * No repeated start detected. The Monitor function has not detect=
ed a
> > +     * Repeated Start event on the I2C bus.
> > +     */
> > +    FLEXCOMM_I2C_MONRXDAT_MONRESTART_NOT_DETECTED =3D 0,
> > +    /*
> > +     * Repeated start detected. The Monitor function has detected a Re=
peated
...
> > +    /*
> > +     * Not acknowledged. The data currently being provided by the Moni=
tor
...
> > +        }, \
> > +    }
> > diff --git a/include/hw/i2c/flexcomm_i2c.h b/include/hw/i2c/flexcomm_i2=
c.h
> > new file mode 100644
...
> > +            qemu_log_mask(LOG_GUEST_ERROR, "I2C monitoring not support=
ed");
> > +        }
> > +        break;
> > +    }
...
> > +                }
> > +            } else if (RF_RD(f, STAT, MSTSTATE) =3D=3D MSTSTATE_RXRDY)=
 {
> > +                uint8_t data =3D i2c_recv(s->bus);
> > +
> > +                RF_WR(f, MSTDAT, DATA, data);
...
> >      object_initialize_child(obj, "usart", &s->usart, TYPE_FLEXCOMM_USA=
RT);
> > +    object_initialize_child(obj, "i2c", &s->i2c, TYPE_FLEXCOMM_I2C);
> >  }
> >
> >  static void flexcomm_finalize(Object *obj)
> > @@ -250,6 +252,7 @@ static void flexcomm_realize(DeviceState *dev, Erro=
r **errp)
> >
...
> >      [ '-i', rt595, '-o', '@SOURCE_ROOT@/include/hw/arm/svd/flexcomm_us=
art.h',
> >      '-p', 'USART0', '-t', 'FLEXCOMM_USART'])
> > +  run_target('svd-flexcomm-i2c', command: svd_gen_header +
> > +    [ '-i', rt595, '-o', '@SOURCE_ROOT@/include/hw/arm/svd/flexcomm_i2=
c.h',
...
> > @@ -18,4 +18,5 @@ i2c_ss.add(when: 'CONFIG_PPC4XX', if_true: files('ppc=
4xx_i2c.c'))
...
> > @@ -51,3 +51,13 @@ npcm7xx_smbus_recv_fifo(const char *id, uint8_t rece=
ived, uint8_t expected) "%s
> >
...
> > +# flexcomm_i2c.c
> > +
> > +flexcomm_i2c_reg_read(const char *id, const char *reg_name, uint32_t a=
ddr, uint32_t val) " %s: %s[0x%04x] -> 0x%08x"
> > +flexcomm_i2c_reg_write(const char *id, const char *reg_name, uint32_t =
addr, uint32_t val) "%s: %s[0x%04x] <- 0x%08x"
> > +flexcomm_i2c_start(const char *id, uint8_t addr, uint8_t recv) "%s: 0x=
%02x %d"
