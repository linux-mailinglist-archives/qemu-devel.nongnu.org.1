...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 8DB477707B8
	for <lists+qemu-devel@lfdr.de>; Fri,  4 Aug 2023 20:22:10 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qRzPj-0001yH-FG; Fri, 04 Aug 2023 14:20:39 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <i.maximets@ovn.org>)
 id 1qRzPh-0001y1-FS
 for qemu-devel@nongnu.org; Fri, 04 Aug 2023 14:20:37 -0400
Received: from relay6-d.mail.gandi.net ([217.70.183.198])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <i.maximets@ovn.org>)
 id 1qRzPc-0005lJ-TT
 for qemu-devel@nongnu.org; Fri, 04 Aug 2023 14:20:37 -0400
Received: by mail.gandi.net (Postfix) with ESMTPSA id DC3D1C0003;
 Fri,  4 Aug 2023 18:20:29 +0000 (UTC)
From: Ilya Maximets <i.maximets@ovn.org>
To: Jason Wang <jasowang@redhat.com>
Cc: Paolo Bonzini <pbonzini@redhat.com>, Eric Blake <eblake@redhat.com>,
 Stefan Hajnoczi <stefanha@redhat.com>, qemu-devel@nongnu.org,
 Ilya Maximets <i.maximets@ovn.org>
Subject: [PATCH v3] net: add initial support for AF_XDP network backend
Date: Fri,  4 Aug 2023 20:21:10 +0200
Message-Id: <20230804182110.2627049-1-i.maximets@ovn.org>
...
@@ -2102,6 +2109,7 @@ config_host_data.set('CONFIG_HEXAGON_IDEF_PARSER', get_option('hexagon_idef_pars
...
index aaea5ddd77..1de42feaf4 100644
--- a/meson_options.txt
+++ b/meson_options.txt
...
index 29b98c3d4c..74fdaa6551 100644
--- a/qemu-options.hx
+++ b/qemu-options.hx
...
index 9da3fe299b..f18ea17cdf 100644
...
index 6d2fa38e3e..b898ede76b 100644
