...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 777C8A60109
	for <lists+qemu-devel@lfdr.de>; Thu, 13 Mar 2025 20:25:34 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1tsoAP-0002ue-59; Thu, 13 Mar 2025 15:24:29 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <adityag@linux.ibm.com>)
 id 1tsoA5-0002s0-He; Thu, 13 Mar 2025 15:24:09 -0400
Received: from mx0a-001b2d01.pphosted.com ([148.163.156.1])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <adityag@linux.ibm.com>)
 id 1tsoA3-0000tn-C4; Thu, 13 Mar 2025 15:24:09 -0400
Received: from pps.filterd (m0353729.ppops.net [127.0.0.1])
 by mx0a-001b2d01.pphosted.com (8.18.1.2/8.18.1.2) with ESMTP id 52DGo4ui030036;
 Thu, 13 Mar 2025 19:24:05 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com; h=cc
 :content-transfer-encoding:date:from:in-reply-to:message-id
 :mime-version:references:subject:to; s=pp1; bh=Uuw3/tigzX/MyyvAd
 mAPs71cWo8bjE7FB5tGCK9RVeE=; b=J9FLHJ3s6/Bmm6OhZRThSJUyTyMu4Gdo2
 
Received: from pps.reinject (localhost [127.0.0.1])
 by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 45byd8tak8-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Thu, 13 Mar 2025 19:24:05 +0000 (GMT)
Received: from m0353729.ppops.net (m0353729.ppops.net [127.0.0.1])
 by pps.reinject (8.18.0.8/8.18.0.8) with ESMTP id 52DJO5jT029735;
 Thu, 13 Mar 2025 19:24:05 GMT
Received: from ppma12.dal12v.mail.ibm.com
 (dc.9e.1632.ip4.static.sl-reverse.com [50.22.158.220])
 by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 45byd8tak5-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Thu, 13 Mar 2025 19:24:05 +0000 (GMT)
Received: from pps.filterd (ppma12.dal12v.mail.ibm.com [127.0.0.1])
 by ppma12.dal12v.mail.ibm.com (8.18.1.2/8.18.1.2) with ESMTP id 52DGBwIe015361;
 Thu, 13 Mar 2025 19:24:04 GMT
Received: from smtprelay03.fra02v.mail.ibm.com ([9.218.2.224])
 by ppma12.dal12v.mail.ibm.com (PPS) with ESMTPS id 45atspkfnk-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Thu, 13 Mar 2025 19:24:04 +0000
...
Received: from smtpav04.fra02v.mail.ibm.com (unknown [127.0.0.1])
 by IMSVA (Postfix) with ESMTP id 9C34720043;
 Thu, 13 Mar 2025 19:24:00 +0000 (GMT)
Received: from smtpav04.fra02v.mail.ibm.com (unknown [127.0.0.1])
 by IMSVA (Postfix) with ESMTP id 76E9E20040;
...
Subject: [PATCH v2 4/8] hw/ppc: Preserve memory regions registered for fadump
Date: Fri, 14 Mar 2025 00:53:37 +0530
Message-ID: <20250313192341.132171-5-adityag@linux.ibm.com>
...
X-TM-AS-GCONF: 00
X-Proofpoint-GUID: 3LM7W_MoQhEVbK0KTzRTgV5tpw7Sbf-2
X-Proofpoint-ORIG-GUID: xW-bIu__NIW2qYZhVPAdqvJiGt-Tbing
...
---
 hw/ppc/spapr_fadump.c         | 158 ++++++++++++++++++++++++++++++++--
 include/hw/ppc/spapr_fadump.h |  23 +++++
 2 files changed, 176 insertions(+), 5 deletions(-)

diff --git a/hw/ppc/spapr_fadump.c b/hw/ppc/spapr_fadump.c
index fedd2cde9a4f..db874fe13487 100644
--- a/hw/ppc/spapr_fadump.c
+++ b/hw/ppc/spapr_fadump.c
@@ -123,14 +123,162 @@ uint32_t do_fadump_register(SpaprMachineState *spapr, target_ulong args)
...
+    return true;
 ...
 /*
@@ -151,7 +299,7 @@ void trigger_fadump_boot(SpaprMachineState *spapr, target_ulong spapr_retcode)
     pause_all_vcpus();
...
index 071608cda088..d56ca1d6d651 100644
