...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id BACA57D1B0F
	for <lists+qemu-devel@lfdr.de>; Sat, 21 Oct 2023 07:41:27 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qu4eS-0002vH-2b; Sat, 21 Oct 2023 01:35:56 -0400
...
Received: by mail-qk1-x735.google.com with SMTP id
 af79cd13be357-7788ebea620so92859285a.3
 for <qemu-devel@nongnu.org>; Fri, 20 Oct 2023 22:35:46 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linaro.org; s=google; t=1697866545; x=1698471345; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=/UP3k7WCRkmPRh6bZlNkIAfN70TBHmuOR5dGifrhqeU=;
 b=
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=/UP3k7WCRkmPRh6bZlNkIAfN70TBHmuOR5dGifrhqeU=;
 b=
X-Gm-Message-State: AOJu0YwpbyxpxlDnJyRu2M4ylgxA6FfTlQoC24vri5oUYr788W8/nbvq
 QDRh3pxC9gu8hJdEH9ZqQWMe9Ki5BY0V3CJnaKA=
X-Google-Smtp-Source: AGHT+IHtCFbRIrYdivoEWLdoedkkPFiuBncZwBSH9iUAdD23QyZoktYxhS1D+ZakPzUL16lBA6eHWw==
X-Received: by 2002:a05:620a:bcb:b0:76e:f496:1930 with SMTP id
 s11-20020a05620a0bcb00b0076ef4961930mr4123912qki.43.1697866545581; 
 Fri, 20 Oct 2023 22:35:45 -0700 (PDT)
...
Subject: [PATCH v3 55/90] target/sparc: Move simple fp load/store to decodetree
Date: Fri, 20 Oct 2023 22:31:23 -0700
Message-Id: <20231021053158.278135-56-richard.henderson@linaro.org>
...
index 96c6e19fc9..30eeed84c2 100644
...
index df4a22eb04..e08cb8f0ff 100644
...
-
 ...
 {
     rd = QFPREG(rd);
@@ -2883,6 +2861,16 @@ static void gen_faligndata(TCGv dst, TCGv gsr, TCGv s1, TCGv s2)
 }
 #endif
...
@@ -3011,6 +2999,20 @@ static bool raise_priv(DisasContext *dc)
     return true;
 }
...
@@ -4755,6 +4757,68 @@ static bool do_casa(DisasContext *dc, arg_r_r_ri_asi *a, MemOp mop)
...
+
 #define CHECK_IU_FEATURE(dc, FEATURE)                      \
     if (!((dc)->def->features & CPU_FEATURE_ ## FEATURE))  \
         goto illegal_insn;
@@ -4769,7 +4833,8 @@ static void disas_sparc_legacy(DisasContext *dc, unsigned int insn)
...
@@ -5636,12 +5701,9 @@ static void disas_sparc_legacy(DisasContext *dc, unsigned int insn)
                 }
                 switch (xop) {
...
+                    g_assert_not_reached();  /* in decodetree */
 ...
 #ifdef TARGET_SPARC64
                     gen_address_mask(dc, cpu_addr);
@@ -5658,25 +5720,6 @@ static void disas_sparc_legacy(DisasContext *dc, unsigned int insn)
                                         dc->mem_idx, MO_TEUL | MO_ALIGN);
...
@@ -5686,11 +5729,9 @@ static void disas_sparc_legacy(DisasContext *dc, unsigned int insn)
                 }
                 switch (xop) {
...
+                    g_assert_not_reached();
                 case 0x25: /* stfsr, V9 stxfsr */
                     {
 #ifdef TARGET_SPARC64
@@ -5705,43 +5746,6 @@ static void disas_sparc_legacy(DisasContext *dc, unsigned int insn)
                                            dc->mem_idx, MO_TEUL | MO_ALIGN);
                     }
                     break;
-                case 0x26:
...
@@ -5788,19 +5792,9 @@ static void disas_sparc_legacy(DisasContext *dc, unsigned int insn)
  illegal_insn:
