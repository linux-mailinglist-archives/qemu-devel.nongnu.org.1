...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 92239753581
	for <lists+qemu-devel@lfdr.de>; Fri, 14 Jul 2023 10:49:58 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qKEU8-0002fu-UN; Fri, 14 Jul 2023 04:49:08 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <gaosong@loongson.cn>)
 id 1qKETr-0001sn-3x
 for qemu-devel@nongnu.org; Fri, 14 Jul 2023 04:48:53 -0400
Received: from mail.loongson.cn ([114.242.206.163])
 by eggs.gnu.org with esmtp (Exim 4.90_1)
 (envelope-from <gaosong@loongson.cn>) id 1qKETo-0005Eh-Fv
 for qemu-devel@nongnu.org; Fri, 14 Jul 2023 04:48:50 -0400
Received: from loongson.cn (unknown [10.2.5.185])
 by gateway (Coremail) with SMTP id _____8Cxrut0C7Fkts4EAA--.10613S3;
 Fri, 14 Jul 2023 16:46:44 +0800 (CST)
Received: from localhost.localdomain (unknown [10.2.5.185])
 by localhost.localdomain (Coremail) with SMTP id
 AQAAf8AxzyNYC7FkFOotAA--.22026S45; 
 Fri, 14 Jul 2023 16:46:43 +0800 (CST)
From: Song Gao <gaosong@loongson.cn>
To: qemu-devel@nongnu.org
Cc: richard.henderson@linaro.org
Subject: [PATCH v3 43/47] target/loongarch: Implement xvreplve xvinsve0
 xvpickve xvb{sll/srl}v
Date: Fri, 14 Jul 2023 16:46:11 +0800
Message-Id: <20230714084615.2448038-44-gaosong@loongson.cn>
...
X-CM-TRANSID: AQAAf8AxzyNYC7FkFOotAA--.22026S45
...
index 2ce7ce7ccb..d2ea70d8f0 100644
--- a/target/loongarch/insn_trans/trans_lsx.c.inc
+++ b/target/loongarch/insn_trans/trans_lsx.c.inc
@@ -4178,7 +4178,8 @@ static bool trans_vreplvei_d(DisasContext *ctx, arg_vv_i *a)
     return true;
 }
...
@@ -4187,85 +4188,103 @@ static bool gen_vreplve(DisasContext *ctx, arg_vvr *a, int vece, int bit,
...
index 333afa73af..e8d0b5d13b 100644
