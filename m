...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 7DBCA82707E
	for <lists+qemu-devel@lfdr.de>; Mon,  8 Jan 2024 15:00:25 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rMq9p-0002qG-1K; Mon, 08 Jan 2024 08:59:13 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <ines.varhol@telecom-paris.fr>)
 id 1rMq9m-0002pI-Bg; Mon, 08 Jan 2024 08:59:10 -0500
Received: from zproxy2.enst.fr ([2001:660:330f:2::dd])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <ines.varhol@telecom-paris.fr>)
 id 1rMq9i-000540-I3; Mon, 08 Jan 2024 08:59:10 -0500
Received: from localhost (localhost [IPv6:::1])
 by zproxy2.enst.fr (Postfix) with ESMTP id DAC848078A;
...
Received: from zproxy2.enst.fr ([IPv6:::1])
 ...
 id sjD8S7Jq1G4u; Mon,  8 Jan 2024 14:58:58 +0100 (CET)
Received: from localhost (localhost [IPv6:::1])
 by zproxy2.enst.fr (Postfix) with ESMTP id B950D80736;
 Mon,  8 Jan 2024 14:58:58 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.10.3 zproxy2.enst.fr B950D80736
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=telecom-paris.fr;
 s=A35C7578-1106-11E5-A17F-C303FDDA8F2E; t=1704722338;
 bh=OSCGPseFI5EgBJ0+FmVxdBaJCdqBS4obCguMNaQowkE=;
 h=From:To:Date:Message-ID:MIME-Version;
 b=VT/9k9pEhTznZ3ZdvtgIdx+KASx9csioo31FHCZ2oW8xaQiIxDL9kRJJUn3vDpK5T
 8rTYn9yMptL6RGND+JM7LNtAt3C00IYeicCmnvk7t3Hw1Y2V4u7H9WoADleGTJYkAG
 W9JP4ciUK15WhssluVNNOcwLl8p3cspi4WJpNkqI=
X-Virus-Scanned: amavis at enst.fr
Received: from zproxy2.enst.fr ([IPv6:::1])
 by localhost (zproxy2.enst.fr [IPv6:::1]) (amavis, port 10026) with ESMTP
 id EHmYaru-z0Tl; Mon,  8 Jan 2024 14:58:58 +0100 (CET)
Received: from inesv-Inspiron-3501.enst.fr (unknown
 [IPv6:2a04:8ec0:0:240:f2a4:b1b:1eac:479c])
 by zproxy2.enst.fr (Postfix) with ESMTPSA id 86085806F3;
 Mon,  8 Jan 2024 14:58:58 +0100 (CET)
...
Subject: [PATCH v6 1/2] hw/arm: Add minimal support for the STM32L4x5 SoC
Date: Mon,  8 Jan 2024 14:58:28 +0100
...
index 00ec1f7eca..da29dcc16e 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
...
index 660f49db49..35613b1d67 100644
--- a/hw/arm/Kconfig
+++ b/hw/arm/Kconfig
...
+
+    if (!memory_region_init_ram(&s->sram1, OBJECT(dev_soc), "SRAM1", SRA=
M1_SIZE,
+                                errp)) {
+        return;
+    }
...
ram1);
+
+    if (!memory_region_init_ram(&s->sram2, OBJECT(dev_soc), "SRAM2", SRA=
M2_SIZE,
+                                errp)) {
+        return;
+    }
