...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id A5CD5D06D4B
	for <lists+qemu-devel@lfdr.de>; Fri, 09 Jan 2026 03:15:44 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1ve21I-000131-HX; Thu, 08 Jan 2026 21:14:32 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <EwanHai-oc@zhaoxin.com>)
 id 1ve21G-00011Q-JP
 for qemu-devel@nongnu.org; Thu, 08 Jan 2026 21:14:30 -0500
Received: from mx1.zhaoxin.com ([210.0.225.12])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <EwanHai-oc@zhaoxin.com>)
 id 1ve21E-0002Ne-Aa
 for qemu-devel@nongnu.org; Thu, 08 Jan 2026 21:14:30 -0500
X-ASG-Debug-ID: 1767924863-086e2306f80c580001-jgbH7p
Received: from ZXSHMBX1.zhaoxin.com (ZXSHMBX1.zhaoxin.com [10.28.252.163]) by
 mx1.zhaoxin.com with ESMTP id CB4KKKiKvWnnQ5Xj (version=TLSv1.2
 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=NO);
 Fri, 09 Jan 2026 10:14:23 +0800 (CST)
...
Received: from ZXSHMBX1.zhaoxin.com ([fe80::936:f2f9:9efa:3c85]) by
 ...
 15.01.2507.059; Fri, 9 Jan 2026 10:14:23 +0800
X-Barracuda-RBL-Trusted-Forwarder: 10.28.252.163
...
Received: by ewan-server.zhaoxin.com (Postfix, from userid 1000)
 id 1EB262D0005C; Thu,  8 Jan 2026 21:10:28 -0500 (EST)
...
X-ASG-Orig-Subj: [PATCH v3 2/3] target/i386: Introduce Zhaoxin Shijidadao CPU
 model
Message-ID: <20260109021028.83985-3-ewanhai-oc@zhaoxin.com>
...
X-Moderation-Data: 1/9/2026 10:14:21 AM
X-Barracuda-Connect: ZXSHMBX1.zhaoxin.com[10.28.252.163]
X-Barracuda-Start-Time: 1767924863
X-Barracuda-Encrypted: ECDHE-RSA-AES128-GCM-SHA256
X-Barracuda-URL: https://mx2.zhaoxin.com:4443/cgi-mod/mark.cgi
X-Virus-Scanned: by bsmtpd at zhaoxin.com
X-Barracuda-Scan-Msg-Size: 8718
...
- v2 (alias: Shijidadao-Client) - Client variant with different FMS
  (model=3D0x6b, stepping=3D1) and without CORE_CAPABILITY features
...
+            {
+                .version =3D 1,
+                .alias =3D "Shijidadao-Server",
+            },
+            {
+                .version =3D 2,
+                .alias =3D "Shijidadao-Client",
+                .note =3D "client variant",
+                .props =3D (PropValue[]) {
+                    { "model", "0x6b" },
+                    { "stepping", "1" },
+                    { "core-capability", "off" },
