...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id E35DB7D66D3
	for <lists+qemu-devel@lfdr.de>; Wed, 25 Oct 2023 11:31:15 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qvaCw-00059M-LV; Wed, 25 Oct 2023 05:29:46 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <gaosong@loongson.cn>)
 id 1qvaCv-000595-Hb
 for qemu-devel@nongnu.org; Wed, 25 Oct 2023 05:29:45 -0400
Received: from mail.loongson.cn ([114.242.206.163])
 by eggs.gnu.org with esmtp (Exim 4.90_1)
 (envelope-from <gaosong@loongson.cn>) id 1qvaCd-0001dM-Qt
 for qemu-devel@nongnu.org; Wed, 25 Oct 2023 05:29:45 -0400
Received: from loongson.cn (unknown [10.2.5.185])
 by gateway (Coremail) with SMTP id _____8DxRvHq3zhlCoA0AA--.36944S3;
 Wed, 25 Oct 2023 17:29:14 +0800 (CST)
Received: from localhost.localdomain (unknown [10.2.5.185])
 by localhost.localdomain (Coremail) with SMTP id
 AQAAf8BxK9zp3zhlpuExAA--.39806S3; 
 Wed, 25 Oct 2023 17:29:13 +0800 (CST)
From: Song Gao <gaosong@loongson.cn>
To: peter.maydell@linaro.org
Cc: qemu-devel@nongnu.org, richard.henderson@linaro.org, philmd@linaro.org,
 alex.bennee@linaro.org, maobibo@loongson.cn
Subject: [risu PATCH 1/5] loongarch: Add LSX instructions
Date: Wed, 25 Oct 2023 17:29:11 +0800
Message-Id: <20231025092915.902814-2-gaosong@loongson.cn>
...
X-CM-TRANSID: AQAAf8BxK9zp3zhlpuExAA--.39806S3
...
---
 loongarch64.risu | 807 +++++++++++++++++++++++++++++++++++++++++++++++
 1 file changed, 807 insertions(+)

diff --git a/loongarch64.risu b/loongarch64.risu
index d625a12..78ccee3 100644
--- a/loongarch64.risu
+++ b/loongarch64.risu
@@ -610,3 +610,810 @@ fstx_s LA64 0011 10000011 10000 rk:5 rj:5 fd:5 \
