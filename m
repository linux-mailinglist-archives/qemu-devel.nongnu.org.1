...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C712A6878E
	for <lists+qemu-devel@lfdr.de>; Wed, 19 Mar 2025 10:11:43 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1tupRC-0002Rb-3X; Wed, 19 Mar 2025 05:10:10 -0400
...
Received: from movement by movementarian.org with local (Exim 4.95)
 (envelope-from <movement@movementarian.org>) id 1tupR2-001I7C-Eg;
 Wed, 19 Mar 2025 09:10:00 +0000
Date: Wed, 19 Mar 2025 09:10:00 +0000
...
Subject: Re: [PATCH for-10.1 01/32] vfio: Move vfio_mig_active() into
 migration.c
Message-ID: <Z9qJ6KMNwXk2xHML@movementarian.org>
