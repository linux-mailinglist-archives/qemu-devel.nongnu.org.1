...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B8A776FB36
	for <lists+qemu-devel@lfdr.de>; Fri,  4 Aug 2023 09:32:42 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qRpHX-0003jz-Vx; Fri, 04 Aug 2023 03:31:32 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <akihiko.odaki@gmail.com>)
 id 1qRpHD-0003jg-21
 for qemu-devel@nongnu.org; Fri, 04 Aug 2023 03:31:12 -0400
Received: from mail-pl1-x62e.google.com ([2607:f8b0:4864:20::62e])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <akihiko.odaki@gmail.com>)
 id 1qRpH8-000692-6l
 for qemu-devel@nongnu.org; Fri, 04 Aug 2023 03:31:10 -0400
Received: by mail-pl1-x62e.google.com with SMTP id
 d9443c01a7336-1bb119be881so15539245ad.3
 for <qemu-devel@nongnu.org>; Fri, 04 Aug 2023 00:31:05 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20221208; t=1691134264; x=1691739064;
 h=content-transfer-encoding:in-reply-to:from:references:cc:to
 :content-language:subject:user-agent:mime-version:date:message-id
 :from:to:cc:subject:date:message-id:reply-to;
 bh=qn14VqoMyo07LQxsG5xzebUFTm2Fiq+hDJ4POXQ0AwM=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20221208; t=1691134264; x=1691739064;
 h=content-transfer-encoding:in-reply-to:from:references:cc:to
 :content-language:subject:user-agent:mime-version:date:message-id
 :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
 bh=qn14VqoMyo07LQxsG5xzebUFTm2Fiq+hDJ4POXQ0AwM=;
 b=
X-Gm-Message-State: AOJu0Ywmlnw5WT4XGD3nK7oN+lS99UyiqaNYr6MIuGFPa+4O1j+EfN/n
 Ovq+76/VOGqsYFMjJFBEbJU=
X-Google-Smtp-Source: AGHT+IFepThVXmbejsdTJ7Rwx5Zp1alln13qh9ZPmlS1xiArrbb9VCX+YREVO1v/ruWTbtWPeCCLiw==
X-Received: by 2002:a17:902:eb42:b0:1b8:6a09:9cf9 with SMTP id
 i2-20020a170902eb4200b001b86a099cf9mr1023485pli.26.1691134263673; 
 Fri, 04 Aug 2023 00:31:03 -0700 (PDT)
Received: from ?IPV6:2400:4050:a840:1e00:78d2:b862:10a7:d486?
 ([2400:4050:a840:1e00:78d2:b862:10a7:d486])
 by smtp.gmail.com with ESMTPSA id
 p16-20020a170902e75000b001bba3a4888bsm1055786plf.102.2023.08.04.00.31.01
 (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
 Fri, 04 Aug 2023 00:31:03 -0700 (PDT)
Message-ID: <ecc47b24-4339-f400-4641-f32a33130c90@gmail.com>
Date: Fri, 4 Aug 2023 16:31:00 +0900
MIME-Version: 1.0
User-Agent: Mozilla Thunderbird
Subject: Re: [PATCH v3 6/9] gfxstream + rutabaga: add initial support for
 gfxstream
...
References: <20230803235502.373-1-gurchetansingh@google.com>
 <20230803235502.373-7-gurchetansingh@google.com>
From: Akihiko Odaki <akihiko.odaki@gmail.com>
In-Reply-To: <20230803235502.373-7-gurchetansingh@google.com>
...
On 2023/08/04 8:54, Gurchetan Singh wrote:
...
You shouldn't need an explict cast too. Please review *all* casts and 
...
You do no longer need braces here.
...
> +    CHECK(!result, cmd);
> +    /*
> +     * It's necessary to move res into resource since both g_steal_pointer(..)
> +     * and QTAILQ_INSERT_HEAD(..) are macros.  Compilation errors occur with a
> +     * single line statement.
> +     */
> +    resource = g_steal_pointer(&res);
> +    QTAILQ_INSERT_HEAD(&g->reslist, resource, next);

I tried to compile with a single line statement but the compilation 
error was not caused by both of g_steal_pointer() and 
QTAILQ_INSERT_HEAD() being macros.

The real problem is that g_steal_pointer() returns void *. An implicit 
cast happens if you assign to struct virtio_gpu_simple_resource *, but 
it won't if you do in one line.

And it won't work even if you manage to avoid the compilation error by 
explicitly casting since QTAILQ_INSERT_HEAD() refers to the third 
parameter several times without assigning it to a local variable. The 
first reference will steal the pointer and the later ones will fail.

That said, I still believe having two different variables with names 
semantically identical (res and resource) is undesierable. Now I suggest:
...
What will happen in 3)? For example what will happen if you use Rutabaga 
on X.org desktop?
...
> +
> +        if (runtime_dir) {
> +            sprintf_result = snprintf(&wayland_socket_path[0], UNIX_PATH_MAX,
> +                                      "%s%s%s", runtime_dir, "/", display);

Just write wayland_socket_path instead of &wayland_socket_path[0].
Also use "%s/%s" as the format.

> +        }
> +    } else {
> +        sprintf_result = snprintf(&wayland_socket_path[0], UNIX_PATH_MAX,
> +                                  "%s", vr->wayland_socket_path);

Why don't you pass vr->wayland_socket_path as is to Rutabaga instead of 
copying the content with snprintf()?

> +        /*
> +         * If the user explicitly specified an invalid Wayland socket and
> +         * sprintf fails, error out.
> +         */
> +        if (sprintf_result < 0 || sprintf_result >= UNIX_PATH_MAX) {
> +            error_setg(errp, "wayland socket %s malformed",
> +                       vr->wayland_socket_path);
> +            return -EINVAL;
> +        }
> +    }
> +
...
You don't need to allocate it on a heap. Just use an automatic variable.

> +            channels.num_channels = 1;
> +            channels.channels[0].channel_name = &wayland_socket_path[0]; > +            channels.channels[0].channel_type = 
