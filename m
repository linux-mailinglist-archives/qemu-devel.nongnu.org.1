...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 6E6D5B1A69C
	for <lists+qemu-devel@lfdr.de>; Mon,  4 Aug 2025 17:52:50 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1uixUO-0002hR-Hi; Mon, 04 Aug 2025 11:52:40 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mohamed@unpredictable.fr>)
 id 1uiw76-0005sZ-MM
 for qemu-devel@nongnu.org; Mon, 04 Aug 2025 10:24:33 -0400
Received: from p-east3-cluster4-host4-snip4-4.eps.apple.com ([57.103.84.37]
 helo=outbound.qs.icloud.com)
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mohamed@unpredictable.fr>)
 id 1uiw6t-0000Sd-7m
 for qemu-devel@nongnu.org; Mon, 04 Aug 2025 10:24:26 -0400
Received: from outbound.qs.icloud.com (unknown [127.0.0.2])
 by p00-icloudmta-asmtp-us-east-2d-10-percent-0 (Postfix) with ESMTPS id
 DA07C18001E9; Mon,  4 Aug 2025 14:24:06 +0000 (UTC)
Dkim-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=unpredictable.fr;
 s=sig1; bh=PgdMsH5bQwRo3IUiZKbnzV3RrP/jKfr+nWtotr/IL+4=;
 h=From:To:Subject:Date:Message-Id:MIME-Version:x-icloud-hme;
 b=
X-Client-IP: 46.189.47.18
Received: from localhost.localdomain (qs-asmtp-me-k8s.p00.prod.me.com
 [17.57.155.37])
 by p00-icloudmta-asmtp-us-east-2d-10-percent-0 (Postfix) with ESMTPSA id
 C63141800149; Mon,  4 Aug 2025 14:24:03 +0000 (UTC)
...
Subject: [PATCH v4 13/17] whpx: arm64: clamp down IPA size
Date: Mon,  4 Aug 2025 16:23:22 +0200
Message-Id: <20250804142326.72947-14-mohamed@unpredictable.fr>
X-Mailer: git-send-email 2.39.5 (Apple Git-154)
In-Reply-To: <20250804142326.72947-1-mohamed@unpredictable.fr>
References: <20250804142326.72947-1-mohamed@unpredictable.fr>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Proofpoint-Spam-Details-Enc: AW1haW4tMjUwODA0MDA4MCBTYWx0ZWRfX5Oei8xqdDM9h
 
X-Proofpoint-GUID: 4uugS4FmB9nR6e15Xh30nH607VOtvQHI
X-Proofpoint-ORIG-GUID: 4uugS4FmB9nR6e15Xh30nH607VOtvQHI
...
Received-SPF: pass client-ip=57.103.84.37;
...
index 0039f6a12b..f90c3fc113 100644
--- a/hw/arm/virt.c
+++ b/hw/arm/virt.c
@@ -70,6 +70,7 @@
 #include "hw/irq.h"
...
index 2e32debf6f..ed447bf014 100644
...
@@ -655,6 +656,40 @@ static void whpx_cpu_update_state(void *opaque, bool running, RunState state)
 {
 }
