...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 0BC98711F17
	for <lists+qemu-devel@lfdr.de>; Fri, 26 May 2023 07:07:58 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1q2Peh-0001yS-6h; Fri, 26 May 2023 01:06:23 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <jeuk20.kim@samsung.com>)
 id 1q2Pee-0001xa-CL
 for qemu-devel@nongnu.org; Fri, 26 May 2023 01:06:20 -0400
...
Received: from epcas2p2.samsung.com (unknown [182.195.41.54])
 ...
 20230526050607epoutp026c5d6c000c45b0b5bd54b2c499cc3c19~imR6tp29I2575525755epoutp02T
 for <qemu-devel@nongnu.org>; Fri, 26 May 2023 05:06:07 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout2.samsung.com
 20230526050607epoutp026c5d6c000c45b0b5bd54b2c499cc3c19~imR6tp29I2575525755epoutp02T
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
 s=mail20170921; t=1685077567;
 bh=1E06JznIKvi6qPEyoY2lCTiW3+y1yqDx+49Tgud/7Nk=;
 h=Subject:Reply-To:From:To:CC:Date:References:From;
 b=mZMny7Q8sva98tvptf3v4NYELGuiKP0dEA3gXwf42EzkcN4Wrsa1t7VJznVwH4u3v
 Z0yqbkqjvYNgZZmTglo5c5hGEjicAQQSUjZzNvbuAc6iEC4c5BCgonPQdake+VIWdf
 Xsew+7G5WTU2dt75EDr0bHIoFF+vLaYJ1SyjGwik=
Received: from epsnrtp2.localdomain (unknown [182.195.42.163]) by
 epcas2p4.samsung.com (KnoxPortal) with ESMTP id
 20230526050606epcas2p4563acd82bc71db16082bcd97b4a606bf~imR5z4zGJ1890818908epcas2p4W;
 Fri, 26 May 2023 05:06:06 +0000 (GMT)
Received: from epsmges2p3.samsung.com (unknown [182.195.36.101]) by
 epsnrtp2.localdomain (Postfix) with ESMTP id 4QSCYn6BHZz4x9Q6; Fri, 26 May
 2023 05:06:05 +0000 (GMT)
X-AuditID: b6c32a47-eedff70000001ce0-c0-64703e3dd4cf
Received: from epcas2p3.samsung.com ( [182.195.41.55]) by
 epsmges2p3.samsung.com (Symantec Messaging Gateway) with SMTP id
 9F.41.07392.D3E30746; Fri, 26 May 2023 14:06:05 +0900 (KST)
Mime-Version: 1.0
Subject: [PATCH 2/3] hw/ufs: Support for Query Transfer Requests
...
X-Msg-Type: PERSONAL
X-Reply-Demand: N
Message-ID: <20230526050605epcms2p547d7fb1e130f8e9b9e1b31c6dabef189@epcms2p5>
Date: Fri, 26 May 2023 14:06:05 +0900
X-CMS-MailID: 20230526050605epcms2p547d7fb1e130f8e9b9e1b31c6dabef189
...
X-CPGSPASS: Y
X-CPGSPASS: Y
X-Brightmail-Tracker: H4sIAAAAAAAAA+NgFmplk+LIzCtJLcpLzFFi42LZdljTXNfWriDF4OBxXYuXhzQtruw/z2jx
 ...
 
DLP-Filter: Pass
X-CFilter-Loop: Reflected
X-CMS-RootMailID: 20230526050605epcms2p547d7fb1e130f8e9b9e1b31c6dabef189
References: <CGME20230526050605epcms2p547d7fb1e130f8e9b9e1b31c6dabef189@epcms2p5>
...
index 122ce05411..125fd179f8 100644
--- a/hw/ufs/ufs.c
+++ b/hw/ufs/ufs.c
@@ -19,6 +19,233 @@
...
@@ -199,6 +459,631 @@ static const MemoryRegionOps ufs_mmio_ops = {
     },
 };
...
@@ -232,6 +1117,23 @@ static void ufs_init_pci(UfsHc *u, PCIDevice *pci_dev)
...
+
 ...
 {
     uint32_t cap = 0;
@@ -249,6 +1151,54 @@ static void ufs_init_hc(UfsHc *u)
...
@@ -259,10 +1209,24 @@ static void ufs_realize(PCIDevice *pci_dev, Error **errp)
         return;
     }
...
@@ -281,6 +1245,7 @@ static void ufs_class_init(ObjectClass *oc, void *data)
