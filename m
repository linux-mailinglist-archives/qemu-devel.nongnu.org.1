...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 7403495AFAC
	for <lists+qemu-devel@lfdr.de>; Thu, 22 Aug 2024 09:54:07 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1sh2cj-0002ql-Cm; Thu, 22 Aug 2024 03:52:49 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from
 <BATV+0692cd3b886892db1595+7669+infradead.org+dwmw2@casper.srs.infradead.org>)
 id 1sh2cc-0002q3-Jl
 for qemu-devel@nongnu.org; Thu, 22 Aug 2024 03:52:43 -0400
Received: from casper.infradead.org ([2001:8b0:10b:1236::1])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from
 <BATV+0692cd3b886892db1595+7669+infradead.org+dwmw2@casper.srs.infradead.org>)
 id 1sh2cX-00089G-JU
 for qemu-devel@nongnu.org; Thu, 22 Aug 2024 03:52:42 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 d=infradead.org; s=casper.20170209; h=MIME-Version:Content-Type:Date:Cc:To:
 From:Subject:Message-ID:Sender:Reply-To:Content-Transfer-Encoding:Content-ID:
 Content-Description:In-Reply-To:References;
 bh=/5kw97Jbrc19vXfNUnK8fCh43mU4q3spP1oOgqBI0ag=; b=Mt0qX3MzNq9+Mt34f24CRserOu
 ;
Received: from [2001:8b0:10b:5:74d1:c74:54fa:bb6f]
 (helo=u3832b3a9db3152.ant.amazon.com)
 by casper.infradead.org with esmtpsa (Exim 4.97.1 #2 (Red Hat Linux))
 id 1sh2cN-0000000AFXv-3HCs; Thu, 22 Aug 2024 07:52:28 +0000
Message-ID: <22927a046263c84ee76043aacdb67e8f009662ba.camel@infradead.org>
Subject: [PATCH v3] hw/acpi: Add vmclock device
...
Date: Thu, 22 Aug 2024 08:52:27 +0100
Content-Type: multipart/signed; micalg="sha-256";
 protocol="application/pkcs7-signature"; 
 boundary="=-SPV4HaqOcrfCl++SBhTC"
User-Agent: Evolution 3.44.4-0ubuntu2 
MIME-Version: 1.0
X-SRS-Rewrite: SMTP reverse-path rewritten from <dwmw2@infradead.org> by
 casper.infradead.org. See http://www.infradead.org/rpr.html
Received-SPF: none client-ip=2001:8b0:10b:1236::1;
 envelope-from=BATV+0692cd3b886892db1595+7669+infradead.org+dwmw2@casper.srs.infradead.org;
...
Guest support:
https://lore.kernel.org/qemu-devel/410bbef9771ef8aa51704994a70d5965e367e2ce=
.camel@infradead.org/
...
+    Object *vmgenid_dev, *vmclock_dev;
     ...
     char *oem_table_id;
=20
@@ -2578,6 +2579,13 @@ void acpi_build(AcpiBuildTables *tables, MachineStat=
e *machine)
...
DQEHATAcBgkqhkiG9w0BCQUxDxcNMjQwODIyMDc1MjI3WjAvBgkqhkiG9w0BCQQxIgQg24DV0JLl
QKXbuTzNukNtBf1RcS9RSC7Apx6F9Q5KG0Uwgb0GCSsGAQQBgjcQBDGBrzCBrDCBljELMAkGA1UE
...

