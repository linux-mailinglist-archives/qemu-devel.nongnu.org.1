...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id E69997D3D80
	for <lists+qemu-devel@lfdr.de>; Mon, 23 Oct 2023 19:26:37 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1quygJ-0005q8-15; Mon, 23 Oct 2023 13:25:35 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mail@maciej.szmigiero.name>)
 id 1quygG-0005o8-WB
 for qemu-devel@nongnu.org; Mon, 23 Oct 2023 13:25:33 -0400
Received: from vps-vb.mhejs.net ([37.28.154.113])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mail@maciej.szmigiero.name>)
 id 1quygB-0007eH-Lc
 for qemu-devel@nongnu.org; Mon, 23 Oct 2023 13:25:32 -0400
Received: from MUA by vps-vb.mhejs.net with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <mail@maciej.szmigiero.name>)
 id 1quyg2-0002r8-7J; Mon, 23 Oct 2023 19:25:18 +0200
...
Subject: [PATCH v8 4/9] Add Hyper-V Dynamic Memory Protocol driver
 (hv-balloon) base
Date: Mon, 23 Oct 2023 19:24:30 +0200
Message-ID: <29b0d11a4f9951c57febd5cfa1961173e4659252.1698064312.git.maciej.szmigiero@oracle.com>
...
new file mode 100644
index 000000000000..8d49295da3a4
--- /dev/null
...
index 259dc5f30875..91718265b842 100644
--- a/meson.build
+++ b/meson.build
...
@@ -4318,6 +4343,7 @@ if targetos == 'windows'
 endif
