...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C4E6BCC20A
	for <lists+qemu-devel@lfdr.de>; Fri, 10 Oct 2025 10:27:52 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1v78TU-0007BY-Nu; Fri, 10 Oct 2025 04:27:40 -0400
...
Received: from mail.loongson.cn ([114.242.206.163])
 ...
 (envelope-from <maobibo@loongson.cn>) id 1v78TL-0004UK-As
 for qemu-devel@nongnu.org; Fri, 10 Oct 2025 04:27:38 -0400
Received: from loongson.cn (unknown [10.2.5.213])
 by gateway (Coremail) with SMTP id _____8Dx_79rw+hoDJsUAA--.43675S3;
 Fri, 10 Oct 2025 16:27:23 +0800 (CST)
Received: from localhost.localdomain (unknown [10.2.5.213])
 by front1 (Coremail) with SMTP id qMiowJBxzsFpw+hos0LYAA--.56940S8;
 Fri, 10 Oct 2025 16:27:23 +0800 (CST)
From: Bibo Mao <maobibo@loongson.cn>
To: Song Gao <gaosong@loongson.cn>
Cc: Jiaxun Yang <jiaxun.yang@flygoat.com>,
	qemu-devel@nongnu.org
Subject: [PATCH v2 6/8] hw/loongarch/virt: Add property highmem_mmio with virt
 machine
Date: Fri, 10 Oct 2025 16:27:18 +0800
Message-Id: <20251010082720.3943996-7-maobibo@loongson.cn>
...
X-CM-TRANSID: qMiowJBxzsFpw+hos0LYAA--.56940S8
...
index ad891a5972..264070e787 100644
--- a/hw/loongarch/virt.c
+++ b/hw/loongarch/virt.c
@@ -90,6 +90,20 @@ static void virt_set_veiointc(Object *obj, Visitor *v, const char *name,
...
@@ -1381,6 +1395,13 @@ static void virt_class_init(ObjectClass *oc, const void *data)
...
index 01f20a135a..8a289a49fa 100644
--- a/include/hw/loongarch/virt.h
+++ b/include/hw/loongarch/virt.h
@@ -92,6 +92,7 @@ struct LoongArchVirtMachineState {
     DeviceState *dintc;
     hwaddr ram_end;
