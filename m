...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id E00D777DAA5
	for <lists+qemu-devel@lfdr.de>; Wed, 16 Aug 2023 08:50:02 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qWAKA-0001D3-5w; Wed, 16 Aug 2023 02:48:14 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <faithilikerun@gmail.com>)
 id 1qWAJf-00011g-Gy; Wed, 16 Aug 2023 02:47:41 -0400
Received: from mail-pl1-x636.google.com ([2607:f8b0:4864:20::636])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <faithilikerun@gmail.com>)
 id 1qWAJa-0008An-JC; Wed, 16 Aug 2023 02:47:39 -0400
Received: by mail-pl1-x636.google.com with SMTP id
 d9443c01a7336-1bc6535027aso52446855ad.2; 
 Tue, 15 Aug 2023 23:47:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20221208; t=1692168450; x=1692773250;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=nNI6dSJFpouzAtow9H15Powe/E62QjazVdjlL5QlT28=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20221208; t=1692168450; x=1692773250;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=nNI6dSJFpouzAtow9H15Powe/E62QjazVdjlL5QlT28=;
 b=
X-Gm-Message-State: AOJu0YxpybuGdH5uKYMXwuTsMl4zSW2BC5iR1xP98OtxPCT2cYHgIqR9
 L6+C9eRMw4TnHMm2HodtOw63mCgqQfU2xTFl/P4=
X-Google-Smtp-Source: AGHT+IED/7nybHsujfjfouGiCocqIxkEfWwET8FRLvSgb22akiokaCchbi6ue+efiAqsQQ6lrXnY6w==
X-Received: by 2002:a17:902:b788:b0:1b8:76ce:9d91 with SMTP id
 e8-20020a170902b78800b001b876ce9d91mr1209587pls.1.1692168449209; 
 Tue, 15 Aug 2023 23:47:29 -0700 (PDT)
Received: from fedlinux.. ([106.84.130.68]) by smtp.gmail.com with ESMTPSA id
 c6-20020a170902c1c600b001bee782a1desm1329363plc.181.2023.08.15.23.47.06
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 15 Aug 2023 23:47:28 -0700 (PDT)
...
Subject: [RFC 3/5] hw/nvme: make the metadata of ZNS emulation persistent
Date: Wed, 16 Aug 2023 14:46:15 +0800
Message-Id: <20230816064617.3310-4-faithilikerun@gmail.com>
...
-
 ...
 {
     NvmeRwCmd *rw = (NvmeRwCmd *)&req->cmd;
@@ -2153,10 +1757,6 @@ void nvme_rw_complete_cb(void *opaque, int ret)
...
@@ -2861,8 +2461,6 @@ static inline uint16_t nvme_check_copy_mcl(NvmeNamespace *ns,
...
@@ -2875,10 +2473,6 @@ static void nvme_copy_out_completed_cb(void *opaque, int ret)
         goto out;
     }
...
-
     ...
     iocb->slba += nlb;
 out:
@@ -2987,17 +2581,6 @@ static void nvme_copy_in_completed_cb(void *opaque, int ret)
         goto invalid;
     }
...
@@ -3081,13 +2664,6 @@ static void nvme_do_copy(NvmeCopyAIOCB *iocb)
         }
     }
...
@@ -3157,19 +2733,6 @@ static uint16_t nvme_copy(NvmeCtrl *n, NvmeRequest *req)
...
-
     ...
     if (status) {
         goto invalid;
@@ -3428,14 +2991,6 @@ static uint16_t nvme_read(NvmeCtrl *n, NvmeRequest *req)
         goto invalid;
     }
...
-
     if (NVME_ERR_REC_DULBE(ns->features.err_rec)) {
         ...
         if (status) {
@@ -3511,8 +3066,6 @@ static uint16_t nvme_do_write(NvmeCtrl *n, NvmeRequest *req, bool append,
...
@@ -3544,32 +3097,20 @@ static uint16_t nvme_do_write(NvmeCtrl *n, NvmeRequest *req, bool append,
     }
...
-
             ...
             case NVME_ID_NS_DPS_TYPE_1:
                 if (!piremap) {
@@ -3581,7 +3122,7 @@ static uint16_t nvme_do_write(NvmeCtrl *n, NvmeRequest *req, bool append,
...
+                    rw->reftag = cpu_to_le32(reftag + (slba - zone_start));
                 ...
                 break;
@@ -3595,19 +3136,6 @@ static uint16_t nvme_do_write(NvmeCtrl *n, NvmeRequest *req, bool append,
             }
         }
...
@@ -3650,6 +3178,23 @@ static inline uint16_t nvme_write_zeroes(NvmeCtrl *n, NvmeRequest *req)
...
@@ -3661,7 +3206,7 @@ static uint16_t nvme_get_mgmt_zone_slba_idx(NvmeNamespace *ns, NvmeCmd *c,
...
@@ -3679,198 +3224,21 @@ static uint16_t nvme_get_mgmt_zone_slba_idx(NvmeNamespace *ns, NvmeCmd *c,
     return NVME_SUCCESS;
 }
...
@@ -3880,117 +3248,66 @@ static void nvme_zone_reset_cancel(BlockAIOCB *aiocb)
     }
 }
...
@@ -3998,37 +3315,36 @@ static uint16_t nvme_zone_mgmt_send_zrwa_flush(NvmeCtrl *n, NvmeZone *zone,
         return NVME_INVALID_FIELD | NVME_DNR;
     }
...
@@ -4039,82 +3355,51 @@ static uint16_t nvme_zone_mgmt_send(NvmeCtrl *n, NvmeRequest *req)
         if (status) {
             return status;
         }
-    }
...
@@ -4122,16 +3407,34 @@ static uint16_t nvme_zone_mgmt_send(NvmeCtrl *n, NvmeRequest *req)
             return NVME_INVALID_FIELD | NVME_DNR;
         }
...
+                                                         TO_DO_ZA);
     ...
     if (status) {
         status |= NVME_DNR;
@@ -4140,50 +3443,144 @@ static uint16_t nvme_zone_mgmt_send(NvmeCtrl *n, NvmeRequest *req)
     return status;
 }
...
@@ -4195,12 +3592,8 @@ static uint16_t nvme_zone_mgmt_recv(NvmeCtrl *n, NvmeRequest *req)
...
@@ -4213,64 +3606,31 @@ static uint16_t nvme_zone_mgmt_recv(NvmeCtrl *n, NvmeRequest *req)
         return status;
     }
...
index c9c3a54d36..e54712de30 100644
--- a/hw/nvme/ns.c
+++ b/hw/nvme/ns.c
...
@@ -663,7 +593,6 @@ void nvme_ns_cleanup(NvmeNamespace *ns)
 {
     if (blk_get_zone_model(ns->blkconf.blk)) {
...
@@ -777,10 +706,6 @@ static Property nvme_ns_props[] = {
...
index 9f04a772f6..0cbed607a8 100644
...
index e16dfe8581..79a62b5271 100644
...
index c56ed29c8f..f69aa1094a 100644
--- a/include/sysemu/block-backend-io.h
+++ b/include/sysemu/block-backend-io.h
@@ -106,8 +106,10 @@ uint32_t blk_get_zone_capacity(BlockBackend *blk);
