...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 81B60941E1C
	for <lists+qemu-devel@lfdr.de>; Tue, 30 Jul 2024 19:25:54 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1sYqaL-0004eq-Op; Tue, 30 Jul 2024 13:24:29 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <chalapathi.v@linux.ibm.com>)
 id 1sYqaI-0004XN-OW; Tue, 30 Jul 2024 13:24:26 -0400
Received: from mx0b-001b2d01.pphosted.com ([148.163.158.5])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <chalapathi.v@linux.ibm.com>)
 id 1sYqaE-0006Nl-LR; Tue, 30 Jul 2024 13:24:26 -0400
Received: from pps.filterd (m0353723.ppops.net [127.0.0.1])
 by mx0a-001b2d01.pphosted.com (8.18.1.2/8.18.1.2) with ESMTP id 46UGwLTf000738;
 Tue, 30 Jul 2024 17:24:14 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com; h=from
 :to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding; s=pp1; bh=ACjGbkNQnZhi9
 ubqrFnnU6yqVjCWkDpQtMj3bZ5FRjw=; b=iszwyIDAfFqr1R2QzwyYyzYwgoMSm
 
Received: from pps.reinject (localhost [127.0.0.1])
 by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 40q45r8235-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Tue, 30 Jul 2024 17:24:13 +0000 (GMT)
Received: from m0353723.ppops.net (m0353723.ppops.net [127.0.0.1])
 by pps.reinject (8.18.0.8/8.18.0.8) with ESMTP id 46UHLI05008739;
 Tue, 30 Jul 2024 17:24:13 GMT
Received: from ppma13.dal12v.mail.ibm.com
 (dd.9e.1632.ip4.static.sl-reverse.com [50.22.158.221])
 by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 40q45r8234-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Tue, 30 Jul 2024 17:24:13 +0000 (GMT)
Received: from pps.filterd (ppma13.dal12v.mail.ibm.com [127.0.0.1])
 by ppma13.dal12v.mail.ibm.com (8.17.1.19/8.17.1.19) with ESMTP id
 46UFbA8G003857; Tue, 30 Jul 2024 17:24:12 GMT
Received: from smtprelay05.fra02v.mail.ibm.com ([9.218.2.225])
 by ppma13.dal12v.mail.ibm.com (PPS) with ESMTPS id 40ndemdway-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Tue, 30 Jul 2024 17:24:12 +0000
Received: from smtpav02.fra02v.mail.ibm.com (smtpav02.fra02v.mail.ibm.com
 [10.20.54.101])
 by smtprelay05.fra02v.mail.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id
 46UHO6KK54984972
 (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
 Tue, 30 Jul 2024 17:24:08 GMT
Received: from smtpav02.fra02v.mail.ibm.com (unknown [127.0.0.1])
 by IMSVA (Postfix) with ESMTP id 9318B20043;
 Tue, 30 Jul 2024 17:24:06 +0000 (GMT)
Received: from smtpav02.fra02v.mail.ibm.com (unknown [127.0.0.1])
 by IMSVA (Postfix) with ESMTP id 75EB120040;
...
Subject: [PATCH v6 3/6] hw/ssi: Extend SPI model
Date: Tue, 30 Jul 2024 12:23:40 -0500
Message-Id: <20240730172343.5818-4-chalapathi.v@linux.ibm.com>
...
X-TM-AS-GCONF: 00
X-Proofpoint-ORIG-GUID: zyBOzxnMKL9_dkN5SJx8FQ1c4USQzUpb
X-Proofpoint-GUID: r057J1dCG2cvdTkOfWn_7HQFz083p7OT
...
---
 ...
 4 files changed, 1156 insertions(+), 1 deletion(-)
...
index de3ffc4e56..d02f4dca01 100644
--- a/hw/ssi/pnv_spi.c
+++ b/hw/ssi/pnv_spi.c
@@ -17,6 +17,9 @@
 #include "hw/irq.h"
...
@@ -50,6 +1089,10 @@ static uint64_t pnv_spi_xscom_read(void *opaque, hwaddr addr, unsigned size)
         val = s->regs[reg];
...
+        }
     ...
     case SPI_SEQ_OP_REG:
         val = 0;
@@ -111,6 +1154,8 @@ static void pnv_spi_xscom_write(void *opaque, hwaddr addr,
...
@@ -143,6 +1188,7 @@ static const MemoryRegionOps pnv_spi_xscom_ops = {
...
@@ -192,6 +1238,7 @@ static void pnv_spi_class_init(ObjectClass *klass, void *data)
