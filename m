...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id DE175737CA8
	for <lists+qemu-devel@lfdr.de>; Wed, 21 Jun 2023 10:04:07 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qBsob-00011b-3Z; Wed, 21 Jun 2023 04:03:45 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <jeuk20.kim@samsung.com>)
 id 1qBsoX-0000pM-8b
 for qemu-devel@nongnu.org; Wed, 21 Jun 2023 04:03:41 -0400
Received: from mailout4.samsung.com ([203.254.224.34])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <jeuk20.kim@samsung.com>)
 id 1qBsoR-0005ks-QI
 for qemu-devel@nongnu.org; Wed, 21 Jun 2023 04:03:40 -0400
Received: from epcas2p4.samsung.com (unknown [182.195.41.56])
 by mailout4.samsung.com (KnoxPortal) with ESMTP id
 20230621080333epoutp048e203aba61d84f34deab0ac9f5eab7b8~qneQfXvwE1804918049epoutp04x
 for <qemu-devel@nongnu.org>; Wed, 21 Jun 2023 08:03:33 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout4.samsung.com
 20230621080333epoutp048e203aba61d84f34deab0ac9f5eab7b8~qneQfXvwE1804918049epoutp04x
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
 s=mail20170921; t=1687334613;
 bh=/5/4k7nXavi0BYECGsMAcpeYVSe2geVPw98dN9ogHY8=;
 h=Subject:Reply-To:From:To:CC:In-Reply-To:Date:References:From;
 b=EfsBaEE74lVNM45QP4icMJsreEzW7DyHHuK3ooUG5tF4eT7tSvHKgIjcKe/sTbsLk
 m/bWB6lczwj9g7sshnrevOjhwUDF0iWyz+qsElGFTyt7T/1Nc4z53EkwvuHIzeEDwI
 cUb7mWAlOrIXk2UToSmJCIXAW0fBz61oWJl4eg2E=
Received: from epsnrtp2.localdomain (unknown [182.195.42.163]) by
 epcas2p4.samsung.com (KnoxPortal) with ESMTP id
 20230621080333epcas2p42e77d20b17a48c57e8f9512f47de0719~qneQWRgEU1174811748epcas2p4O;
 Wed, 21 Jun 2023 08:03:33 +0000 (GMT)
Received: from epsmges2p4.samsung.com (unknown [182.195.36.99]) by
 epsnrtp2.localdomain (Postfix) with ESMTP id 4QmGGX48bzz4x9QH; Wed, 21 Jun
 2023 08:03:32 +0000 (GMT)
X-AuditID: b6c32a48-87fff70000007e89-cd-6492aed4ce35
Received: from epcas2p1.samsung.com ( [182.195.41.53]) by
 epsmges2p4.samsung.com (Symantec Messaging Gateway) with SMTP id
 42.78.32393.4DEA2946; Wed, 21 Jun 2023 17:03:32 +0900 (KST)
Mime-Version: 1.0
Subject: [PATCH v3 3/3] hw/ufs: Support for UFS logical unit
...
CC: "stefanha@redhat.com" <stefanha@redhat.com>, "pbonzini@redhat.com"
 ...
 <kwolf@redhat.com>, "hreitz@redhat.com" <hreitz@redhat.com>, Klaus Birkelund
 Jensen <k.jensen@samsung.com>, "eblake@redhat.com" <eblake@redhat.com>
X-Priority: 3
X-Content-Kind-Code: NORMAL
In-Reply-To: <20230621075535epcms2p7fc17717fe677ab8a8b714607486b7b6a@epcms2p7>
X-CPGS-Detection: blocking_info_exchange
X-Drm-Type: N,general
X-Msg-Generator: Mail
X-Msg-Type: PERSONAL
X-Reply-Demand: N
Message-ID: <20230621080332epcms2p258224df2de6748eeecf98858de150ed0@epcms2p2>
Date: Wed, 21 Jun 2023 17:03:32 +0900
X-CMS-MailID: 20230621080332epcms2p258224df2de6748eeecf98858de150ed0
Content-Transfer-Encoding: 7bit
Content-Type: text/plain; charset="utf-8"
X-Sendblock-Type: AUTO_CONFIDENTIAL
CMS-TYPE: 102P
X-Brightmail-Tracker: 
 1Cz+ZHspT37PUl+hJUosxRmJhlrMRcWJAPhcpUkeBAAA
DLP-Filter: Pass
X-CFilter-Loop: Reflected
X-CMS-RootMailID: 20230621075535epcms2p7fc17717fe677ab8a8b714607486b7b6a
References: <20230621075535epcms2p7fc17717fe677ab8a8b714607486b7b6a@epcms2p7>
 <CGME20230621075535epcms2p7fc17717fe677ab8a8b714607486b7b6a@epcms2p2>
...
index 97cf6664b9..5a4018ca5d 100644
...
index 2b564141c6..81dbe7ff03 100644
--- a/hw/ufs/ufs.c
+++ b/hw/ufs/ufs.c
@@ -8,6 +8,19 @@
...
@@ -461,6 +474,19 @@ static const MemoryRegionOps ufs_mmio_ops = {
     },
 };
...
+
 static void ufs_build_upiu_header(UfsRequest *req, uint8_t trans_type,
                                   ...
                                   uint8_t scsi_status,
@@ -474,6 +500,98 @@ static void ufs_build_upiu_header(UfsRequest *req, uint8_t trans_type,
...
@@ -751,9 +869,11 @@ static const RpmbUnitDescriptor rpmb_unit_desc = {
...
@@ -761,8 +881,8 @@ static QueryRespCode ufs_read_unit_desc(UfsRequest *req)
     if (lun == UFS_UPIU_RPMB_WLUN) {
...
@@ -1012,8 +1132,7 @@ static void ufs_exec_req(UfsRequest *req)
...
@@ -1024,7 +1143,14 @@ static void ufs_exec_req(UfsRequest *req)
         req_result = UFS_REQUEST_FAIL;
     }
...
@@ -1234,6 +1360,28 @@ static void ufs_init_hc(UfsHc *u)
...
+
 ...
 {
     UfsHc *u = UFS(pci_dev);
@@ -1242,15 +1390,55 @@ static void ufs_realize(PCIDevice *pci_dev, Error **errp)
         return;
     }
...
@@ -1289,6 +1477,49 @@ static void ufs_class_init(ObjectClass *oc, void *data)
     dc->vmsd = &ufs_vmstate;
 }
...
@@ -1297,9 +1528,18 @@ static const TypeInfo ufs_info = {
...
index 869361447f..7c85066f28 100644
--- a/hw/ufs/ufs.h
+++ b/hw/ufs/ufs.h
@@ -18,6 +18,18 @@
