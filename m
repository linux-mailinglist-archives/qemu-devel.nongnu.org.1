...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id EAB387604DE
	for <lists+qemu-devel@lfdr.de>; Tue, 25 Jul 2023 03:42:06 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qO72U-00083Z-G6; Mon, 24 Jul 2023 21:40:38 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <outgoing@sr.ht>) id 1qO72R-000814-Gi
 for qemu-devel@nongnu.org; Mon, 24 Jul 2023 21:40:35 -0400
Received: from mail-b.sr.ht ([173.195.146.151])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <outgoing@sr.ht>) id 1qO72P-0008KZ-Ik
 for qemu-devel@nongnu.org; Mon, 24 Jul 2023 21:40:35 -0400
Authentication-Results: mail-b.sr.ht; dkim=none 
Received: from git.sr.ht (unknown [173.195.146.142])
 by mail-b.sr.ht (Postfix) with ESMTPSA id DC66E11EF15;
 Tue, 25 Jul 2023 01:40:31 +0000 (UTC)
From: ~hyman <hyman@git.sr.ht>
Date: Wed, 07 Jun 2023 22:58:32 +0800
Subject: [PATCH QEMU v10 3/9] qapi/migration: Introduce vcpu-dirty-limit
 parameters
MIME-Version: 1.0
Message-ID: <169024923116.19090.10825599068950039132-3@git.sr.ht>
X-Mailer: git.sr.ht
...
+#     migration, defaults to 1.  (Since 8.2)
+#
 # Features:
 #
