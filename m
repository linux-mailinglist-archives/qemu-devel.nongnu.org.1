...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C565969C85
	for <lists+qemu-devel@lfdr.de>; Tue,  3 Sep 2024 13:55:46 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1slS7H-0008CR-DQ; Tue, 03 Sep 2024 07:54:35 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <aesteve@redhat.com>)
 id 1slS7D-0008By-PA
 for qemu-devel@nongnu.org; Tue, 03 Sep 2024 07:54:31 -0400
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1725364466;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 in-reply-to:in-reply-to:references:references;
 bh=bkn5SqMjOKjX19UZKeYGORqJOvVbzUtcY67nnyaffeQ=;
 b=fQACqaV3mkj6JTesEww0agQ4fiGk7h2RUe60FH/f5ASS+GPdqU7jUwy+WhDSz0jwMTSdfq
 cCwraZWBE2MKTNTsx1cPClPJLiF3rd5o/5FnVyYVDl44NOAaFCsLhYmKEWmwh+EmB8saM5
 VpsQyenHiQcHa9H32wIMn/HZUCY+/YA=
Received: from mail-pl1-f199.google.com (mail-pl1-f199.google.com
 [209.85.214.199]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-322-RNEaoTfpPfWalx_9jIWPrw-1; Tue, 03 Sep 2024 07:54:24 -0400
X-MC-Unique: RNEaoTfpPfWalx_9jIWPrw-1
Received: by mail-pl1-f199.google.com with SMTP id
 d9443c01a7336-2054ff12bb9so24892775ad.1
 for <qemu-devel@nongnu.org>; Tue, 03 Sep 2024 04:54:24 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1725364464; x=1725969264;
 h=cc:to:subject:message-id:date:from:in-reply-to:references
 :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
 :reply-to;
 bh=bkn5SqMjOKjX19UZKeYGORqJOvVbzUtcY67nnyaffeQ=;
 b=
X-Gm-Message-State: AOJu0YwXgNmtInE7h5HQpkNHrG6jWz+/SqskMcpcwh2zpGlTtr0nB8RD
 z1yMvsRHetL/BafcVkUa/u8LPNxWMQhFez3gbbJujm9l/i0sBGQrwDSyRJvHmRoCzUcb8F4AjIr
 9U5noVGhe5H62Me05zkvfXjHgzow1/3Ca1dIxnxGjDH8ZQ0+Dx2FA5CqsB+bD/9GhjjjDhdfmhS
 vNBN3VR/q17nqCU0kJiBjY85Z7qog=
X-Received: by 2002:a17:902:ea0e:b0:206:9519:1821 with SMTP id
 d9443c01a7336-20695191a88mr22151945ad.14.1725364463751; 
 Tue, 03 Sep 2024 04:54:23 -0700 (PDT)
X-Google-Smtp-Source: AGHT+IHgwU5eWelhsY6RVBuYxleRTxE/mftxxye3Gl/4tPHrx6KK6WHyag14FDZszDQAxiWE1tCqPLTmc2bKHx/3o6Y=
X-Received: by 2002:a17:902:ea0e:b0:206:9519:1821 with SMTP id
 d9443c01a7336-20695191a88mr22151615ad.14.1725364463289; Tue, 03 Sep 2024
 04:54:23 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <CADSE00+HWkP9FQTuA-xNtExS-FSieh7DJ4D3zzrtJi3a6=PP1Q@mail.gmail.com>
From: Albert Esteve <aesteve@redhat.com>
Date: Tue, 3 Sep 2024 13:54:12 +0200
Message-ID: <CADSE00JWvq7HYibVymewoKwuo1T1-W6ZJ1fJEB3ofiS1iOyf1w@mail.gmail.com>
...
Content-Type: multipart/alternative; boundary="000000000000f17786062135b767"
...
>
>
> On Thu, Jul 11, 2024 at 9:45=E2=80=AFAM Stefan Hajnoczi <stefanha@redhat.=
com>
> wrote:
>
...
>> > +        ret =3D vhost_user_backend_handle_shmem_map(dev, &payload.mma=
p,
>> > +                                                  fd ? fd[0] : -1);
>> > +        break;
...
<div dir=3D"ltr" class=3D"gmail_attr">On Tue, Sep 3, 2024 at 11:54=E2=80=AF=
AM Albert Esteve &lt;<a href=3D"mailto:aesteve@redhat.com">aesteve@redhat.c=
...
il_quote"><div dir=3D"ltr" class=3D"gmail_attr">On Thu, Jul 11, 2024 at 9:4=
5=E2=80=AFAM Stefan Hajnoczi &lt;<a href=3D"mailto:stefanha@redhat.com" tar=
get=3D"_blank">stefanha@redhat.com</a>&gt; wrote:<br></div><blockquote clas=
s=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid r=
gb(204,204,204);padding-left:1ex">On Fri, Jun 28, 2024 at 04:57:06PM +0200,=
 Albert Esteve wrote:<br>
...
><div>a valid option?</div></div></div></blockquote><div><br></div><div>May=
be something like this would do?<br>```</div><div>=C2=A0 =C2=A0 =C2=A0if (m=
emory_region_find(mr, vu_mmap-&gt;shm_offset, vu_mmap-&gt;len).mr) {</div>=
=C2=A0 =C2=A0 =C2=A0 =C2=A0 error_report(&quot;Requested memory (%&quot; PR=
Ix64 &quot;+%&quot; PRIx64 &quot; overalps &quot;<br>=C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0&quot;with previousl=
y mapped memory&quot;,<br>=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0vu_mmap-&gt;shm_offset, vu_mmap-&gt;len);<br>=C2=
=A0 =C2=A0 =C2=A0 =C2=A0 return -EFAULT;<br>=C2=A0 =C2=A0 }<br><div>```</di=
