...
Subject: [PATCH v7 03/16] backends/igvm: Add IGVM loader and configuration
Date: Thu, 27 Feb 2025 13:44:07 +0000
Message-ID: <928b7178f2960441871dbb8145f639b10ac84ccb.1740663410.git.roy.hopkins@randomman.co.uk>
...
index 28ce24cd8d..1cc3b51804 100644
--- a/qapi/qom.json
+++ b/qapi/qom.json
@@ -932,6 +932,19 @@
   'data': { '*filename': 'str' },
