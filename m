...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id B9B397D8C9D
	for <lists+qemu-devel@lfdr.de>; Fri, 27 Oct 2023 02:43:28 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qwAvA-0006eC-OU; Thu, 26 Oct 2023 20:41:52 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <stefanha@gmail.com>)
 id 1qwAv8-0006d1-4o; Thu, 26 Oct 2023 20:41:50 -0400
Received: from mail-oo1-xc2c.google.com ([2607:f8b0:4864:20::c2c])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <stefanha@gmail.com>)
 id 1qwAv4-0008Dz-NN; Thu, 26 Oct 2023 20:41:49 -0400
Received: by mail-oo1-xc2c.google.com with SMTP id
 006d021491bc7-586940ee5a5so872330eaf.0; 
 Thu, 26 Oct 2023 17:41:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1698367304; x=1698972104; darn=nongnu.org;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:from:to:cc:subject:date
 :message-id:reply-to;
 bh=9Lrj3hcth64Jlbivrv7/DJsmtTJeLz/jQopuoLelRm4=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1698367304; x=1698972104;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=9Lrj3hcth64Jlbivrv7/DJsmtTJeLz/jQopuoLelRm4=;
 b=
X-Gm-Message-State: AOJu0Yzh7UlYsmWS1qO1YBwZhGg55nFTnd+5bodiUVX2hHIk4sQpdGa0
 IliDgsMiYMg8bUw54ZcJJGMeW6l30Nn4UXoVRVE=
X-Google-Smtp-Source: AGHT+IHaDrCkiULyFxI32fY+5k8+YhiSliv0sXqTCVV/NeVjzsO1UcGeLdOO4taoIfXGnqccEnCLc0aWBnW+Ib4Eb1U=
X-Received: by 2002:a4a:d347:0:b0:583:fc94:c3f3 with SMTP id
 d7-20020a4ad347000000b00583fc94c3f3mr1122384oos.9.1698367303951; Thu, 26 Oct
 2023 17:41:43 -0700 (PDT)
MIME-Version: 1.0
References: <20231024131305.87468-1-quintela@redhat.com>
 <CAJSP0QVZPM5BkHYBTqXmDBuBvUuAAhjdgX_3Ka0WbqTzBxutvg@mail.gmail.com>
 <87il6te782.fsf@secure.mitica>
In-Reply-To: <87il6te782.fsf@secure.mitica>
From: Stefan Hajnoczi <stefanha@gmail.com>
Date: Fri, 27 Oct 2023 09:41:30 +0900
Message-ID: <CAJSP0QVogdcO9CQEk+hOK-RecnMFiR5qCsHHB6Myrkhhq4Wf8w@mail.gmail.com>
...
:
> >>
> >> The following changes since commit a95260486aa7e78d7c7194eba65cf03311a=
d94ad:
> >>
> >>   Merge tag 'pull-tcg-20231023' of https://gitlab.com/rth7680/qemu int=
o staging (2023-10-23 14:45:46 -0700)
> >>
> >> are available in the Git repository at:
> >>
> >>   https://gitlab.com/juan.quintela/qemu.git tags/migration-20231024-pu=
ll-request
> >>
> >> for you to fetch changes up to 088f7f03da3f5b3487091302b795c22b1bfe56f=
b:
> >>
> >>   migration: Deprecate old compression method (2023-10-24 13:48:24 +02=
00)
> >>
> >> ----------------------------------------------------------------
...
>
> $ cirrus-run -v --show-build-log always .gitlab-ci.d/cirrus/$NAME.yml 01:=
18:03
...
>
> $ ./check 130 -qcow2
> QEMU          -- "/scratch/qemu/gcc/full/all/qemu-system-x86_64" -nodefau=
lts -display none -accel qtest
> QEMU_IMG      -- "/scratch/qemu/gcc/full/all/qemu-img"
> QEMU_IO       -- "/scratch/qemu/gcc/full/all/qemu-io" --cache writeback -=
-aio threads -f qcow2
...
> PRINT_QEMU_OUTPUT --
>
> 130   fail       [14:43:56] [14:43:57]   0.5s   (last: 0.4s)  output mism=
atch (see /scratch/qemu/gcc/full/all/tests/qemu-iotests/scratch/qcow2-file-=
130/130.out.bad)
> --- /mnt/code/qemu/full/tests/qemu-iotests/130.out
> +++ /scratch/qemu/gcc/full/all/tests/qemu-iotests/scratch/qcow2-file-130/=
130.out.bad
> @@ -11,18 +11,14 @@
...
> +qemu-img: Could not open 'TEST_DIR/t.IMGFMT': Failed to get shared "writ=
e" lock
...
> QEMU          -- "/home/quintela/scratch/qemu/gcc/qemu/all/qemu-system-s3=
90x" -nodefaults -display none -accel qtest
> QEMU_IMG      -- "/home/quintela/scratch/qemu/gcc/qemu/all/qemu-img"
> QEMU_IO       -- "/home/quintela/scratch/qemu/gcc/qemu/all/qemu-io" --cac=
he writeback --aio threads -f qcow2
> QEMU_NBD      -- "/home/quintela/scratch/qemu/gcc/qemu/all/qemu-nbd"
> IMGFMT        -- qcow2
> IMGPROTO      -- file
> PLATFORM      -- Linux/s390x s390x-kvm-007.lab.eng.rdu2.redhat.com 5.14.0=
-284.38.1.el9_2.s390x
> TEST_DIR      -- /home/quintela/scratch/qemu/gcc/qemu/all/tests/qemu-iote=
sts/scratch
...
> PRINT_QEMU_OUTPUT --
>
> 108   fail       [08:24:54] [08:24:56]   1.7s                 output mism=
atch (see /home/quintela/scratch/qemu/gcc/qemu/all/tests/qemu-iotests/scrat=
ch/qcow2-file-108/108.out.bad)
> --- /home/quintela/code/qemu/qemu/tests/qemu-iotests/108.out
> +++ /home/quintela/scratch/qemu/gcc/qemu/all/tests/qemu-iotests/scratch/q=
cow2-file-108/108.out.bad
> @@ -152,6 +152,8 @@
>
>  --- Rebuilding refcount structures on block devices ---
>
> +fuse: failed to exec fusermount3: No such file or directory
> +qemu-storage-daemon: --export fuse,id=3Dfuse-export,node-name=3Dexport-n=
ode,mountpoint=3D/home/quintela/scratch/qemu/gcc/qemu/all/tests/qemu-iotest=
s/scratch/qcow2-file-108/fuse-export,writable=3Don,growable=3Doff,allow-oth=
er=3Doff: Failed to mount FUSE session to export
...
> +cat: /home/quintela/scratch/qemu/gcc/qemu/all/tests/qemu-iotests/scratch=
/qcow2-file-108/qsd.pid: No such file or directory
...
>     at ../../../../../quintela/code/qemu/full/hw/core/qdev-properties.c:9=
38
> 938         if (!prop->info->print && prop->info->get) {
> Missing separate debuginfos, use: dnf debuginfo-install libeconf-0.4.1-3.=
el9_2.aarch64
> (gdb) bt
> #0  0x0000aaaaab05b828 in qdev_class_add_legacy_property
>     (prop=3D0xaaaaab5fffe0 <savevm_s390_storage_keys>, dc=3D0xaaaaab88be6=
0)
>     at ../../../../../quintela/code/qemu/full/hw/core/qdev-properties.c:9=
38
> #1  device_class_set_props
>     (dc=3Ddc@entry=3D0xaaaaab88be60, props=3Dprops@entry=3D0xaaaaab5fff88=
 <s390_skeys_props>) at ../../../../../quintela/code/qemu/full/hw/core/qdev=
-properties.c:954
...
>     (key=3D<optimized out>, value=3D0xaaaaab74ea60, opaque=3D0xffffffffe4=
98)
>     at ../../../../../quintela/code/qemu/full/qom/object.c:1095
> #5  0x0000fffff6fe92d8 in g_hash_table_foreach
>     (hash_table=3D0xaaaaab70caa0 =3D {...}, func=3D0xaaaaab0621b0 <object=
_class_foreach_tramp>, user_data=3D0xffffffffe498) at ../glib/ghash.c:2065
> #6  0x0000aaaaab062798 in object_class_foreach
>     (opaque=3D<optimized out>, include_abstract=3D<optimized out>, implem=
ents_type=3D<optimized out>, fn=3D<optimized out>)
>     at ../../../../../quintela/code/qemu/full/qom/object.c:87
> #7  object_class_get_list
>     (implements_type=3Dimplements_type@entry=3D0xaaaaab3cb670 "machine", =
include_abstract=3Dinclude_abstract@entry=3Dfalse)
...
> #11 0x0000aaaaaade7fbc in main (argc=3D<optimized out>, argv=3D<optimized=
 out>)
...
>
> >
> > You can ignore avocado-system-debian, but the others look like real fai=
lures.
> >
...
> >>
> >> Thomas Huth (5):
> >>   hw/ipmi: Don't call vmstate_register() from instance_init() function=
s
