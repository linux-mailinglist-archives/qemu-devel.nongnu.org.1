...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 9106B806366
	for <lists+qemu-devel@lfdr.de>; Wed,  6 Dec 2023 01:25:26 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rAfiD-0006OE-Md; Tue, 05 Dec 2023 19:24:25 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <alistair23@gmail.com>)
 id 1rAfiA-0006Nn-Dq; Tue, 05 Dec 2023 19:24:23 -0500
Received: from mail-lf1-x12d.google.com ([2a00:1450:4864:20::12d])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <alistair23@gmail.com>)
 id 1rAfi3-0008IU-08; Tue, 05 Dec 2023 19:24:20 -0500
Received: by mail-lf1-x12d.google.com with SMTP id
 2adb3069b0e04-50c0f13ea11so1052867e87.3; 
 Tue, 05 Dec 2023 16:24:13 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1701822252; x=1702427052; darn=nongnu.org;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:from:to:cc:subject:date
 :message-id:reply-to;
 bh=CF77T0iBUB6Mv8ggGQEyRgEUZqQNlM0KQGpS1mk2M2o=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1701822252; x=1702427052;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=CF77T0iBUB6Mv8ggGQEyRgEUZqQNlM0KQGpS1mk2M2o=;
 b=
X-Gm-Message-State: AOJu0YxsDWCQxA4Cunex0zLF4pSBrMP/8tXk/uzGVSuEcWgn8W+EJbMM
 JdbMhCUgHaldSWRvtiYgmfj8X0w3gxLAD5p6A3c=
X-Google-Smtp-Source: AGHT+IH+VWMeTXuL34PT/3wJM2+vvIlPvK/m/gV8ou2/L7Yb+1btqZcxBrdgftIPqgszrCgUW2+ebU25z3pW0sWj+8I=
X-Received: by 2002:a05:6512:39d6:b0:50c:15:9323 with SMTP id
 k22-20020a05651239d600b0050c00159323mr59304lfu.91.1701822251093; Tue, 05 Dec
 2023 16:24:11 -0800 (PST)
MIME-Version: 1.0
References: <20231130182748.1894790-1-dbarboza@ventanamicro.com>
 <20231130182748.1894790-2-dbarboza@ventanamicro.com>
In-Reply-To: <20231130182748.1894790-2-dbarboza@ventanamicro.com>
From: Alistair Francis <alistair23@gmail.com>
Date: Wed, 6 Dec 2023 10:23:42 +1000
Message-ID: <CAKmqyKNzhFSCX95_3s8o=rEPPYMT63uePfGwtbdm8FmzZ5mPaA@mail.gmail.com>
Subject: Re: [PATCH for-9.0 1/4] linux-headers: Update to Linux v6.7-rc3
...
Received-SPF: pass client-ip=2a00:1450:4864:20::12d;
 envelope-from=alistair23@gmail.com; helo=mail-lf1-x12d.google.com
X-Spam_score_int: -18
X-Spam_score: -1.9
X-Spam_bar: -
...
>  #define  PCI_EXP_RTCAP_CRSVIS  0x0001  /* CRS Software Visibility capabi=
lity */
...
>  #define  PCI_EXP_DPC_STATUS_TRIGGER_RSN            0x0006 /* Trigger Rea=
son */
> +#define  PCI_EXP_DPC_STATUS_TRIGGER_RSN_UNCOR  0x0000 /* Uncorrectable e=
rror */
> +#define  PCI_EXP_DPC_STATUS_TRIGGER_RSN_NFE    0x0002 /* Rcvd ERR_NONFAT=
AL */
> +#define  PCI_EXP_DPC_STATUS_TRIGGER_RSN_FE     0x0004 /* Rcvd ERR_FATAL =
*/
> +#define  PCI_EXP_DPC_STATUS_TRIGGER_RSN_IN_EXT 0x0006 /* Reason in Trig =
Reason Extension field */
>  #define  PCI_EXP_DPC_STATUS_INTERRUPT      0x0008 /* Interrupt Status */
>  #define  PCI_EXP_DPC_RP_BUSY               0x0010 /* Root Port Busy */
>  #define  PCI_EXP_DPC_STATUS_TRIGGER_RSN_EXT 0x0060 /* Trig Reason Extens=
ion */
> +#define  PCI_EXP_DPC_STATUS_TRIGGER_RSN_RP_PIO         0x0000  /* RP PIO=
 error */
> +#define  PCI_EXP_DPC_STATUS_TRIGGER_RSN_SW_TRIGGER     0x0020  /* DPC SW=
 Trigger bit */
> +#define  PCI_EXP_DPC_RP_PIO_FEP                    0x1f00 /* RP PIO Firs=
t Err Ptr */
>
...
>
> @@ -1088,6 +1100,8 @@
>  #define  PCI_L1SS_CTL1_LTR_L12_TH_VALUE        0x03ff0000  /* LTR_L1.2_T=
HRESHOLD_Value */
>  #define  PCI_L1SS_CTL1_LTR_L12_TH_SCALE        0xe0000000  /* LTR_L1.2_T=
HRESHOLD_Scale */
...
> -__SC_COMP(__NR_lookup_dcookie, sys_lookup_dcookie, compat_sys_lookup_dco=
okie)
> +__SYSCALL(__NR_lookup_dcookie, sys_ni_syscall)
>  #define __NR_eventfd2 19
>  __SYSCALL(__NR_eventfd2, sys_eventfd2)
>  #define __NR_epoll_create1 20
> @@ -816,15 +816,21 @@ __SYSCALL(__NR_process_mrelease, sys_process_mrelea=
se)
...
> diff --git a/linux-headers/asm-loongarch/bitsperlong.h b/linux-headers/as=
m-loongarch/bitsperlong.h
...
> diff --git a/linux-headers/asm-loongarch/kvm.h b/linux-headers/asm-loonga=
rch/kvm.h
> new file mode 100644
...
> diff --git a/linux-headers/asm-loongarch/mman.h b/linux-headers/asm-loong=
arch/mman.h
> new file mode 100644
...
> diff --git a/linux-headers/asm-loongarch/unistd.h b/linux-headers/asm-loo=
ngarch/unistd.h
> new file mode 100644
...
FT)
> +#define KVM_REG_RISCV_CSR_SMSTATEEN    (0x2 << KVM_REG_RISCV_SUBTYPE_SHI=
FT)
...
> + * @IOMMU_HWPT_ALLOC_NEST_PARENT: If set, allocate a HWPT that can serve=
 as
> + *                                the parent HWPT in a nesting configura=
tion.
> + * @IOMMU_HWPT_ALLOC_DIRTY_TRACKING: Dirty tracking support for device I=
OMMU is
...
> + * A kernel-managed HWPT will be created with the mappings from the give=
n
> + * IOAS via the @pt_id. The @data_type for this allocation must be set t=
o
> + * IOMMU_HWPT_DATA_NONE. The HWPT can be allocated as a parent HWPT for =
a
> + * nesting configuration by passing IOMMU_HWPT_ALLOC_NEST_PARENT via @fl=
ags.
> + *
> + * A user-managed nested HWPT will be created from a given parent HWPT v=
ia
...
> + * @IOMMU_HW_INFO_VTD_ERRATA_772415_SPR17: If set, disallow read-only ma=
ppings
> + *                                         on a nested_parent domain.
> + *                                         https://www.intel.com/content=
/www/us/en/content-details/772415/content-details.html
> + */
...
>   * @__reserved: Must be 0
>   *
>   * @cap_reg: Value of Intel VT-d capability register defined in VT-d spe=
c
...
>   * @out_data_type: Output the iommu hardware info type as defined in the=
 enum
>   *                 iommu_hw_info_type.
> + * @out_capabilities: Output the generic iommu capability info type as d=
efined
...
> +
> +/**
> + * struct iommu_hwpt_set_dirty_tracking - ioctl(IOMMU_HWPT_SET_DIRTY_TRA=
CKING)
...
aring
> + *                                        any dirty bits metadata. This =
flag
> + *                                        can be passed in the expectati=
on
...
> +
> +/**
> + * struct iommu_hwpt_get_dirty_bitmap - ioctl(IOMMU_HWPT_GET_DIRTY_BITMA=
P)
...
nter_offset)
> +#define KVM_ARM_GET_REG_WRITABLE_MASKS _IOR(KVMIO,  0xb6, struct reg_mas=
k_range)
>
>  /* ioctl for vm fd */
...
> +        *
> +        * UFFD_FEATURE_WP_ASYNC indicates that userfaultfd write-protect=
ion
...
> + *
> + * The functionality is incorporated for devices that needs bus master c=
ontrol,
> + * but the in-band device interface lacks the support. Consequently, it =
is not
> + * applicable to PCI devices, as bus master control for PCI devices is m=
anaged
...
>         __u32   flags;
>  #define VFIO_IOMMU_INFO_PGSIZES (1 << 0)       /* supported page sizes i=
nfo */
>  #define VFIO_IOMMU_INFO_CAPS   (1 << 1)        /* Info supports caps */
> -       __u64   iova_pgsizes;   /* Bitmap of supported page sizes */
> +       __aligned_u64   iova_pgsizes;           /* Bitmap of supported pa=
ge sizes */
>         __u32   cap_offset;     /* Offset within info struct of first cap=
 */
>         __u32   pad;
...
>
> +/* Get the group for the descriptor table including driver & device area=
s
