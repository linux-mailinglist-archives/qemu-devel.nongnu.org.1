...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 1ABE774C963
	for <lists+qemu-devel@lfdr.de>; Mon, 10 Jul 2023 02:59:44 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qIfEs-0006wY-RD; Sun, 09 Jul 2023 20:58:54 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <alistair23@gmail.com>)
 id 1qIfEo-0006tW-6Z; Sun, 09 Jul 2023 20:58:50 -0400
Received: from mail-vk1-xa2d.google.com ([2607:f8b0:4864:20::a2d])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <alistair23@gmail.com>)
 id 1qIfEj-00066v-ST; Sun, 09 Jul 2023 20:58:49 -0400
Received: by mail-vk1-xa2d.google.com with SMTP id
 71dfb90a1353d-47191280066so1087944e0c.2; 
 Sun, 09 Jul 2023 17:58:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20221208; t=1688950724; x=1691542724;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:from:to:cc:subject:date
 :message-id:reply-to;
 bh=1fyOOM6p5ZPzDEJpzs2Q59i5iCj/Zi/8wru/NLpb9Dc=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20221208; t=1688950724; x=1691542724;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=1fyOOM6p5ZPzDEJpzs2Q59i5iCj/Zi/8wru/NLpb9Dc=;
 b=
X-Gm-Message-State: ABy/qLZAqi1eGx0HEsy4C3bhrgOW1U0qCCh+n+BlYlh9FCsQv1GS2zkl
 +C4bmdv6J8/sjxZnJTECpcIR4YLV8goBsw7CKOM=
X-Google-Smtp-Source: APBJJlF9fIBHRZ8qgztYSxUYyzJ/R8Rncovk0uWqQdkQM5CL4lt7PXRXDPJY+v7W8f+8+agDpVE2ueHBzKMqRSd5+ls=
X-Received: by 2002:a67:e34b:0:b0:444:c49c:a95d with SMTP id
 s11-20020a67e34b000000b00444c49ca95dmr4865391vsm.7.1688950724016; Sun, 09 Jul
 2023 17:58:44 -0700 (PDT)
MIME-Version: 1.0
References: <20230703062616.991472-1-christoph.muellner@vrull.eu>
In-Reply-To: <20230703062616.991472-1-christoph.muellner@vrull.eu>
From: Alistair Francis <alistair23@gmail.com>
Date: Mon, 10 Jul 2023 10:58:17 +1000
Message-ID: <CAKmqyKNPJNLg9QvhtHqWHUZRdmbTD3zqCuzMkx+tdnvsLSMkAA@mail.gmail.com>
...
>
>  /* CSR names */
> @@ -2842,36 +2925,60 @@ static void decode_inst_opcode(rv_decode *dec, rv=
_isa isa)
...
>                  break;
>              case 44:
> @@ -2894,6 +3001,8 @@ static void decode_inst_opcode(rv_decode *dec, rv_i=
sa isa)
...
>                  break;
>              case 81:
> @@ -2901,6 +3010,14 @@ static void decode_inst_opcode(rv_decode *dec, rv_=
isa isa)
...
>                  break;
>              case 83:
> @@ -2908,6 +3025,18 @@ static void decode_inst_opcode(rv_decode *dec, rv_=
isa isa)
...
>                  break;
>              case 96:
> @@ -2924,6 +3053,7 @@ static void decode_inst_opcode(rv_decode *dec, rv_i=
sa isa)
...
>                  break;
>              case 99:
> @@ -2970,6 +3100,7 @@ static void decode_inst_opcode(rv_decode *dec, rv_i=
sa isa)
>                          ((inst >> 12) & 0b00000111)) {
...
>                  break;
>              case 115:
> @@ -2977,24 +3108,33 @@ static void decode_inst_opcode(rv_decode *dec, rv=
_isa isa)
>                          ((inst >> 12) & 0b00000111)) {
...
>                  break;
>              }
> @@ -4254,6 +4394,10 @@ static void decode_inst_operands(rv_decode *dec, r=
v_isa isa)
>          break;
...
>          dec->rd =3D operand_rd(inst);
> @@ -4664,6 +4808,9 @@ static void format_inst(char *buf, size_t buflen, s=
