...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 98B3E7C7080
	for <lists+qemu-devel@lfdr.de>; Thu, 12 Oct 2023 16:41:52 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qqwoQ-0002nI-BS; Thu, 12 Oct 2023 10:37:18 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <david@redhat.com>) id 1qqwoN-0002jw-5D
 for qemu-devel@nongnu.org; Thu, 12 Oct 2023 10:37:15 -0400
Received: from us-smtp-delivery-124.mimecast.com ([170.10.129.124])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <david@redhat.com>) id 1qqwoL-0005gU-2J
 for qemu-devel@nongnu.org; Thu, 12 Oct 2023 10:37:14 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1697121432;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=IBXttHcfW0M8HXrc9Z+XlZcNFtzxUeal28gr6fZ8tpc=;
 b=G0sxtUkGzAdoPAqwUSBgFS4j8FqUvrg+H/LiXvnJFDFOF7dtnLCgwNvAfj6H4GtJkrfUVC
 o9NtgU2Abk13S0XvsCAD8OQ59sAUoeO/DBcJlnIf+e3pxTPaRDzSP9FQRfj11M5mVlnZyb
 lut3Sro7EwV2XhwcK1hzbafBcjsOAeo=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-1-zkPkXb_SO2CMSThFjYYxgQ-1; Thu, 12 Oct 2023 10:36:58 -0400
X-MC-Unique: zkPkXb_SO2CMSThFjYYxgQ-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.rdu2.redhat.com
 [10.11.54.7])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 4B37618312CF;
 Thu, 12 Oct 2023 14:36:58 +0000 (UTC)
Received: from t14s.fritz.box (unknown [10.39.192.176])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 2A13C1C060DF;
 Thu, 12 Oct 2023 14:36:57 +0000 (UTC)
From: David Hildenbrand <david@redhat.com>
To: qemu-devel@nongnu.org
Cc: David Hildenbrand <david@redhat.com>, Tiwei Bie <tiwei.bie@intel.com>,
 Igor Mammedov <imammedo@redhat.com>, Peter Xu <peterx@redhat.com>,
 "Michael S . Tsirkin" <mst@redhat.com>
Subject: [GIT PULL 01/18] vhost: Rework memslot filtering and fix
 "used_memslot" tracking
Date: Thu, 12 Oct 2023 16:36:38 +0200
Message-ID: <20231012143655.114631-2-david@redhat.com>
...
index 3766b415f8..85e99061d3 100644
--- a/hw/virtio/vhost-user.c
+++ b/hw/virtio/vhost-user.c
@@ -2622,10 +2622,9 @@ vhost_user_crypto_close_session(struct vhost_dev *dev, uint64_t session_id)
     return 0;
 }
...
@@ -2868,6 +2867,7 @@ const VhostOps user_ops = {
...
@@ -2894,7 +2894,6 @@ const VhostOps user_ops = {
...
index 9cfac40fde..0edd31a7e8 100644
--- a/hw/virtio/vhost.c
+++ b/hw/virtio/vhost.c
@@ -45,20 +45,33 @@
...
index 1860b541d8..d4aa635153 100644
