...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 2DEEA83ED8D
	for <lists+qemu-devel@lfdr.de>; Sat, 27 Jan 2024 15:40:57 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rTjqM-0002Re-2z; Sat, 27 Jan 2024 09:39:38 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <arnaud.minier@telecom-paris.fr>)
 id 1rTjqH-0002PN-8h; Sat, 27 Jan 2024 09:39:33 -0500
Received: from zproxy4.enst.fr ([2001:660:330f:2::df])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <arnaud.minier@telecom-paris.fr>)
 id 1rTjqD-0002Pz-BT; Sat, 27 Jan 2024 09:39:33 -0500
Received: from localhost (localhost [IPv6:::1])
 by zproxy4.enst.fr (Postfix) with ESMTP id 0CFC220829;
...
Received: from zproxy4.enst.fr ([IPv6:::1])
 ...
 id a5Hz14aRITXT; Sat, 27 Jan 2024 15:39:23 +0100 (CET)
Received: from localhost (localhost [IPv6:::1])
 by zproxy4.enst.fr (Postfix) with ESMTP id 081DF20824;
 Sat, 27 Jan 2024 15:39:23 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.10.3 zproxy4.enst.fr 081DF20824
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=telecom-paris.fr;
 s=A35C7578-1106-11E5-A17F-C303FDDA8F2E; t=1706366363;
 bh=gzkMMzKsN7vqbmQkAadWLe9OPmFUkB2N4+fqA6JQWWc=;
 h=From:To:Date:Message-Id:MIME-Version;
 b=7k7bXpuXCqMEk3a8x+fF/UARcj226x8UWb7lGcpEUdbdeAmnzyrUYxfXeOIzWdidm
 4LU0FQIHOcUIDXLf2/uxVUg7LJaKBF9XwVFHVRianBSCporn1aPDt5iL16VG83TChu
 lBWBS6IUlwvQoodnNtRvPenO+QulJprSTpX/njFo=
X-Virus-Scanned: amavis at enst.fr
Received: from zproxy4.enst.fr ([IPv6:::1])
 by localhost (zproxy4.enst.fr [IPv6:::1]) (amavis, port 10026) with ESMTP
 id 328EcUQIoUt6; Sat, 27 Jan 2024 15:39:22 +0100 (CET)
Received: from AM-Inspiron-3585.numericable.fr (38.162.10.109.rev.sfr.net
 [109.10.162.38])
 by zproxy4.enst.fr (Postfix) with ESMTPSA id 6F85A20823;
...
Subject: [PATCH v3 2/8] Add an internal clock multiplexer object
Date: Sat, 27 Jan 2024 15:38:58 +0100
Message-Id: <20240127143904.80187-3-arnaud.minier@telecom-paris.fr>
...
index 38ca8aad7d..5013fa0c04 100644
...
@@ -329,6 +451,7 @@ static const ClockPortInitArray stm32l4x5_rcc_clocks =
=3D {
...
=20
@@ -338,6 +461,14 @@ static void stm32l4x5_rcc_init(Object *obj)
=20
...
=20
@@ -383,6 +514,7 @@ static const VMStateDescription vmstate_stm32l4x5_rcc=
 =3D {
...
@@ -392,10 +524,26 @@ static void stm32l4x5_rcc_realize(DeviceState *dev,=
 Error **errp)
             return;
         }
=20
...
@@ -427,6 +575,12 @@ static const TypeInfo stm32l4x5_rcc_types[] =3D {
