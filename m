...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F37AC31D09
	for <lists+qemu-devel@lfdr.de>; Tue, 04 Nov 2025 16:23:03 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1vGIro-0002Y1-7h; Tue, 04 Nov 2025 10:22:41 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <deller@kernel.org>) id 1vGIri-0002Pq-Rr
 for qemu-devel@nongnu.org; Tue, 04 Nov 2025 10:22:34 -0500
Received: from tor.source.kernel.org ([172.105.4.254])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <deller@kernel.org>) id 1vGIrW-0003z3-07
 for qemu-devel@nongnu.org; Tue, 04 Nov 2025 10:22:27 -0500
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
 by tor.source.kernel.org (Postfix) with ESMTP id ADD57601EC;
 Tue,  4 Nov 2025 15:22:13 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id F3A73C4CEF7;
 Tue,  4 Nov 2025 15:22:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=k20201202; t=1762269733;
 bh=cR4sdr9AUtlHU2Qs2vudW8QlHt+pg02BkSqNa2/pyl0=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Subject: [PULL v2 3/3] i82596: Implement enhanced TX/RX with packet queuing
 and filtering
Date: Tue,  4 Nov 2025 16:22:04 +0100
Message-ID: <20251104152204.6261-4-deller@kernel.org>
...
---
 hw/net/i82596.c     | 2206 ++++++++++++++++++++++++++++++-------------
 hw/net/trace-events |   21 +-
 2 files changed, 1585 insertions(+), 642 deletions(-)

diff --git a/hw/net/i82596.c b/hw/net/i82596.c
index 859cc88b2e..37dcc0387b 100644
--- a/hw/net/i82596.c
+++ b/hw/net/i82596.c
@@ -49,14 +49,6 @@
 #include "i82596.h"
