...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id D2ACF7409B1
	for <lists+qemu-devel@lfdr.de>; Wed, 28 Jun 2023 09:28:54 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qEPax-0007B1-W8; Wed, 28 Jun 2023 03:28:08 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <rbolshakov@ddn.com>)
 id 1qEOXe-0007lQ-58; Wed, 28 Jun 2023 02:20:38 -0400
Received: from outbound-ip7a.ess.barracuda.com ([209.222.82.174])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <rbolshakov@ddn.com>)
 id 1qEOXc-00057d-4S; Wed, 28 Jun 2023 02:20:37 -0400
Received: from NAM04-MW2-obe.outbound.protection.outlook.com
 (mail-mw2nam04lp2177.outbound.protection.outlook.com [104.47.73.177]) by
 mx-outbound41-38.us-east-2c.ess.aws.cudaops.com (version=TLSv1.2
 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NO);
 Wed, 28 Jun 2023 06:19:56 +0000
...
Received: from LV8PR19MB8249.namprd19.prod.outlook.com (2603:10b6:408:191::12)
 by CO6PR19MB5353.namprd19.prod.outlook.com (2603:10b6:303:144::19)
...
CC: "kvm@vger.kernel.org" <kvm@vger.kernel.org>, Marcel Apfelbaum
 <marcel.apfelbaum@gmail.com>, Peter Maydell <peter.maydell@linaro.org>,
 "qemu-arm@nongnu.org" <qemu-arm@nongnu.org>, Richard Henderson
 <richard.henderson@linaro.org>, Alexander Graf <agraf@csgraf.de>,
 "xen-devel@lists.xenproject.org" <xen-devel@lists.xenproject.org>, Sunil
 Muthuswamy <sunilmut@microsoft.com>, Anthony Perard
 <anthony.perard@citrix.com>, Stefano Stabellini <sstabellini@kernel.org>,
 Yanan Wang <wangyanan55@huawei.com>, Paul Durrant <paul@xen.org>, Reinoud
 Zandijk <reinoud@netbsd.org>, Eduardo Habkost <eduardo@habkost.net>, Cameron
 Esfahani <dirty@apple.com>, Paolo Bonzini <pbonzini@redhat.com>
Subject: Re: [PATCH v3 01/16] MAINTAINERS: Update Roman Bolshakov email address
...
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:LV8PR19MB8249.namprd19.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230028)(4636009)(366004)(396003)(136003)(39850400004)(346002)(376002)(451199021)(6512007)(66446008)(31686004)(38070700005)(26005)(66556008)(66476007)(122000001)(5660300002)(7416002)(66574015)(86362001)(8936002)(41300700001)(4326008)(316002)(8676002)(66946007)(76116006)(64756008)(31696002)(38100700002)(110136005)(966005)(36756003)(6506007)(6486002)(186003)(2906002)(15650500001)(71200400001)(83380400001)(54906003)(2616005)(478600001)(45980500001);
 DIR:OUT; SFP:1101; 
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 28 Jun 2023 06:19:51.9759 (UTC)
...
X-BESS-ID: 1687933195-110534-5423-89471-1
X-BESS-VER: 2019.1_20230620.2205
...
X-BESS-Outbound-Spam-Report: Code version 3.2,
 rules version 3.2.2.249133 [from 
 cloudscan16-57.us-east-2b.ess.aws.cudaops.com]
 Rule breakdown below
 pts rule name              description
 ---- ---------------------- --------------------------------
 0.50 BSF_RULE7568M          META: Custom Rule 7568M 
 0.00 BSF_BESS_OUTBOUND      META: BESS Outbound 
X-BESS-Outbound-Spam-Status: SCORE=0.50 using account:ESS124931 scores of
 KILL_LEVEL=7.0 tests=BSF_RULE7568M, BSF_BESS_OUTBOUND
X-BESS-BRTS-Status: 1
Received-SPF: pass client-ip=209.222.82.174; envelope-from=rbolshakov@ddn.com;
 helo=outbound-ip7a.ess.barracuda.com
X-Spam_score_int: -27
X-Spam_score: -2.8
X-Spam_bar: --
...
X-Mailman-Approved-At: Wed, 28 Jun 2023 03:27:59 -0400
