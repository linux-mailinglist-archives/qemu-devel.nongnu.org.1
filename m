...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id BEC74876C8C
	for <lists+qemu-devel@lfdr.de>; Fri,  8 Mar 2024 22:56:12 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1riiAw-0007e0-77; Fri, 08 Mar 2024 16:54:46 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <dbarboza@ventanamicro.com>)
 id 1riiAt-0007dK-C0
 for qemu-devel@nongnu.org; Fri, 08 Mar 2024 16:54:43 -0500
...
Received: by mail-pl1-x62b.google.com with SMTP id
 d9443c01a7336-1dc13fb0133so10189085ad.3
 for <qemu-devel@nongnu.org>; Fri, 08 Mar 2024 13:54:39 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=ventanamicro.com; s=google; t=1709934877; x=1710539677; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=xY2Z5IfTd1KSvbyDHbvcolpsGrUFi+DEGWTZK45ysGY=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=xY2Z5IfTd1KSvbyDHbvcolpsGrUFi+DEGWTZK45ysGY=;
 b=
X-Gm-Message-State: AOJu0Yzx7Gl7mEYMiKodvkFX9+YnKgiwQH0mgIUwardzWm5nzXTARPgy
 f/JJSi/eRpQZSxCJ3Wi0TNUbW79Xic0QjpgUVywc99VcUZczGAsZktgZdmAtuhRPbRb2E/nmTU9
 e
X-Google-Smtp-Source: AGHT+IES/gqMH93Kvw5XLV4ZY0qYRdzZezppdL/ETFJptCRPbuH0Kefeq42NdH30EKoet0ltqnzyhw==
X-Received: by 2002:a17:902:b198:b0:1db:c390:1fdc with SMTP id
 s24-20020a170902b19800b001dbc3901fdcmr340473plr.1.1709934876747; 
 Fri, 08 Mar 2024 13:54:36 -0800 (PST)
Received: from grind.. ([177.94.15.159]) by smtp.gmail.com with ESMTPSA id
 d3-20020a170902b70300b001dd66e6ec91sm107702pls.140.2024.03.08.13.54.33
...
Subject: [PATCH v8 07/10] target/riscv: remove 'over' brconds from vector trans
Date: Fri,  8 Mar 2024 18:53:47 -0300
Message-ID: <20240308215402.117405-8-dbarboza@ventanamicro.com>
...
-        gen_set_label(over);
     ...
     return false;
@@ -3637,8 +3538,6 @@ static bool trans_vcompress_vm(DisasContext *s, arg_r *a)
...
@@ -3648,7 +3547,6 @@ static bool trans_vcompress_vm(DisasContext *s, arg_r *a)
                            s->cfg_ptr->vlenb, data,
                            fns[s->sew]);
         mark_vs_dirty(s);
-        gen_set_label(over);
     ...
     return false;
@@ -3671,12 +3569,9 @@ static bool trans_##NAME(DisasContext *s, arg_##NAME * a)               \
...
@@ -3705,8 +3600,6 @@ static bool int_ext_op(DisasContext *s, arg_rmr *a, uint8_t seq)
 {
     uint32_t data = 0;
...
-    tcg_gen_brcond_tl(TCG_COND_GEU, cpu_vstart, cpu_vl, over);
     ...
     static gen_helper_gvec_3_ptr * const fns[6][4] = {
         {
@@ -3751,7 +3644,6 @@ static bool int_ext_op(DisasContext *s, arg_rmr *a, uint8_t seq)
                        s->cfg_ptr->vlenb, data, fn);
