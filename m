...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id ABD417B79E8
	for <lists+qemu-devel@lfdr.de>; Wed,  4 Oct 2023 10:20:27 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qnx6Q-0001es-RQ; Wed, 04 Oct 2023 04:19:30 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <marcandre.lureau@gmail.com>)
 id 1qnx6P-0001ee-44
 for qemu-devel@nongnu.org; Wed, 04 Oct 2023 04:19:29 -0400
Received: from mail-qt1-x829.google.com ([2607:f8b0:4864:20::829])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <marcandre.lureau@gmail.com>)
 id 1qnx6L-0007as-1e
 for qemu-devel@nongnu.org; Wed, 04 Oct 2023 04:19:28 -0400
Received: by mail-qt1-x829.google.com with SMTP id
 d75a77b69052e-4196c617ef0so12046691cf.1
 for <qemu-devel@nongnu.org>; Wed, 04 Oct 2023 01:19:24 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1696407564; x=1697012364; darn=nongnu.org;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:from:to:cc:subject:date
 :message-id:reply-to;
 bh=GHHa/+nHm2wpk7uZM9Mnotz3CoccNtiS0CAEJRaTai0=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1696407564; x=1697012364;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=GHHa/+nHm2wpk7uZM9Mnotz3CoccNtiS0CAEJRaTai0=;
 b=
X-Gm-Message-State: AOJu0YzFipbxPuKZJeZvDOReNJDwsf74euTWD4bH0YLndfgoEs5lHnw8
 J7fxGiQGgdpwDogmLfoClx2n+L3OGlb1MdzQzW0=
X-Google-Smtp-Source: AGHT+IGH3wwOP2vFYyw/AgiBIHNaoKRlmSEQug0Zy6e/ZjOSYEi1ojYooYv8+jaoLHD+WRwvN6VZtpLGSD/Z+1YZo7o=
X-Received: by 2002:a05:622a:10e:b0:418:2cb:f953 with SMTP id
 u14-20020a05622a010e00b0041802cbf953mr1875259qtw.17.1696407563557; Wed, 04
 Oct 2023 01:19:23 -0700 (PDT)
MIME-Version: 1.0
References: <20231003204500.518-1-gurchetansingh@chromium.org>
 <20231003204500.518-7-gurchetansingh@chromium.org>
In-Reply-To: <20231003204500.518-7-gurchetansingh@chromium.org>
From: =?UTF-8?B?TWFyYy1BbmRyw6kgTHVyZWF1?= <marcandre.lureau@gmail.com>
Date: Wed, 4 Oct 2023 12:19:11 +0400
Message-ID: <CAJ+F1CK8+dRED_fys_drp9ePMoEaisBXCYoEzOsr8n3hbWk5Jg@mail.gmail.com>
Subject: Re: [PATCH v15 6/9] gfxstream + rutabaga: add initial support for
 gfxstream
...
A few minor comments, after that I'd ack & merge the series.

Fwiw, rutabaga is now in Fedora rawhide
(https://bugzilla.redhat.com/bugzilla/show_bug.cgi?id=3D2238751)

gfxstream is up for review
(https://bugzilla.redhat.com/bugzilla/show_bug.cgi?id=3D2242058)

On Wed, Oct 4, 2023 at 2:09=E2=80=AFAM Gurchetan Singh
...
> +
> +    /*
> +     * There is small risk of the MemoryRegion still deferencing the poi=
nter
...
Side comment: I wish we would make enum properties easier with QAPI..
...
I'd use g_get_user_runtime_dir() instead

> +        const char *display =3D getenv("WAYLAND_DISPLAY");

g_getenv() (for portability, eventually)
...
I'd switch to g_build_filename() instead (with a g_auto path)
