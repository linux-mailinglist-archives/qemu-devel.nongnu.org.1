...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id A8A4C809301
	for <lists+qemu-devel@lfdr.de>; Thu,  7 Dec 2023 22:06:24 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rBLXy-0002hk-Kg; Thu, 07 Dec 2023 16:04:39 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <nicolas.eder@lauterbach.com>)
 id 1rBLXt-0002hC-My
 for qemu-devel@nongnu.org; Thu, 07 Dec 2023 16:04:34 -0500
Received: from smtp1.lauterbach.com ([62.154.241.196])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <nicolas.eder@lauterbach.com>)
 id 1rBLXq-0005od-Jk
 for qemu-devel@nongnu.org; Thu, 07 Dec 2023 16:04:33 -0500
Received: (qmail 10466 invoked by uid 484); 7 Dec 2023 21:04:18 -0000
X-Qmail-Scanner-Diagnostics: from nedpc1.intern.lauterbach.com by
 smtp1.lauterbach.com (envelope-from <nicolas.eder@lauterbach.com>,
 uid 484) with qmail-scanner-2.11 
 (mhr: 1.0. clamdscan: 0.99/21437. spamassassin: 3.4.0.  
 Clear:RC:1(10.2.11.92):. 
 Processed in 0.15476 secs); 07 Dec 2023 21:04:18 -0000
Received: from nedpc1.intern.lauterbach.com
 (Authenticated_SSL:neder@[10.2.11.92])
 (envelope-sender <nicolas.eder@lauterbach.com>)
 by smtp1.lauterbach.com (qmail-ldap-1.03) with TLS_AES_256_GCM_SHA384
 encrypted SMTP for <qemu-devel@nongnu.org>; 7 Dec 2023 21:04:17 -0000
...
Subject: [PATCH v4 12/17] mcdstub: all core specific queries added
Date: Thu,  7 Dec 2023 22:03:53 +0100
Message-Id: <20231207210358.7409-13-nicolas.eder@lauterbach.com>
...
@@ -897,6 +897,301 @@ static void handle_query_cores(GArray *params, void *user_ctx)
     mcd_put_strbuf();
 }
...
+
  ...
  *
@@ -922,6 +1217,76 @@ static void init_query_cmds_table(MCDCmdParseEntry *mcd_query_cmds_table)
     };
