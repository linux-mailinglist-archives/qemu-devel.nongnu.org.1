...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 0DBA77604DC
	for <lists+qemu-devel@lfdr.de>; Tue, 25 Jul 2023 03:42:03 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qO72W-00084Y-PQ; Mon, 24 Jul 2023 21:40:40 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <outgoing@sr.ht>) id 1qO72T-00083L-HK
 for qemu-devel@nongnu.org; Mon, 24 Jul 2023 21:40:37 -0400
Received: from mail-b.sr.ht ([173.195.146.151])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <outgoing@sr.ht>) id 1qO72R-0008LE-RK
 for qemu-devel@nongnu.org; Mon, 24 Jul 2023 21:40:37 -0400
Authentication-Results: mail-b.sr.ht; dkim=none 
Received: from git.sr.ht (unknown [173.195.146.142])
 by mail-b.sr.ht (Postfix) with ESMTPSA id 9138C11EF58;
 Tue, 25 Jul 2023 01:40:32 +0000 (UTC)
From: ~hyman <hyman@git.sr.ht>
Date: Thu, 08 Jun 2023 00:12:40 +0800
Subject: [PATCH QEMU v10 7/9] migration: Implement dirty-limit convergence
 algorithm
MIME-Version: 1.0
Message-ID: <169024923116.19090.10825599068950039132-7@git.sr.ht>
X-Mailer: git.sr.ht
