...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 93C6CC50AC1
	for <lists+qemu-devel@lfdr.de>; Wed, 12 Nov 2025 07:05:58 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1vJ3xv-0002fK-Gj; Wed, 12 Nov 2025 01:04:23 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <zhiwei_liu@linux.alibaba.com>)
 id 1vJ3xt-0002eC-HJ; Wed, 12 Nov 2025 01:04:21 -0500
Received: from out30-133.freemail.mail.aliyun.com ([115.124.30.133])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <zhiwei_liu@linux.alibaba.com>)
 id 1vJ3xp-0002qw-GI; Wed, 12 Nov 2025 01:04:21 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linux.alibaba.com; s=default;
 t=1762927443; h=Message-ID:Date:MIME-Version:Subject:To:From:Content-Type;
 bh=aGYg8utZIm35ShdxFAOPsZ8VhTO7Hl17Ql7O0eoL+wU=;
 b=DtJn1SwNyCHUBnWNlWtdOmxqxHPH8Ut6BK5Dlnb7Mg/jHVfnM3fnUo6uEXJzq/haKXDG2OCFTcvjfZaHFVF2S5MKi6XN/eDfYe4ug5p5SmnJsCShUXHuOOfr02sj+gAyqjzlbtq1TYNSOPMc8qbrAuGrG58ePuVfSBA5Hypspvg=
Received: from 30.166.65.49(mailfrom:zhiwei_liu@linux.alibaba.com
 fp:SMTPD_---0WsF2Bi-_1762927441 cluster:ay36) by smtp.aliyun-inc.com;
 Wed, 12 Nov 2025 14:04:02 +0800
Message-ID: <7182e022-82aa-4fd2-ac31-f8685e7bb980@linux.alibaba.com>
Date: Wed, 12 Nov 2025 14:04:01 +0800
MIME-Version: 1.0
...
References: <20250918061911.904-1-zhiwei_liu@linux.alibaba.com>
 ...
 <CAKmqyKM9rGk+b6q_6mfwP_RL-GMhgiKZhRC_QJtgKvA394aeSQ@mail.gmail.com>
Content-Language: en-US
From: LIU Zhiwei <zhiwei_liu@linux.alibaba.com>
In-Reply-To: <CAKmqyKM9rGk+b6q_6mfwP_RL-GMhgiKZhRC_QJtgKvA394aeSQ@mail.gmail.com>
...
On 11/12/25 12:31 PM, Alistair Francis wrote:
> On Thu, Sep 18, 2025 at 4:21 PM LIU Zhiwei <zhiwei_liu@linux.alibaba.com> wrote:
...
> ‘get_physical_address_pmp’ follows non-static declaration
...
> ‘get_physical_address_pmp’ with type ‘int(CPURISCVState *, int *,
> hwaddr,  int,  MMUAccessType,  i
> nt)’ {aka ‘int(struct CPUArchState *, int *, long unsigned int,  int,
> MMUAccessType,  int)’}
>    88 | int get_physical_address_pmp(CPURISCVState *env, int *prot, hwaddr addr,
>       |     ^~~~~~~~~~~~~~~~~~~~~~~~
> ninja: build stopped: subcommand failed.

Sorry, I see that this build error has been fixed in patch 3,  so the 
patch set can be built. I will send a v3 patch set to move this part in 
patch 3 to  patch 2 and test each patch in patch set v3.
