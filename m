...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id BBE187BA8EB
	for <lists+qemu-devel@lfdr.de>; Thu,  5 Oct 2023 20:18:46 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qoSuY-0000Ke-Eq; Thu, 05 Oct 2023 14:17:22 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <vikram.garhwal@amd.com>)
 id 1qoSuV-0000KF-PU
 for qemu-devel@nongnu.org; Thu, 05 Oct 2023 14:17:19 -0400
...
Subject: [QEMU][PATCH v1 4/7] xen: let xen_ram_addr_from_mapcache() return -1
