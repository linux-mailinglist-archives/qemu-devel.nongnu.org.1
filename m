...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id B9A8C908C39
	for <lists+qemu-devel@lfdr.de>; Fri, 14 Jun 2024 15:04:23 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1sI6at-00055F-1r; Fri, 14 Jun 2024 09:03:51 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <zhiwei_liu@linux.alibaba.com>)
 id 1sI6aq-00054i-7t; Fri, 14 Jun 2024 09:03:48 -0400
Received: from out30-112.freemail.mail.aliyun.com ([115.124.30.112])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <zhiwei_liu@linux.alibaba.com>)
 id 1sI6aj-0005Bv-27; Fri, 14 Jun 2024 09:03:47 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linux.alibaba.com; s=default;
 t=1718370207; h=Message-ID:Date:MIME-Version:Subject:To:From:Content-Type;
 bh=TPedL+N7DST+TD70kn9aSPIXvLetn90tgOtxy5MPaF8=;
 b=ha8IdqKXYXQrLpH5C2xuCygTtv9T2NRPImsK+C2dNiCFM740HO3a+Lw/lkTfKXxabvFEU5zB5b0Dc2HrIFuZZWuiiUUpob6lMBbY0mXsA4zwkf5iuebTRCpE1YTXPeoGknEYXArWHRG1lOCVs+POhaaf6FQ4QSdx5IlMwC065M8=
X-Alimail-AntiSpam: AC=PASS; BC=-1|-1; BR=01201311R191e4; CH=green; DM=||false|;
 DS=||; FP=0|-1|-1|-1|0|-1|-1|-1; HT=maildocker-contentspam033045046011;
 MF=zhiwei_liu@linux.alibaba.com; NM=1; PH=DS; RN=9; SR=0;
 TI=SMTPD_---0W8RBPsE_1718370205; 
Received: from 30.166.65.72(mailfrom:zhiwei_liu@linux.alibaba.com
 fp:SMTPD_---0W8RBPsE_1718370205) by smtp.aliyun-inc.com;
 Fri, 14 Jun 2024 21:03:26 +0800
Message-ID: <e52b1867-acde-4bc7-b7ad-0b7aa7fa29e8@linux.alibaba.com>
Date: Fri, 14 Jun 2024 21:02:16 +0800
MIME-Version: 1.0
...
References: <20240612031706.2927602-1-ethan84@andestech.com>
 ...
 <c3a93c65-c2b2-4215-912b-12850b878f32@linux.alibaba.com>
 <Zmug+k8k+6HsveGC@ethan84-VirtualBox>
...
In-Reply-To: <Zmug+k8k+6HsveGC@ethan84-VirtualBox>
...
>> Should we report an error here? IMHO, we can assert it.
> It just check the device is from system bus or pci bus.
> There should not be any errors here.
I see. It makes sense when we connect to PCI bus and usually  PCI 
devices will not set the requester id.
>
...
>>> +    start_addr = addr;
>>> +    end_addr = addr;
>> If that's true, can we exactly get the ENTRY_HIT or ENTRY_PAR_HIT?
>>
>> I think it is necessary to pass the transaction length to translate
>> function.
> Without transaction length, ENTRY_PAR_HIT will not occur.
> We only get ENTRY_HIT or ENTRY_NO_HIT by matching the start address of
> the transaction.

IMHO, as you have set entry.addr_mask to zero, you are checking the 
transaction one by one byte.
It is low efficient but correct. Is it right?
...
>>> +    }
>> I think we are only use IOMMUMemoryRegion for remapping.  Is there any
>> reason to make them different?
>>
> The only different thing is the pci_id. We can get the id by
> IOMMUMemoryRegion name.
>
> Thanks,
> Ethan
>
