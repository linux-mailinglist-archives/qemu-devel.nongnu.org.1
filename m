...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 6EFA7ACC2CB
	for <lists+qemu-devel@lfdr.de>; Tue,  3 Jun 2025 11:20:02 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1uMNnX-0008Do-Ti; Tue, 03 Jun 2025 05:19:07 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <odaki@rsg.ci.i.u-tokyo.ac.jp>)
 id 1uMNnU-0008DC-Gz
 for qemu-devel@nongnu.org; Tue, 03 Jun 2025 05:19:05 -0400
Received: from www3579.sakura.ne.jp ([49.212.243.89])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <odaki@rsg.ci.i.u-tokyo.ac.jp>)
 id 1uMNnN-0006qf-C4
 for qemu-devel@nongnu.org; Tue, 03 Jun 2025 05:19:04 -0400
Received: from [157.82.207.189] ([157.82.207.189]) (authenticated bits=0)
 by www3579.sakura.ne.jp (8.16.1/8.16.1) with ESMTPSA id 5539IXBs068202
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NO);
 Tue, 3 Jun 2025 18:18:44 +0900 (JST)
 (envelope-from odaki@rsg.ci.i.u-tokyo.ac.jp)
DKIM-Signature: a=rsa-sha256; bh=QJrj51eDjJVbQYi1bbXE3OknJC5inGGvmEo0aLk9YHU=; 
 c=relaxed/relaxed; d=rsg.ci.i.u-tokyo.ac.jp;
 h=From:Date:Subject:Message-Id:To;
 s=rs20250326; t=1748942324; v=1;
 b=
From: Akihiko Odaki <odaki@rsg.ci.i.u-tokyo.ac.jp>
Date: Tue, 03 Jun 2025 18:18:29 +0900
Subject: [PATCH v3 2/2] ui/vnc: Introduce the VncWorker type
MIME-Version: 1.0
...
X-Spam_report: (0.3 / 5.0 requ) BAYES_00=-1.9, DKIM_INVALID=0.1,
 DKIM_SIGNED=0.1, PDS_OTHER_BAD_TLD=1.999,
...
index 82b883bb69fa5ce331945dcffe25588d5fd73f50..8b0afdd17aba06058bbac237eac2b4eeb4efea06 100644
--- a/ui/vnc.h
+++ b/ui/vnc.h
...
@@ -613,17 +622,21 @@ void vnc_hextile_set_pixel_conversion(VncState *vs, int generic);
...
index 25c7b2c7889c04253652f63730329052703a10a1..9dfe6ae5a2435ea3c11ebeea85cf51416c7d6841 100644
...
index 52e9193eab572a79733b11c89bde81daf01679e7..a6d287118aaaed30372d90668f0406de4d14599c 100644
--- a/ui/vnc-enc-zlib.c
+++ b/ui/vnc-enc-zlib.c
...
index 97ec6c7119bc6da3af0e46e73a9e36220646d010..7679014c9e3379e21390f5815163854f5283700c 100644
--- a/ui/vnc-enc-zrle.c
+++ b/ui/vnc-enc-zrle.c
...
index d3486af9e2138aaf5e0bb24ed3e7c97940582820..bed33950a8791e7915f3396933b0ed1d474b1575 100644
--- a/ui/vnc-jobs.c
+++ b/ui/vnc-jobs.c
...
index 59009ff61b350487153960d0236eb438f93e665b..0556b154a840f5a2e7ecc8dba35415eaed077966 100644
--- a/ui/vnc.c
+++ b/ui/vnc.c
@@ -56,11 +56,6 @@
...
index 2ef7501d52165f80fd6af8aab8e7d7097b283399..68d28f58b7ef3a96a149a740b3f90b641ec80f40 100644
