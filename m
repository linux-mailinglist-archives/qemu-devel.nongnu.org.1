...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 6CD57839399
	for <lists+qemu-devel@lfdr.de>; Tue, 23 Jan 2024 16:49:29 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rSJ0d-00034e-W5; Tue, 23 Jan 2024 10:48:20 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mjt@tls.msk.ru>)
 id 1rSIzx-0002oa-CR; Tue, 23 Jan 2024 10:47:37 -0500
Received: from isrv.corpit.ru ([86.62.121.231])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mjt@tls.msk.ru>)
 id 1rSIzs-0000h1-Vf; Tue, 23 Jan 2024 10:47:37 -0500
Received: from tsrv.corpit.ru (tsrv.tls.msk.ru [192.168.177.2])
 by isrv.corpit.ru (Postfix) with ESMTP id 4B41646921;
 Tue, 23 Jan 2024 18:47:50 +0300 (MSK)
Received: from tls.msk.ru (mjt.wg.tls.msk.ru [192.168.177.130])
 by tsrv.corpit.ru (Postfix) with SMTP id 4699469EB0;
 Tue, 23 Jan 2024 18:47:09 +0300 (MSK)
Received: (nullmailer pid 3847906 invoked by uid 1000);
...
Subject: [Stable-8.2.1 42/54] target/i386: pcrel: store low bits of physical
 address in data[0]
Date: Tue, 23 Jan 2024 18:46:43 +0300
Message-Id: <20240123154708.3847837-4-mjt@tls.msk.ru>
...
index 312ca0d594..8fd49ff474 100644
--- a/target/i386/tcg/translate.c
+++ b/target/i386/tcg/translate.c
@@ -6972,7 +6972,6 @@ static void i386_tr_insn_start(DisasContextBase *dcbase, CPUState *cpu)
