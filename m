...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A52BAA4264
	for <lists+qemu-devel@lfdr.de>; Wed, 30 Apr 2025 07:32:14 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1uA00D-0002dq-Bd; Wed, 30 Apr 2025 01:29:01 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mario.fleischmann@lauterbach.com>)
 id 1u9zzo-0002IK-O7
 for qemu-devel@nongnu.org; Wed, 30 Apr 2025 01:28:37 -0400
Received: from smtp1.lauterbach.com ([62.154.241.196])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mario.fleischmann@lauterbach.com>)
 id 1u9zzj-0006lJ-B5
 for qemu-devel@nongnu.org; Wed, 30 Apr 2025 01:28:35 -0400
Received: (qmail 2042 invoked by uid 484); 30 Apr 2025 05:28:07 -0000
X-Qmail-Scanner-Diagnostics: from 10.2.13.100 by smtp1.lauterbach.com
 ...
 Processed in 0.013269 secs); 30 Apr 2025 05:28:07 -0000
...
Subject: [PATCH v2 19/20] mcd: Implement trigger control
Date: Wed, 30 Apr 2025 07:27:40 +0200
Message-Id: <20250430052741.21145-20-mario.fleischmann@lauterbach.com>
...
---
 ...
 mcd/mcd_stub.c   | 290 +++++++++++++++++++++++
 qapi/mcd.json    | 588 +++++++++++++++++++++++++++++++++++++++++++++++
 5 files changed, 1618 insertions(+), 19 deletions(-)

diff --git a/mcd/mcd_qapi.c b/mcd/mcd_qapi.c
index 1cbf61e..b0a995e 100644
--- a/mcd/mcd_qapi.c
+++ b/mcd/mcd_qapi.c
...
@@ -115,8 +125,24 @@ static mcdserver_state g_server_state = {
     .open_server = NULL,
     .system_key = "",
     .cores = NULL,
+    .bp_cpu = NULL,
...
@@ -1536,6 +2064,26 @@ mcd_return_et mcd_qry_state_f(const mcd_core_st *core, mcd_core_state_st *state)
         break;
     }
