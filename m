...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 54DC9753583
	for <lists+qemu-devel@lfdr.de>; Fri, 14 Jul 2023 10:49:59 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qKESi-0004v3-HY; Fri, 14 Jul 2023 04:47:40 -0400
...
Received: from mail.loongson.cn ([114.242.206.163])
 ...
 (envelope-from <gaosong@loongson.cn>) id 1qKERy-0004um-VS
 for qemu-devel@nongnu.org; Fri, 14 Jul 2023 04:46:58 -0400
Received: from loongson.cn (unknown [10.2.5.185])
 by gateway (Coremail) with SMTP id _____8Cx5_FyC7Fkr84EAA--.13580S3;
 Fri, 14 Jul 2023 16:46:42 +0800 (CST)
Received: from localhost.localdomain (unknown [10.2.5.185])
 by localhost.localdomain (Coremail) with SMTP id
 AQAAf8AxzyNYC7FkFOotAA--.22026S41; 
 Fri, 14 Jul 2023 16:46:41 +0800 (CST)
From: Song Gao <gaosong@loongson.cn>
To: qemu-devel@nongnu.org
Cc: richard.henderson@linaro.org
Subject: [PATCH v3 39/47] target/loongarch: Implement xvseq xvsle xvslt
Date: Fri, 14 Jul 2023 16:46:07 +0800
Message-Id: <20230714084615.2448038-40-gaosong@loongson.cn>
...
X-CM-TRANSID: AQAAf8AxzyNYC7FkFOotAA--.22026S41
...
@@ -3720,7 +3720,8 @@ TRANS(vffintl_d_w, gen_vv_f, 16, gen_helper_vffintl_d_w)
...
@@ -3730,7 +3731,7 @@ static bool do_cmp(DisasContext *ctx, arg_vvv *a, MemOp mop, TCGCond cond)
...
@@ -3765,145 +3766,147 @@ static void gen_vslti_u_vec(unsigned vece, TCGv_vec t, TCGv_vec a, int64_t imm)
...
index 4d6b5a202f..e6c7441313 100644
