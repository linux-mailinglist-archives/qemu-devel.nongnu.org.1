...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 18F4F7CEA6B
	for <lists+qemu-devel@lfdr.de>; Wed, 18 Oct 2023 23:58:50 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qtEVe-0002Ai-Jo; Wed, 18 Oct 2023 17:55:22 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <richard.henderson@linaro.org>)
 id 1qtEVc-00023r-DB
 for qemu-devel@nongnu.org; Wed, 18 Oct 2023 17:55:20 -0400
...
Received: by mail-ot1-x332.google.com with SMTP id
 46e09a7af769-6c4b9e09521so4800950a34.3
 for <qemu-devel@nongnu.org>; Wed, 18 Oct 2023 14:55:16 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linaro.org; s=google; t=1697666115; x=1698270915; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=1YSWkebDb1aF25YdLI3KCaxkO43bstvjPk/lV3yHWuY=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1697666115; x=1698270915;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=1YSWkebDb1aF25YdLI3KCaxkO43bstvjPk/lV3yHWuY=;
 b=
X-Gm-Message-State: AOJu0Yw1KZgMcK3lOn/y/3EOurIew3OCALT+jAKgKQGfYndXm1WOis5s
 OAAO/jQtN93HenRuIOaX5Vcl+/5goW478xDYkxk=
X-Google-Smtp-Source: AGHT+IHuBzkMKwKb7KhNKXxT1TJzncNLvI9ijKGvX9STx5wFCx3OlpNQw/NVb1kZriA3zIid40NYTQ==
X-Received: by 2002:a05:6358:9f8f:b0:166:e1cc:bc27 with SMTP id
 fy15-20020a0563589f8f00b00166e1ccbc27mr232766rwb.10.1697666115068; 
 Wed, 18 Oct 2023 14:55:15 -0700 (PDT)
Received: from stoup.. ([71.212.149.95]) by smtp.gmail.com with ESMTPSA id
 r15-20020aa7962f000000b006889348ba6esm3796263pfg.127.2023.10.18.14.55.14
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 18 Oct 2023 14:55:14 -0700 (PDT)
From: Richard Henderson <richard.henderson@linaro.org>
To: qemu-devel@nongnu.org
Cc: deller@gmx.de
Subject: [PATCH 46/61] target/hppa: Remove TARGET_REGISTER_BITS
Date: Wed, 18 Oct 2023 14:51:20 -0700
Message-Id: <20231018215135.1561375-47-richard.henderson@linaro.org>
...
Rely only on TARGET_LONG_BITS, fixed at 64, and is_pa20.
...
index 251f85444a..5ce05046c0 100644
--- a/target/hppa/cpu.h
+++ b/target/hppa/cpu.h
@@ -141,22 +141,10 @@
 #define CR_IPSW          22
...
@@ -257,8 +245,8 @@ void hppa_translate_init(void);
...
+                                             target_ulong off)
 {
     ...
     return off;
@@ -269,7 +257,7 @@ static inline target_ulong hppa_form_gva_psw(target_ureg psw, uint64_t spc,
 }
...
@@ -313,8 +301,8 @@ static inline void cpu_get_tb_cpu_state(CPUHPPAState *env, vaddr *pc,
...
@@ -328,8 +316,8 @@ static inline void cpu_get_tb_cpu_state(CPUHPPAState *env, vaddr *pc,
     *pflags = flags;
 }
...
index bbb6080e2d..5654061a69 100644
--- a/target/hppa/cpu.c
+++ b/target/hppa/cpu.c
...
index 04cdbafe9d..f112648764 100644
...
-#endif
     ...
     cb |= ((psw >> 13) & 1) << 24;
     cb |= ((psw >> 12) & 1) << 20;
@@ -121,8 +111,8 @@ void hppa_cpu_dump_state(CPUState *cs, FILE *f, int flags)
 {
     HPPACPU *cpu = HPPA_CPU(cs);
...
+    target_ulong psw_cb;
     ...
     int i, w;
     uint64_t m;
@@ -155,8 +145,8 @@ void hppa_cpu_dump_state(CPUState *cs, FILE *f, int flags)
...
index d6f46b18e9..96fc3103f8 100644
...
index 44dcf310b6..46a9e83508 100644
