...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 67B9DD03064
	for <lists+qemu-devel@lfdr.de>; Thu, 08 Jan 2026 14:28:43 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1vdq2f-0001DE-1J; Thu, 08 Jan 2026 08:27:09 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <max.chou@sifive.com>)
 id 1vdq2b-0001A6-MT
 for qemu-devel@nongnu.org; Thu, 08 Jan 2026 08:27:06 -0500
Received: from mail-pj1-x102e.google.com ([2607:f8b0:4864:20::102e])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <max.chou@sifive.com>)
 id 1vdq2X-0003XA-HH
 for qemu-devel@nongnu.org; Thu, 08 Jan 2026 08:27:05 -0500
Received: by mail-pj1-x102e.google.com with SMTP id
 98e67ed59e1d1-34c565b888dso2769376a91.0
 for <qemu-devel@nongnu.org>; Thu, 08 Jan 2026 05:27:01 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=sifive.com; s=google; t=1767878820; x=1768483620; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=26O6YszVy3nfqJ+E4kh92IDIvaEnpWYuQGOVJi1aK9M=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1767878820; x=1768483620;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-gg:x-gm-message-state:from
 :to:cc:subject:date:message-id:reply-to;
 bh=26O6YszVy3nfqJ+E4kh92IDIvaEnpWYuQGOVJi1aK9M=;
 b=
X-Gm-Message-State: AOJu0YwM+Zuh78Uk8+pjBUHSZs9Iu5UJGulHbdcTA1a0jvdm3lnaizMW
 /lZVUSRyesJyOD6bOhGXEeuQnNhWIw2OwE6Rog3fkyHbIaqUklaD8cU6dCDTifs09UWQxmmvGkt
 rR2hozBNZZnQmuA+7iGZ/xkfdC/XHWloORYb+fqz3vyWcdNAcjc++p4nj6vlB+8OHIn84bQhxwH
 OgxtzLUJr1qyk6e2lG7rY/3a1eQrVcL/YuPCYMuvg=
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IHqg3740KKxc9eWmrtSc0x6vl0G+TN5w764EE1pxKXPFWvtwTIhCMBuTQPmSWLFm2JpM0CNrg==
X-Received: by 2002:a17:90b:582f:b0:341:761c:3330 with SMTP id
 98e67ed59e1d1-34f68c4d711mr5672341a91.23.1767878819244; 
 Thu, 08 Jan 2026 05:26:59 -0800 (PST)
Received: from duncan.localdomain (114-35-142-126.hinet-ip.hinet.net.
 [114.35.142.126]) by smtp.gmail.com with ESMTPSA id
 98e67ed59e1d1-34f6ae3f033sm2298787a91.0.2026.01.08.05.26.57
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 08 Jan 2026 05:26:58 -0800 (PST)
...
Subject: [PATCH v2 8/9] target/riscv: rvv: Support Zvfbfa vector bf16
 operations
Date: Thu,  8 Jan 2026 21:26:29 +0800
Message-ID: <20260108132631.9429-9-max.chou@sifive.com>
...
---
 ...
 target/riscv/insn_trans/trans_rvv.c.inc    | 986 +++++++++++++--------
 target/riscv/internals.h                   |   1 +
 target/riscv/vector_helper.c               | 329 +++++++
 5 files changed, 999 insertions(+), 379 deletions(-)
...
index 066dc364c5..6cfda03d2e 100644
...
index 3315397257..bcd45b0aa3 100644
...
+        }
     ...
     case MO_16:
         return s->cfg_ptr->ext_zve32f;
@@ -2345,10 +2354,11 @@ GEN_OPIWI_NARROW_TRANS(vnclip_wi, IMM_ZX, vnclip_wx)
...
@@ -2362,25 +2372,39 @@ static void do_nanbox(DisasContext *s, TCGv_i64 out, TCGv_i64 in)
     }
 }
...
+    if (CHECK(s, a, -1)) {                                         \
         ...
         static gen_helper_gvec_4_ptr * const fns[3] = {            \
             gen_helper_##NAME##_h,                                 \
@@ -2406,14 +2430,48 @@ static bool trans_##NAME(DisasContext *s, arg_rmrr *a)             \
     }                                                              \
     return false;                                                  \
 }
...
+                        bool do_bf16_nanbox)
 {
     ...
     TCGv_i32 desc;
@@ -2431,7 +2489,7 @@ static bool opfvf_trans(uint32_t vd, uint32_t rs1, uint32_t vs2,
...
@@ -2443,244 +2501,316 @@ static bool opfvf_trans(uint32_t vd, uint32_t rs1, uint32_t vs2,
  * If the current SEW does not correspond to a supported IEEE floating-point
  * type, an illegal instruction exception is raised
  */
...
@@ -2688,21 +2818,23 @@ GEN_OPFVF_WIDEN_TRANS(vfwnmsac_vf, opfvf_overwrite_widen_check)
  * If the current SEW does not correspond to a supported IEEE floating-point
  * type, an illegal instruction exception is raised
  */
...
@@ -2720,76 +2852,95 @@ static bool do_opfv(DisasContext *s, arg_rmr *a,
     return false;
 }
...
+        vext_check_altfmt(s, MO_16)) {
         ...
         TCGv_i64 t1;
@@ -2797,7 +2948,7 @@ static bool trans_vfmv_v_f(DisasContext *s, arg_vfmv_v_f *a)
...
+            do_nanbox(s, t1, cpu_fpr[a->rs1], true);
             ...
             tcg_gen_gvec_dup_i64(s->sew, vreg_ofs(s, a->rd),
                                  MAXSZ(s), MAXSZ(s), t1);
@@ -2810,12 +2961,12 @@ static bool trans_vfmv_v_f(DisasContext *s, arg_vfmv_v_f *a)
...
@@ -2831,15 +2982,15 @@ static bool trans_vfmv_v_f(DisasContext *s, arg_vfmv_v_f *a)
 }
...
@@ -2863,95 +3014,129 @@ static bool opfv_widen_check(DisasContext *s, arg_rmr *a)
            vext_check_ds(s, a->rd, a->rs2, a->vm);
 }
...
@@ -2967,104 +3152,140 @@ static bool opfv_narrow_check(DisasContext *s, arg_rmr *a)
...
@@ -3097,10 +3318,12 @@ GEN_OPIVV_WIDEN_TRANS(vwredsum_vs, reduction_widen_check)
...
@@ -3109,11 +3332,13 @@ GEN_OPFVV_TRANS(vfredmax_vs, freduction_check)
...
@@ -3528,7 +3753,8 @@ static bool trans_vfmv_s_f(DisasContext *s, arg_vfmv_s_f *a)
 {
     if (require_rvv(s) &&
         require_rvf(s) &&
-        vext_check_isa_ill(s)) {
...
@@ -3540,7 +3766,7 @@ static bool trans_vfmv_s_f(DisasContext *s, arg_vfmv_s_f *a)
...
@@ -3622,20 +3848,24 @@ GEN_OPIVX_VSLIDE1_TRANS(vslide1up_vx, slideup_check)
...
index c7b9d6b467..5aea553814 100644
--- a/target/riscv/vector_helper.c
+++ b/target/riscv/vector_helper.c
@@ -3167,9 +3167,11 @@ void HELPER(NAME)(void *vd, void *v0, void *vs1,          \
                       total_elems * ESZ);                 \
 }
...
@@ -3212,26 +3214,37 @@ void HELPER(NAME)(void *vd, void *v0, uint64_t s1,        \
                       total_elems * ESZ);                 \
 }
...
@@ -3247,14 +3260,22 @@ static uint64_t float64_rsub(uint64_t a, uint64_t b, float_status *s)
...
@@ -3268,15 +3289,25 @@ static uint64_t vfwadd32(uint32_t a, uint32_t b, float_status *s)
...
@@ -3290,15 +3321,24 @@ static uint64_t vfwsub32(uint32_t a, uint32_t b, float_status *s)
...
@@ -3309,15 +3349,24 @@ static uint64_t vfwaddw32(uint64_t a, uint32_t b, float_status *s)
...
@@ -3328,25 +3377,33 @@ static uint64_t vfwsubw32(uint64_t a, uint32_t b, float_status *s)
...
@@ -3387,6 +3444,12 @@ GEN_VEXT_VF(vfrdiv_vf_w, 4)
...
@@ -3399,12 +3462,17 @@ static uint64_t vfwmul32(uint32_t a, uint32_t b, float_status *s)
...
@@ -3419,6 +3487,12 @@ static void do_##NAME(void *vd, void *vs1, void *vs2, int i,       \
...
@@ -3434,9 +3508,11 @@ static uint64_t fmacc64(uint64_t a, uint64_t b, uint64_t d, float_status *s)
...
@@ -3450,13 +3526,22 @@ static void do_##NAME(void *vd, uint64_t s1, void *vs2, int i,    \
...
@@ -3475,19 +3560,29 @@ static uint64_t fnmacc64(uint64_t a, uint64_t b, uint64_t d, float_status *s)
                                    float_muladd_negate_product, s);
 }
...
@@ -3503,19 +3598,29 @@ static uint64_t fmsac64(uint64_t a, uint64_t b, uint64_t d, float_status *s)
...
@@ -3531,19 +3636,29 @@ static uint64_t fnmsac64(uint64_t a, uint64_t b, uint64_t d, float_status *s)
...
@@ -3559,19 +3674,30 @@ static uint64_t fmadd64(uint64_t a, uint64_t b, uint64_t d, float_status *s)
...
@@ -3590,19 +3716,29 @@ static uint64_t fnmadd64(uint64_t a, uint64_t b, uint64_t d, float_status *s)
                                    float_muladd_negate_product, s);
 }
...
@@ -3618,19 +3754,29 @@ static uint64_t fmsub64(uint64_t a, uint64_t b, uint64_t d, float_status *s)
...
@@ -3646,15 +3792,19 @@ static uint64_t fnmsub64(uint64_t a, uint64_t b, uint64_t d, float_status *s)
...
@@ -3692,6 +3842,15 @@ GEN_VEXT_VV_ENV(vfwmaccbf16_vv, 4)
...
@@ -3707,15 +3866,27 @@ static uint64_t fwnmacc32(uint32_t a, uint32_t b, uint64_t d, float_status *s)
                              float_muladd_negate_product, s);
 }
...
+
 ...
 {
     return float32_muladd(float16_to_float32(a, true, s),
@@ -3730,15 +3901,27 @@ static uint64_t fwmsac32(uint32_t a, uint32_t b, uint64_t d, float_status *s)
                           float_muladd_negate_c, s);
 }
...
+
 ...
 {
     return float32_muladd(float16_to_float32(a, true, s),
@@ -3753,12 +3936,16 @@ static uint64_t fwnmsac32(uint32_t a, uint32_t b, uint64_t d, float_status *s)
                           float_muladd_negate_product, s);
 }
...
@@ -3864,6 +4051,46 @@ static uint64_t frsqrt7(uint64_t f, int exp_size, int frac_size)
     return val;
 }
...
@@ -3984,9 +4211,11 @@ static float64 frsqrt7_d(float64 f, float_status *s)
...
@@ -4079,6 +4308,38 @@ static uint64_t frec7(uint64_t f, int exp_size, int frac_size,
     return val;
 }
...
+
 ...
 {
     int exp_size = 5, frac_size = 10;
@@ -4175,36 +4436,46 @@ static float64 frec7_d(float64 f, float_status *s)
     return make_float64(val);
 }
...
@@ -4333,6 +4604,7 @@ void HELPER(NAME)(void *vd, void *v0, void *vs1, void *vs2,   \
     }                                                         \
 }
...
@@ -4374,10 +4646,17 @@ void HELPER(NAME)(void *vd, void *v0, uint64_t s1, void *vs2,       \
     }                                                               \
 }
...
@@ -4396,27 +4675,39 @@ static bool vmfne64(uint64_t a, uint64_t b, float_status *s)
     return compare != float_relation_equal;
 }
...
@@ -4435,10 +4726,18 @@ static bool vmfgt64(uint64_t a, uint64_t b, float_status *s)
     return compare == float_relation_greater;
 }
...
+
 ...
 {
     FloatRelation compare = float16_compare(a, b, s);
@@ -4460,11 +4759,31 @@ static bool vmfge64(uint64_t a, uint64_t b, float_status *s)
            compare == float_relation_equal;
 }
...
+
 ...
 {
     float16 f = frs1;
@@ -4522,9 +4841,11 @@ target_ulong fclass_d(uint64_t frs1)
     }
 }
...
@@ -4615,17 +4936,21 @@ GEN_VEXT_V_ENV(vfwcvt_x_f_v_w, 8)
...
@@ -4652,17 +4977,21 @@ GEN_VEXT_V_ENV(vfwcvtbf16_f_f_v, 4)
