...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id F1B00CB8F32
	for <lists+qemu-devel@lfdr.de>; Fri, 12 Dec 2025 15:18:27 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1vU3xw-0003jl-IF; Fri, 12 Dec 2025 09:17:52 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <functioner@sjtu.edu.cn>)
 id 1vU3xt-0003jJ-PD
 for qemu-devel@nongnu.org; Fri, 12 Dec 2025 09:17:49 -0500
...
Received: from proxy188.sjtu.edu.cn (smtp188.sjtu.edu.cn [202.120.2.188])
 by smtp232.sjtu.edu.cn (Postfix) with ESMTPS id 1A04D1281CEAC;
 Fri, 12 Dec 2025 22:16:50 +0800 (CST)
Received: from localhost.localdomain (unknown [202.120.40.100])
 by proxy188.sjtu.edu.cn (Postfix) with ESMTPSA id E656337C958;
...
Subject: [PATCH v2 2/2] tcg tests: add a test to verify the syscall filter
 plugin API
Date: Fri, 12 Dec 2025 22:15:41 +0800
Message-Id: <20251212141541.1792111-3-functioner@sjtu.edu.cn>
