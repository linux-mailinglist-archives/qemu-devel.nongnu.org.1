...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 1CBDD72E1D1
	for <lists+qemu-devel@lfdr.de>; Tue, 13 Jun 2023 13:40:16 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1q91XO-00037U-30; Tue, 13 Jun 2023 06:46:10 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <belmouss@redhat.com>)
 id 1q91XK-000375-2c
 for qemu-devel@nongnu.org; Tue, 13 Jun 2023 06:46:06 -0400
Received: from us-smtp-delivery-124.mimecast.com ([170.10.133.124])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <belmouss@redhat.com>)
 id 1q91XC-00082u-9P
 for qemu-devel@nongnu.org; Tue, 13 Jun 2023 06:46:05 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1686653148;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=C37Fsl0EZN8AXSJsP2JQlH6txDxU3FW41vnThYtTXIQ=;
 b=XncJe3CCL4WPJEhKeRqJHk+Ib3Aqn6LTXa0L//WSiuqENUnR+IpclWyE4pS4mB9WpDL/wf
 nU6Q4V0XAxAYl8shPjN0TenfUe9boqGT8CxHWBdG7aGwBcGRUGay4/JAPzpyH7uSsjfUzZ
 6e0rzEtr7kFpoY6nvstSW47QNb0DH3k=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-574-hwNHwtCrPlWG5tQbYuzb2Q-1; Tue, 13 Jun 2023 06:45:46 -0400
X-MC-Unique: hwNHwtCrPlWG5tQbYuzb2Q-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.rdu2.redhat.com
 [10.11.54.1])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id ED4D5811E7F
 for <qemu-devel@nongnu.org>; Tue, 13 Jun 2023 10:45:45 +0000 (UTC)
Received: from toolbox.redhat.com (unknown [10.45.226.85])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 721FF40B4CD6;
 Tue, 13 Jun 2023 10:45:45 +0000 (UTC)
From: Bilal Elmoussaoui <belmouss@redhat.com>
To: qemu-devel@nongnu.org
Cc: Bilal Elmoussaoui <belmouss@redhat.com>
Subject: [PATCH 2/2] ui/dbus: Expose a touch device interface
Date: Tue, 13 Jun 2023 12:45:35 +0200
...
+
+    ret = console_handle_touch_event(ddc->dcl.con, touch_slots,
...
+
 ...
 dbus_mouse_set_pos(DBusDisplayConsole *ddc,
                    GDBusMethodInvocation *invocation,
@@ -440,7 +482,7 @@ dbus_display_console_new(DBusDisplay *display, QemuConsole *con)
...
+    int idx, i;
     ...
     assert(display);
     assert(con);
@@ -495,6 +537,18 @@ dbus_display_console_new(DBusDisplay *display, QemuConsole *con)
