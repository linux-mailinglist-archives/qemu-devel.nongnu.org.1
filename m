...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 2BDF3BE133C
	for <lists+qemu-devel@lfdr.de>; Thu, 16 Oct 2025 03:53:05 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1v9D96-0002WJ-6y; Wed, 15 Oct 2025 21:51:12 -0400
...
Received: from mail.loongson.cn ([114.242.206.163])
 ...
 (envelope-from <maobibo@loongson.cn>) id 1v9D8X-0001TU-LF
 for qemu-devel@nongnu.org; Wed, 15 Oct 2025 21:50:41 -0400
Received: from loongson.cn (unknown [10.2.5.213])
 by gateway (Coremail) with SMTP id _____8BxG9JkT_BoibEWAA--.47446S3;
 Thu, 16 Oct 2025 09:50:28 +0800 (CST)
Received: from localhost.localdomain (unknown [10.2.5.213])
 by front1 (Coremail) with SMTP id qMiowJCxH8JjT_BoAY3oAA--.64734S3;
 Thu, 16 Oct 2025 09:50:28 +0800 (CST)
...
Subject: [PATCH v5 01/14] target/loongarch: Use auto method with PTW feature
Date: Thu, 16 Oct 2025 09:50:14 +0800
Message-Id: <20251016015027.1695116-2-maobibo@loongson.cn>
...
X-CM-TRANSID: qMiowJCxH8JjT_BoAY3oAA--.64734S3
...
index 86490e0f72..b7b61ff877 100644
--- a/target/loongarch/cpu.c
+++ b/target/loongarch/cpu.c
@@ -224,6 +224,24 @@ static void loongarch_set_msgint(Object *obj, bool value, Error **errp)
...
+
 ...
 {
     LoongArchCPU *cpu = LOONGARCH_CPU(obj);
@@ -238,7 +256,10 @@ static void loongarch_cpu_post_init(Object *obj)
                              loongarch_set_lasx);
...
@@ -346,6 +367,7 @@ static void loongarch_la464_initfn(Object *obj)
...
@@ -377,6 +399,7 @@ static void loongarch_la132_initfn(Object *obj)
...
@@ -388,6 +411,8 @@ static void loongarch_max_initfn(Object *obj)
     if (tcg_enabled()) {
