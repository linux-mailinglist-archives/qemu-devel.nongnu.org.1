...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 4460498661D
	for <lists+qemu-devel@lfdr.de>; Wed, 25 Sep 2024 20:07:55 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1stWPG-0008VJ-Pc; Wed, 25 Sep 2024 14:06:31 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <kowal@linux.ibm.com>)
 id 1stWP8-0008OC-RA; Wed, 25 Sep 2024 14:06:22 -0400
Received: from mx0a-001b2d01.pphosted.com ([148.163.156.1])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <kowal@linux.ibm.com>)
 id 1stWP3-0007p1-UL; Wed, 25 Sep 2024 14:06:22 -0400
Received: from pps.filterd (m0356517.ppops.net [127.0.0.1])
 by mx0a-001b2d01.pphosted.com (8.18.1.2/8.18.1.2) with ESMTP id 48PEBHFT020956;
 Wed, 25 Sep 2024 18:06:04 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com; h=from
 :to:cc:subject:date:message-id:mime-version
 :content-transfer-encoding; s=pp1; bh=vaWTs8v0gBR1ZWsfJs8dCUScXb
 YoLyToM2h4e1jVoGs=; b=h0jnjT0WaxT1gk+KePI/81YNlV/sLvnOIU7e9q3ggi
 
Received: from pps.reinject (localhost [127.0.0.1])
 by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 41snvb9shw-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Wed, 25 Sep 2024 18:06:04 +0000 (GMT)
Received: from m0356517.ppops.net (m0356517.ppops.net [127.0.0.1])
 by pps.reinject (8.18.0.8/8.18.0.8) with ESMTP id 48PI6331030236;
 Wed, 25 Sep 2024 18:06:03 GMT
Received: from ppma21.wdc07v.mail.ibm.com
 (5b.69.3da9.ip4.static.sl-reverse.com [169.61.105.91])
 by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 41snvb9shp-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Wed, 25 Sep 2024 18:06:03 +0000 (GMT)
Received: from pps.filterd (ppma21.wdc07v.mail.ibm.com [127.0.0.1])
 by ppma21.wdc07v.mail.ibm.com (8.18.1.2/8.18.1.2) with ESMTP id 48PGEq4l012541;
 Wed, 25 Sep 2024 18:06:02 GMT
Received: from smtprelay04.fra02v.mail.ibm.com ([9.218.2.228])
 by ppma21.wdc07v.mail.ibm.com (PPS) with ESMTPS id 41t9fq31mn-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Wed, 25 Sep 2024 18:06:02 +0000
Received: from smtpav01.fra02v.mail.ibm.com (smtpav01.fra02v.mail.ibm.com
 [10.20.54.100])
 by smtprelay04.fra02v.mail.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id
 48PI5wKh31654552
 (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
 Wed, 25 Sep 2024 18:05:58 GMT
Received: from smtpav01.fra02v.mail.ibm.com (unknown [127.0.0.1])
 by IMSVA (Postfix) with ESMTP id 00FC52004E;
 Wed, 25 Sep 2024 18:05:58 +0000 (GMT)
Received: from smtpav01.fra02v.mail.ibm.com (unknown [127.0.0.1])
 by IMSVA (Postfix) with ESMTP id 5ECD920040;
 Wed, 25 Sep 2024 18:05:56 +0000 (GMT)
...
Subject: [PATCH v2] tests/qtest: Add XIVE tests for the powernv10 machine
Date: Wed, 25 Sep 2024 13:05:50 -0500
Message-Id: <20240925180550.3760-1-kowal@linux.ibm.com>
X-Mailer: git-send-email 2.39.5
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-TM-AS-GCONF: 00
X-Proofpoint-ORIG-GUID: 4vmruH4QvaZ8TkPRZVHQJP1cTRKLEY5-
X-Proofpoint-GUID: XR-_yNJbs82ipeAFPb-9xUS0NX_Jzabc
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0
 ...
 engine=8.19.0-2408220000 definitions=main-2409250127
...
---
 MAINTAINERS                        |   1 +
 tests/qtest/pnv-xive2-common.h     | 112 ++++++++++
 tests/qtest/pnv-xive2-common.c     | 191 ++++++++++++++++
 tests/qtest/pnv-xive2-flush-sync.c | 206 +++++++++++++++++
 tests/qtest/pnv-xive2-test.c       | 345 +++++++++++++++++++++++++++++
...
new file mode 100644
index 0000000000..c29079b137
--- /dev/null
+++ b/tests/qtest/pnv-xive2-common.c
@@ -0,0 +1,191 @@
+/*
+ * QTest testcase for PowerNV 10 interrupt controller (xive2)
+ *  - Common functions for a XIVE2 tests
+ *
+ * Copyright (c) 2024, IBM Corporation.
+ *
+ * This work is licensed under the terms of the GNU GPL, version 2 or
