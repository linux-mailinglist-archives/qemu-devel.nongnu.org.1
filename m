...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 429C8BDB47A
	for <lists+qemu-devel@lfdr.de>; Tue, 14 Oct 2025 22:38:18 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1v8liS-00016R-1j; Tue, 14 Oct 2025 16:33:52 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <anjo@rev.ng>) id 1v8liP-00015i-T6
 for qemu-devel@nongnu.org; Tue, 14 Oct 2025 16:33:49 -0400
Received: from rev.ng ([94.130.142.21])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <anjo@rev.ng>) id 1v8liM-0000Ue-WA
 for qemu-devel@nongnu.org; Tue, 14 Oct 2025 16:33:49 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=rev.ng;
 ...
 List-Help; bh=Z6gFoJ3jUIOXmDLpSg2LPlQFI+pzHQZsIPYeY/g6SB4=; b=MbG18fuFp1VGTCU
 Yr3XEEUbJWkvhoJNfl3cEP53B9pKOieZwByB6GpmMJTOZGpuYUQtTXQI1BIHHuumDbtBbeZzN8CGl
 B7V2OjzeRzZeawR97he3KN+F3UrCxopHam/NKEOuWxmDxqRnsSIm0s/qTRCtqIoixv/Evzr/zIuP9
 l8=;
To: qemu-devel@nongnu.org
Cc: pierrick.bouvier@linaro.org, philmd@linaro.org, alistair.francis@wdc.com,
 palmer@dabbelt.com
Subject: [PATCH v3 24/34] target/riscv: Fix arguments to board IMSIC emulation
 callbacks
Date: Tue, 14 Oct 2025 22:35:01 +0200
Message-ID: <20251014203512.26282-25-anjo@rev.ng>
...
index 620411b894..c192359e56 100644
--- a/target/riscv/cpu.h
+++ b/target/riscv/cpu.h
@@ -199,6 +199,24 @@ FIELD(VTYPE, VMA, 7, 1)
...
@@ -464,20 +482,8 @@ struct CPUArchState {
     void *rdtime_fn_arg;
...
+    void *aia_ireg_rmw_cb_arg[4];
     ...
     bool debugger;
@@ -645,12 +651,8 @@ void riscv_cpu_interrupt(CPURISCVState *env);
...
index 55c9e9ae29..b78bc510a6 100644
