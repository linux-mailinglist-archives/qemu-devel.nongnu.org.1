...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 732037A734B
	for <lists+qemu-devel@lfdr.de>; Wed, 20 Sep 2023 08:56:22 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qir5X-0001a8-2X; Wed, 20 Sep 2023 02:53:31 -0400
...
Received: from mail.loongson.cn ([114.242.206.163])
 ...
 (envelope-from <gaosong@loongson.cn>) id 1qir4c-00048b-8k
 for qemu-devel@nongnu.org; Wed, 20 Sep 2023 02:52:48 -0400
Received: from loongson.cn (unknown [10.2.5.185])
 by gateway (Coremail) with SMTP id _____8Cx77ujlgpl2y8qAA--.21918S3;
 Wed, 20 Sep 2023 14:52:19 +0800 (CST)
Received: from localhost.localdomain (unknown [10.2.5.185])
 by localhost.localdomain (Coremail) with SMTP id
 AQAAf8Dxzdx7lgplhVYMAA--.24315S48; 
 Wed, 20 Sep 2023 14:52:17 +0800 (CST)
From: Song Gao <gaosong@loongson.cn>
To: qemu-devel@nongnu.org
Cc: Richard Henderson <richard.henderson@linaro.org>
Subject: [PULL 46/57] target/loongarch: Implement LASX fpu arith instructions
Date: Wed, 20 Sep 2023 14:51:28 +0800
Message-Id: <20230920065139.1403868-47-gaosong@loongson.cn>
...
X-CM-TRANSID: AQAAf8Dxzdx7lgplhVYMAA--.24315S48
...
index 9ddbbc665a..56d13331f6 100644
...
index c1e7130a73..a7f6929db3 100644
--- a/target/loongarch/insn_trans/trans_vec.c.inc
+++ b/target/loongarch/insn_trans/trans_vec.c.inc
@@ -33,6 +33,10 @@ static bool check_vec(DisasContext *ctx, uint32_t oprsz)
...
@@ -45,13 +49,15 @@ static bool gen_vvvv_ptr_vl(DisasContext *ctx, arg_vvvv *a, uint32_t oprsz,
...
+
 ...
 {
@@ -76,6 +82,9 @@ static bool gen_vvvv(DisasContext *ctx, arg_vvvv *a,
...
+    }
     tcg_gen_gvec_3_ptr(vec_full_offset(a->vd),
                        vec_full_offset(a->vj),
                        vec_full_offset(a->vk),
@@ -87,13 +96,15 @@ static bool gen_vvv_ptr_vl(DisasContext *ctx, arg_vvv *a, uint32_t oprsz,
...
+
 ...
 {
@@ -121,6 +132,10 @@ static bool gen_xxx(DisasContext *ctx, arg_vvv *a, gen_helper_gvec_3 *fn)
...
+
     tcg_gen_gvec_2_ptr(vec_full_offset(a->vd),
                        vec_full_offset(a->vj),
                        cpu_env,
@@ -131,13 +146,15 @@ static bool gen_vv_ptr_vl(DisasContext *ctx, arg_vv *a, uint32_t oprsz,
...
+
 ...
 {
@@ -4313,6 +4330,14 @@ TRANS(vfmul_s, LSX, gen_vvv_ptr, gen_helper_vfmul_s)
