...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id D1D688B7966
	for <lists+qemu-devel@lfdr.de>; Tue, 30 Apr 2024 16:28:54 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1s1oTA-0007Mz-Km; Tue, 30 Apr 2024 10:28:33 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <farosas@suse.de>) id 1s1oT4-0007GT-S1
 for qemu-devel@nongnu.org; Tue, 30 Apr 2024 10:28:27 -0400
Received: from smtp-out2.suse.de ([195.135.223.131])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <farosas@suse.de>) id 1s1oT1-0000C9-UA
 for qemu-devel@nongnu.org; Tue, 30 Apr 2024 10:28:26 -0400
Received: from imap1.dmz-prg2.suse.org (imap1.dmz-prg2.suse.org [10.150.64.97])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by smtp-out2.suse.de (Postfix) with ESMTPS id 266011F7E1;
 Tue, 30 Apr 2024 14:28:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 t=1714487302; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=HTUGiaEeNa6EgPVQs0ODMqnQUX9OVjGXxfVVGuBKYxk=;
 b=MqcVwXDeYg/nAlRjqDreFHMuCiNDFKjYBaGRwc2NbCtKKFuIRaO6zV9EgTmqh1cHm668qO
 A34nY2A042DKWqvk3YI16LKrww5dq+ePzIMS+nSIiWpDK65VCEw49+wgYbjJcHTLlGIOTH
 HtnauDcFcbWMURglhUJ5PR+eMx6SSuk=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
 s=susede2_ed25519; t=1714487302;
 h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=HTUGiaEeNa6EgPVQs0ODMqnQUX9OVjGXxfVVGuBKYxk=;
 b=nJOm7k5Nakvem7RJktSmlyqTuQwVZqBf4M0YribKJjrnOS4PoyGTcsr6z3KWhqWvq5d35/
 dfzwICMt5jO+oYDw==
...
Received: from imap1.dmz-prg2.suse.org (localhost [127.0.0.1])
 ...
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by imap1.dmz-prg2.suse.org (Postfix) with ESMTPS id 74033133A7;
 Tue, 30 Apr 2024 14:28:18 +0000 (UTC)
Received: from dovecot-director2.suse.de ([10.150.64.162])
 by imap1.dmz-prg2.suse.org with ESMTPSA id ABXhDgIAMWZjSQAAD6G6ig
 (envelope-from <farosas@suse.de>); Tue, 30 Apr 2024 14:28:18 +0000
...
Subject: [PATCH v3 3/6] migration: Remove 'blk/-b' option from migrate commands
Date: Tue, 30 Apr 2024 11:27:34 -0300
Message-Id: <20240430142737.29066-4-farosas@suse.de>
...
index ee28c26676..6783abed74 100644
...
@@ -2003,22 +1997,6 @@ static bool migrate_prepare(MigrationState *s, bool blk, bool resume,
         }
     }
...
@@ -2027,9 +2005,8 @@ static bool migrate_prepare(MigrationState *s, bool blk, bool resume,
 }
...
@@ -2068,7 +2045,7 @@ void qmp_migrate(const char *uri, bool has_channels,
     }
...
index 8045e39c26..96b0bc323a 100644
--- a/migration/migration.h
+++ b/migration/migration.h
@@ -376,10 +376,6 @@ struct MigrationState {
