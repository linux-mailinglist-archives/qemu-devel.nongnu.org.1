...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 20170870AD7
	for <lists+qemu-devel@lfdr.de>; Mon,  4 Mar 2024 20:38:07 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rhE6t-0003KC-1U; Mon, 04 Mar 2024 14:36:27 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <dbarboza@ventanamicro.com>)
 id 1rhE6g-0003JF-BG
 for qemu-devel@nongnu.org; Mon, 04 Mar 2024 14:36:16 -0500
Received: from mail-pf1-x42b.google.com ([2607:f8b0:4864:20::42b])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <dbarboza@ventanamicro.com>)
 id 1rhE6b-0005gx-Ns
 for qemu-devel@nongnu.org; Mon, 04 Mar 2024 14:36:14 -0500
Received: by mail-pf1-x42b.google.com with SMTP id
 d2e1a72fcca58-6e6381df003so96084b3a.0
 for <qemu-devel@nongnu.org>; Mon, 04 Mar 2024 11:36:09 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=ventanamicro.com; s=google; t=1709580967; x=1710185767; darn=nongnu.org;
 h=content-transfer-encoding:in-reply-to:from:content-language
 :references:to:subject:user-agent:mime-version:date:message-id:from
 :to:cc:subject:date:message-id:reply-to;
 bh=LLHrCHlLsxxX5ohjvP+DfWow+43D8xy1ZWdICfN8Iw4=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1709580967; x=1710185767;
 h=content-transfer-encoding:in-reply-to:from:content-language
 :references:to:subject:user-agent:mime-version:date:message-id
 :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
 bh=LLHrCHlLsxxX5ohjvP+DfWow+43D8xy1ZWdICfN8Iw4=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCXg1qhKfRKIT1sgM9mJw3/p3uT4JNmw/q0pUx+lkURC+NJFKfbKQ1ta64jIAz6eHoAVz0ZLr8o1jmoRU5Xklg/25lCdgmQ=
X-Gm-Message-State: AOJu0YyUJe7Ye07jjp5GNa73SEdJ8ajGTiY8gk6g0GMea6of66Zmokml
 5oP6TAwcX/n94tXGckl+DX88Eyowbb/tsXlpzYyP47w6WruU13mp/P/4Mfh/elI=
X-Google-Smtp-Source: AGHT+IFJrxgi6+cBUNpvAyV4IJqqyrBcBIIWzAElbq4BsxQrYs1qAwyl6cEEV5zW0NpwE3G/I9A8pg==
X-Received: by 2002:a05:6a00:1ac7:b0:6e6:27d3:96ab with SMTP id
 f7-20020a056a001ac700b006e627d396abmr3223076pfv.16.1709580966809; 
 Mon, 04 Mar 2024 11:36:06 -0800 (PST)
Received: from ?IPV6:2804:7f0:bcc0:e4b8:6daf:840a:5593:a7a3?
 ([2804:7f0:bcc0:e4b8:6daf:840a:5593:a7a3])
 by smtp.gmail.com with ESMTPSA id
 r5-20020aa79885000000b006e530aca55asm7610925pfl.123.2024.03.04.11.36.01
 (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
 Mon, 04 Mar 2024 11:36:06 -0800 (PST)
Message-ID: <9bd77fe9-2fea-439f-bb71-0c2499989330@ventanamicro.com>
Date: Mon, 4 Mar 2024 16:35:59 -0300
MIME-Version: 1.0
...
I suggest explicitly creating both flash devices in rvsp_ref_machine_instance_init():
...
I suggest rename rvsp_flash_map() to rvsp_create_flash_maps() and rename the
...
We did some changes in the FDT functions in hw/riscv/virt.c where we used a lot
of "g_autofree" calls to avoid having to call g_free() every time. This was done
in the context of fixing a mem leak.

I suggest doing the same in all the FDT functions you're creating for this
new machine.

Also, it seems like some FDT functions we're using here is a copy/paste of what
the 'virt' machine is doing, e.g. create_fdt_socket_memory(). I think it's worth
thinking about moving these common functions somewhere else (e.g. hw/riscv/fdt_helper.c)
...
We fixed a bug in the 'virt' machine  that had to do with the guest-loader device
not being properly configured. It had to do with the FDT not being properly generated.
See 7a87ba8956e59 and https://gitlab.com/qemu-project/qemu/-/issues/1925 for more info.

Long story short, the 'virt' machine introduced a 'finalize_fdt' step where some pieces
of FDT is created during machine_done(), and some are created during init() via create_fdt().
I think it's a good idea to consider doing that in this new machine to avoid this kind of
problem.
