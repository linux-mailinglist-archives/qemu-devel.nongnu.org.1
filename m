...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F3508C3A97
	for <lists+qemu-devel@lfdr.de>; Mon, 13 May 2024 05:54:55 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1s6Mkq-0001Po-HY; Sun, 12 May 2024 23:53:36 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <luchangqi.123@bytedance.com>)
 id 1s6Mkk-0001Nj-2T
 for qemu-devel@nongnu.org; Sun, 12 May 2024 23:53:32 -0400
Received: from mail-pf1-x42a.google.com ([2607:f8b0:4864:20::42a])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <luchangqi.123@bytedance.com>)
 id 1s6Mkf-0008N3-Nj
 for qemu-devel@nongnu.org; Sun, 12 May 2024 23:53:29 -0400
Received: by mail-pf1-x42a.google.com with SMTP id
 d2e1a72fcca58-6f45020ac2cso3013051b3a.0
 for <qemu-devel@nongnu.org>; Sun, 12 May 2024 20:53:24 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=bytedance.com; s=google; t=1715572403; x=1716177203; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=ACTj/OZgQKRL+N6Qkr1xXpPCrBwg/asS62fOHs2SDG8=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1715572403; x=1716177203;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=ACTj/OZgQKRL+N6Qkr1xXpPCrBwg/asS62fOHs2SDG8=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCXVmbB4WbmeV+em7D2Muqnqhy0qULxCDJli8px+jKJg6RVPEDHxbIeqaCQqoEAKelHd1PIp2dYZfNFVs7kZMokUo5h61Wk=
X-Gm-Message-State: AOJu0Yy2CDZxXHS8NdMBpvw+AlZS0hFjXDxs/mLUaI295GxNX/MeOHFu
 2M1NfS+okbGaPPD6OhSXl9TvO5OAt0NJD6Td1FCtsiUVF4ovltXo/VuT24LxYdM=
X-Google-Smtp-Source: AGHT+IFpDytscN6XPg9zhA8FBZoN+cHEqFFyZW4RfjlwIbojLBaMCWViFXvbXPT0eBnmqB2S4dGqiQ==
X-Received: by 2002:a05:6a00:27a1:b0:6f4:46ea:2f28 with SMTP id
 d2e1a72fcca58-6f4e02cea39mr9933753b3a.18.1715572402999; 
 Sun, 12 May 2024 20:53:22 -0700 (PDT)
Received: from n37-006-243.byted.org ([180.184.51.40])
 by smtp.gmail.com with ESMTPSA id
 d2e1a72fcca58-6f4d2a8137asm6407947b3a.45.2024.05.12.20.53.19
...
Subject: [PATCH v2 11/11] block/iscsi: add persistent reservation in/out driver
Date: Mon, 13 May 2024 11:52:30 +0800
Message-Id: <20240513035230.60162-12-luchangqi.123@bytedance.com>
...
+
 static int iscsi_open(BlockDriverState *bs, QDict *options, int flags,
                       Error **errp)
 {
@@ -2024,6 +2074,11 @@ static int iscsi_open(BlockDriverState *bs, QDict *options, int flags,
...
@@ -2110,6 +2165,8 @@ static void iscsi_refresh_limits(BlockDriverState *bs, Error **errp)
...
+
 ...
 static const char *const iscsi_strong_runtime_opts[] = {
     "transport",
@@ -2451,6 +2891,14 @@ static BlockDriver bdrv_iscsi = {
