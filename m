...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D96F75B40E
	for <lists+qemu-devel@lfdr.de>; Thu, 20 Jul 2023 18:23:32 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qMWQ4-0005No-IC; Thu, 20 Jul 2023 12:22:26 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <outgoing@sr.ht>) id 1qMWPq-0005MP-Ny
 for qemu-devel@nongnu.org; Thu, 20 Jul 2023 12:22:11 -0400
Received: from mail-b.sr.ht ([173.195.146.151])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <outgoing@sr.ht>) id 1qMWPn-0001w2-HV
 for qemu-devel@nongnu.org; Thu, 20 Jul 2023 12:22:10 -0400
Authentication-Results: mail-b.sr.ht; dkim=none 
Received: from git.sr.ht (unknown [173.195.146.142])
 by mail-b.sr.ht (Postfix) with ESMTPSA id D64F711EE8C;
 Thu, 20 Jul 2023 16:22:05 +0000 (UTC)
From: ~hyman <hyman@git.sr.ht>
Date: Fri, 18 Nov 2022 10:08:54 +0800
Subject: [PATCH QEMU v9 1/9] softmmu/dirtylimit: Add parameter check for hmp
 "set_vcpu_dirty_limit"
MIME-Version: 1.0
Message-ID: <168987012554.14797.8679831725383645706-1@git.sr.ht>
X-Mailer: git.sr.ht
