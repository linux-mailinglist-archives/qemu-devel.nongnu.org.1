...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id AD77B75A7F3
	for <lists+qemu-devel@lfdr.de>; Thu, 20 Jul 2023 09:38:39 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qMOEg-0005kG-Qo; Thu, 20 Jul 2023 03:38:06 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <jasowang@redhat.com>)
 id 1qMOEe-0005j2-Mk
 for qemu-devel@nongnu.org; Thu, 20 Jul 2023 03:38:04 -0400
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1689838679;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=k1G3NteCIxLJG6u19/eh4a1ISMLon3JeCxuD+fYgE00=;
 b=ARYYJI7aX3mtD7BFmjb02V76uu2QpnUjOUStquv2L+IbCNA0uOx3rYm+tGaBLk2R7WtXGL
 BUgbt+KmREEMrpsL9OASVd3E4DT6hj7HRwhaFhHSMYW4/EfVV7DuWJurHV9zNCxAgw93Jo
 S2H++Ozsttfkfvza9IoMcMlfKdqR+Hg=
Received: from mail-lj1-f199.google.com (mail-lj1-f199.google.com
 [209.85.208.199]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-107-InCJzOsOMcalyRUomL4gVQ-1; Thu, 20 Jul 2023 03:37:55 -0400
X-MC-Unique: InCJzOsOMcalyRUomL4gVQ-1
Received: by mail-lj1-f199.google.com with SMTP id
 38308e7fff4ca-2b6f97c9d54so4507641fa.3
 for <qemu-devel@nongnu.org>; Thu, 20 Jul 2023 00:37:54 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20221208; t=1689838674; x=1692430674;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=k1G3NteCIxLJG6u19/eh4a1ISMLon3JeCxuD+fYgE00=;
 b=
X-Gm-Message-State: ABy/qLZhhOI4P6N4E7oBBpPq7MVtFXARcdul7hjpo36IjYOYTzSjmSIR
 WhjoKbBHHgso1Y50q5TfnXb85qr6ofDHxncAlZb82cOCRbukIssClwf0K0uQ7yOQMb8MJzdUXGY
 VtLKfoHGugcdgieeo4hPlaTfZyj0S5pA=
X-Received: by 2002:a2e:8841:0:b0:2b6:dc84:b93e with SMTP id
 z1-20020a2e8841000000b002b6dc84b93emr1603697ljj.21.1689838673442; 
 Thu, 20 Jul 2023 00:37:53 -0700 (PDT)
X-Google-Smtp-Source: APBJJlFhwvX5clWkXs0h/sgKAVLV44Q7v9CAzCHFZdG6LaMVL4TSQGINMOMALxJKxiJGeoGlt3tdecX3V/GOonLb5LE=
X-Received: by 2002:a2e:8841:0:b0:2b6:dc84:b93e with SMTP id
 z1-20020a2e8841000000b002b6dc84b93emr1603667ljj.21.1689838672523; Thu, 20 Jul
 2023 00:37:52 -0700 (PDT)
MIME-Version: 1.0
References: <20230705205914.3457560-1-i.maximets@ovn.org>
In-Reply-To: <20230705205914.3457560-1-i.maximets@ovn.org>
From: Jason Wang <jasowang@redhat.com>
Date: Thu, 20 Jul 2023 15:37:40 +0800
Message-ID: <CACGkMEsO6GaeTmGYphZT7Q3pZ8XhpKon3OWkwFwH9fRWCrgTgQ@mail.gmail.com>
...
On Thu, Jul 6, 2023 at 4:58=E2=80=AFAM Ilya Maximets <i.maximets@ovn.org> w=
rote:
>
...
>
> +# libxdp
> +libxdp =3D dependency('libxdp', required: get_option('af_xdp'), method: =
'pkg-config')
> +if libxdp.found() and \
> +      not (libbpf.found() and libbpf.version().version_compare('>=3D0.7'=
))
> +  libxdp =3D not_found
...
> +  else
> +    warning('af-xdp support requires libbpf version >=3D 0.7, disabling'=
)
> +  endif
> +endif
> +
...
> @@ -4285,6 +4303,7 @@ summary_info +=3D {'PVRDMA support':    have_pvrdma=
}
...
> +    uint64_t *addr;
> +
> +    done =3D xsk_ring_cons__peek(&s->cq, XSK_RING_CONS__DEFAULT_NUM_DESC=
S, &idx);
> +
> +    for (i =3D 0; i < done; i++) {
...
> +
> +    for (i =3D 0; i < n; i++) {
> +        *xsk_ring_prod__fill_addr(&s->fq, idx++) =3D s->pool[--s->n_pool=
];
> +    }
...
> +            /*
> +             * The peer does not receive anymore.  Packet is queued, sto=
p
...
> +    if (!s->inhibit && nc->queue_index =3D=3D s->n_queues - 1 && s->xdp_=
flags
...
> +        ret =3D xsk_umem__create_with_fd(&s->umem, sock_fd, s->buffer, s=
ize,
> +                                       &s->fq, &s->cq, &config);
> +#else
...
> +        error =3D bpf_map_update_elem(xsks_map_fd, &queue_id, &xsk_fd, 0=
);
> +        if (error) {
> +            error_setg_errno(errp, error,
...
> +        sock_fds[i] =3D monitor_fd_param(monitor_cur(), substrings[i], e=
rrp);
> +        if (sock_fds[i] < 0) {
> +            g_free(sock_fds);
> +            sock_fds =3D NULL;
...
> +        error_setg(errp, "expected 'inhibit=3Don' and 'xsks-map-fd' toge=
ther");
> +        return -1;
> +    }
> +#else
...
> +        error_setg(errp, "'sock-fds' and 'xsks-map-fd' are mutually excl=
usive");
> +        return -1;
> +    }
> +
...
> +
> +    if (opts->xsks_map_fd) {
> +        xsks_map_fd =3D monitor_fd_param(monitor_cur(), opts->xsks_map_f=
d, errp);
> +        if (xsks_map_fd < 0) {
> +            goto err;
> +        }
...
> +        nc =3D qemu_new_net_client(&net_af_xdp_info, peer, "af-xdp", nam=
e);
...
> +        if (bpf_xdp_query_id(s->ifindex, s->xdp_flags, &prog_id) || !pro=
g_id) {
> +            error_setg_errno(errp, errno,
...
> --- a/net/net.c
> +++ b/net/net.c
> @@ -1082,6 +1082,9 @@ static int (* const net_client_init_fun[NET_CLIENT_=
DRIVER__MAX])(
>  #ifdef CONFIG_NETMAP
...
> +#     (default: false)
> +#
> +# @queues: number of queues to be used for multiqueue interfaces (defaul=
t: 1).
> +#
...
> +#     the interface (default: false).  Requires @sock-fds or @xsks-map-f=
d.
> +#
...
> +    '*start-queue': 'int',
> +    '*inhibit':     'bool',
> +    '*sock-fds':    { 'type': 'str', 'if': 'HAVE_XSK_UMEM__CREATE_WITH_F=
D' },
> +    '*xsks-map-fd': 'str' } }
> +
>  ##
...
>      "                VALE port (created on the fly) called 'name' ('nmna=
me' is name of the \n"
...
py=3Don|off]\n"
> +    "         [,queues=3Dn][,start-queue=3Dm][,inhibit=3Don|off][,xsks-m=
ap-fd=3Dk]\n"
> +#ifdef HAVE_XSK_UMEM__CREATE_WITH_FD
> +    "         [,sock-fds=3Dx:y:...:z]\n"
> +#endif
> +    "                attach to the existing network interface 'name' wit=
h AF_XDP socket\n"
> +    "                use 'mode=3DMODE' to specify an XDP program attach =
mode\n"
> +    "                use 'force-copy=3Don|off' to force XDP copy mode ev=
en if device supports zero-copy (default: off)\n"
> +    "                use 'inhibit=3Don|off' to inhibit loading of a defa=
ult XDP program (default: off)\n"
> +    "                with inhibit=3Don,\n"
> +#ifdef HAVE_XSK_UMEM__CREATE_WITH_FD
> +    "                  use 'sock-fds' to provide file descriptors for al=
ready open XDP sockets\n"
> +    "                  added to a socket map in XDP program.  One socket=
 per queue.  Or\n"
> +#endif
> +    "                  use 'xsks-map-fd=3Dk' to provide a file descripto=
r for xsks map\n"
> +    "                use 'queues=3Dn' to specify how many queues of a mu=
ltiqueue interface should be used\n"
> +    "                use 'start-queue=3Dm' to specify the first queue th=
at should be used\n"
> +#endif
>  #ifdef CONFIG_POSIX
...
>
> +``-netdev af-xdp,id=3Dstr,ifname=3Dname[,mode=3Dnative|skb][,force-copy=
=3Don|off][,queues=3Dn][,start-queue=3Dm][,inhibit=3Don|off][,xsks-map-fd=
...
> +    where the likely most performant mode will be in use.  Number of que=
ues
> +    'n' should generally match the number or queues in the interface,
> +    defaults to 1.  Traffic arriving on non-configured device queues wil=
l
...
> +
> +    'start-queue' option can be specified if a particular range of queue=
s
> +    [m, m + n] should be in use.  For example, this is necessary in orde=
r
> +    to use MLX NICs in native mode.  The driver will create a separate s=
et
> +    of queues on top of regular ones, and only these queues can be used
> +    for AF_XDP sockets.  MLX NICs will also require an additional traffi=
c
...
=3D1
> +
> +    XDP program can also be loaded externally.  In this case 'inhibit' o=
ption
> +    should be set to 'on' and 'xsks-map-fd' provided with a file descrip=
tor
...
> +
> +        |qemu_system| linux.img -device virtio-net-pci,netdev=3Dn1 \\
> +            -netdev af-xdp,id=3Dn1,ifname=3Deth0,queues=3D3,inhibit=3Don=
,sock-fds=3D15:16:17
> +
> +    With 'inhibit=3Don' and 'sock-fds', QEMU process will only require 3=
2 MB
> +    of locked memory (RLIMIT_MEMLOCK) per queue or CAP_IPC_LOCK capabili=
ty.
> +    With 'inhibit=3Don' and 'xsks-map-fd' it will additionally require
> +    CAP_NET_RAW capability.  With 'inhibit=3Doff', CAP_SYS/NET_ADMIN sho=
uld be
> +    added as well.
...
> diff --git a/scripts/ci/org.centos/stream/8/x86_64/configure b/scripts/ci=
/org.centos/stream/8/x86_64/configure
