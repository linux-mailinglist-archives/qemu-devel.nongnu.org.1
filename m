...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 37A0C881662
	for <lists+qemu-devel@lfdr.de>; Wed, 20 Mar 2024 18:19:34 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rmzan-0003Aa-JU; Wed, 20 Mar 2024 13:19:09 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <baturo.alexey@gmail.com>)
 id 1rmzak-00039H-Nu; Wed, 20 Mar 2024 13:19:06 -0400
Received: from mail-ej1-x62d.google.com ([2a00:1450:4864:20::62d])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <baturo.alexey@gmail.com>)
 id 1rmzah-0006cu-Eb; Wed, 20 Mar 2024 13:19:06 -0400
Received: by mail-ej1-x62d.google.com with SMTP id
 a640c23a62f3a-a46f60cc80aso11391066b.0; 
 Wed, 20 Mar 2024 10:19:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1710955141; x=1711559941; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=M3zg+TJOwT1YZDeI03C6xkLyuJzaKqAbiBHCFsf4Vtc=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1710955141; x=1711559941;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=M3zg+TJOwT1YZDeI03C6xkLyuJzaKqAbiBHCFsf4Vtc=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCX/DZDglwVsgJ9WNlKBg+tgvhj5Ay1s1Pma152UeYYhKHVwTYJhlHdsuGrtwaLYkdxLqX59QLJL8jxXR5H3N0h5M3/LHqdIfjfawjPa9T5hu6nLDL5zLFQnVcIMaA==
X-Gm-Message-State: AOJu0YyzxbNCqMIDSEquuL8W0NitL1q3yN/ypErv86N7viBOcmyKUysI
 fS9NNyz8QV2lXugsavqmNP1pesxhiVRkdO2qdteg/8xAorZ02zfm
X-Google-Smtp-Source: AGHT+IHtSjCXmxjQ3HQbezSFMZ9EwBpndneNZaq414+nUvnAOQmzzS1RwxqNkEDDoww4f6B2eFEWgg==
X-Received: by 2002:a17:907:e91:b0:a46:2c22:7f4c with SMTP id
 ho17-20020a1709070e9100b00a462c227f4cmr2073559ejc.35.1710955141392; 
 Wed, 20 Mar 2024 10:19:01 -0700 (PDT)
Received: from freya.midgard (broadband-188-255-126-251.ip.moscow.rt.ru.
 [188.255.126.251]) by smtp.gmail.com with ESMTPSA id
 pv27-20020a170907209b00b00a4576dd5a8csm7481639ejb.201.2024.03.20.10.18.59
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 20 Mar 2024 10:19:00 -0700 (PDT)
...
Subject: [PATCH v8 1/6] target/riscv: Remove obsolete pointer masking
 extension code.
Date: Wed, 20 Mar 2024 20:18:45 +0300
Message-Id: <20240320171850.1197824-2-me@deliversmonkey.space>
...
@@ -707,7 +690,6 @@ static inline uint32_t vext_get_vlmax(uint32_t vlenb, uint32_t vsew,
...
index fc2068ee4d..5098d2d613 100644
...
index ce7322011d..d20bffdd5a 100644
...
index 726096444f..ffb5a1102e 100644
...
@@ -1401,7 +1391,6 @@ static RISCVException write_mstatus(CPURISCVState *env, int csrno,
         env->xl = cpu_recompute_xl(env);
     }
...
@@ -3968,302 +3957,6 @@ static RISCVException write_mcontext(CPURISCVState *env, int csrno,
     return RISCV_EXCP_NONE;
 }
...
-
 ...
 /* Crypto Extension */
@@ -4869,25 +4562,6 @@ riscv_csr_operations csr_ops[CSR_TABLE_SIZE] = {
...
index ab6db817db..0332203a1f 100644
--- a/target/riscv/tcg/tcg-cpu.c
+++ b/target/riscv/tcg/tcg-cpu.c
@@ -988,7 +988,6 @@ static const RISCVCPUMisaExtConfig misa_ext_cfgs[] = {
     MISA_CFG(RVS, true),
     MISA_CFG(RVU, true),
     MISA_CFG(RVH, true),
-    MISA_CFG(RVJ, false),
     ...
     MISA_CFG(RVG, false),
     MISA_CFG(RVB, false),
@@ -1275,8 +1274,8 @@ static void riscv_init_max_cpu_extensions(Object *obj)
     CPURISCVState *env = &cpu->env;
...
index ea5d52b2ef..3382eb0a5f 100644
...
@@ -584,14 +578,9 @@ static TCGv get_address(DisasContext *ctx, int rs1, int imm)
...
@@ -603,14 +592,9 @@ static TCGv get_address_indexed(DisasContext *ctx, int rs1, TCGv offs)
     TCGv src1 = get_gpr(ctx, rs1, EXT_NONE);
...
@@ -1196,8 +1180,6 @@ static void riscv_tr_init_disas_context(DisasContextBase *dcbase, CPUState *cs)
...
@@ -1330,9 +1312,4 @@ void riscv_translate_init(void)
                              "load_res");
...
index fe56c007d5..4934b43722 100644
