...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id CE19475BBA0
	for <lists+qemu-devel@lfdr.de>; Fri, 21 Jul 2023 02:49:04 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qMeIx-00057J-LA; Thu, 20 Jul 2023 20:47:36 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <jeuk20.kim@gmail.com>)
 id 1qMeIr-000557-Iv; Thu, 20 Jul 2023 20:47:29 -0400
Received: from mail-pf1-x433.google.com ([2607:f8b0:4864:20::433])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <jeuk20.kim@gmail.com>)
 id 1qMeIj-0000N9-Uy; Thu, 20 Jul 2023 20:47:29 -0400
Received: by mail-pf1-x433.google.com with SMTP id
 d2e1a72fcca58-668711086f4so966817b3a.1; 
 Thu, 20 Jul 2023 17:47:21 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20221208; t=1689900439; x=1690505239;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=O3GpD1NrFofrVL7GZsdcftm4i98uJEQyQXY5APYmRgw=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20221208; t=1689900439; x=1690505239;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=O3GpD1NrFofrVL7GZsdcftm4i98uJEQyQXY5APYmRgw=;
 b=
X-Gm-Message-State: ABy/qLafUWsS3m+3lI6BwBjafJZ2l9QDqQT+Hh9smtbflANfDMeGNmkk
 6UMx7t/QEcrIwQdnzHGaJ5tItscRMODtsQ==
X-Google-Smtp-Source: APBJJlEVX+a/g+cLJuLfoabfi4TxVHVGyei+zv3zv2ifrUDmlj+bk6nMa9JdEdzYvMV7tyz6Lbap/Q==
X-Received: by 2002:a05:6a00:2905:b0:67a:72d5:3365 with SMTP id
 cg5-20020a056a00290500b0067a72d53365mr7871961pfb.6.1689900438164; 
 Thu, 20 Jul 2023 17:47:18 -0700 (PDT)
Received: from localhost.localdomain ([218.147.112.168])
 by smtp.gmail.com with ESMTPSA id
 g8-20020aa78748000000b00668738796b6sm1782240pfo.52.2023.07.20.17.47.14
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 20 Jul 2023 17:47:17 -0700 (PDT)
...
Subject: [PATCH v6 3/3] hw/ufs: Support for UFS logical unit
Date: Fri, 21 Jul 2023 09:46:34 +0900
Message-Id: <b6fdb5eb64309d96c00f2a77059d45fdb6e14581.1689899435.git.jeuk20.kim@samsung.com>
...
index cd33af2cde..058f78f647 100644
--- a/hw/ufs/ufs.c
+++ b/hw/ufs/ufs.c
@@ -8,6 +8,19 @@
...
@@ -418,6 +431,19 @@ static const MemoryRegionOps ufs_mmio_ops = {
     },
 };
...
+
 static void ufs_build_upiu_header(UfsRequest *req, uint8_t trans_type,
                                   ...
                                   uint8_t scsi_status,
@@ -431,6 +457,98 @@ static void ufs_build_upiu_header(UfsRequest *req, uint8_t trans_type,
...
@@ -708,9 +826,11 @@ static const RpmbUnitDescriptor rpmb_unit_desc = {
...
@@ -718,8 +838,8 @@ static QueryRespCode ufs_read_unit_desc(UfsRequest *req)
     if (lun == UFS_UPIU_RPMB_WLUN) {
...
@@ -969,8 +1089,7 @@ static void ufs_exec_req(UfsRequest *req)
...
@@ -981,7 +1100,14 @@ static void ufs_exec_req(UfsRequest *req)
         req_result = UFS_REQUEST_FAIL;
     }
...
@@ -1183,6 +1309,28 @@ static void ufs_init_hc(UfsHc *u)
...
+
 ...
 {
     UfsHc *u = UFS(pci_dev);
@@ -1191,15 +1339,55 @@ static void ufs_realize(PCIDevice *pci_dev, Error **errp)
         return;
     }
...
@@ -1238,6 +1426,49 @@ static void ufs_class_init(ObjectClass *oc, void *data)
     dc->vmsd = &ufs_vmstate;
 }
...
@@ -1246,9 +1477,18 @@ static const TypeInfo ufs_info = {
