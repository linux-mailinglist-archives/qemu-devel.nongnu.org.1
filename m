...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id CF864BE8947
	for <lists+qemu-devel@lfdr.de>; Fri, 17 Oct 2025 14:25:32 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1v9jVS-0003QT-Mq; Fri, 17 Oct 2025 08:24:26 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <zhiwei_liu@linux.alibaba.com>)
 id 1v9jV4-0003Pz-Qg; Fri, 17 Oct 2025 08:24:03 -0400
Received: from [115.124.30.119] (helo=out30-119.freemail.mail.aliyun.com)
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <zhiwei_liu@linux.alibaba.com>)
 id 1v9jUm-000613-UG; Fri, 17 Oct 2025 08:24:02 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linux.alibaba.com; s=default;
 t=1760703795; h=Content-Type:Message-ID:Date:MIME-Version:Subject:To:From;
 bh=CsiG/KGTi3fkMUpnSGwB0slbLv8nNEBui3TseU76L+M=;
 b=dMiPzjFUEdCyRiOLOQFlU7uPdJAeBF6o3Vtr8pWu98r6ZTMFUbm6MPEmV5dZQCn4ZxhAf0dwsegLycP/F01m8Bb6Jid3ubj9MDYQira0IFvHVDhGPyfnD+qdrcRqVIMu3LUrxPqB2KY4+K6vPAkYr4ZrxyyDGCQOhXftWuZdikk=
Received: from 30.166.65.138(mailfrom:zhiwei_liu@linux.alibaba.com
 fp:SMTPD_---0WqPerwm_1760703792 cluster:ay36) by smtp.aliyun-inc.com;
 Fri, 17 Oct 2025 20:23:13 +0800
Content-Type: multipart/alternative;
 boundary="------------vNMlMVvAnLLhbqRq3chSGDIK"
Message-ID: <2e45ffac-e4fb-4113-93d6-9a672bd5495f@linux.alibaba.com>
Date: Fri, 17 Oct 2025 20:23:12 +0800
MIME-Version: 1.0
...
X-Host-Lookup-Failed: Reverse DNS lookup failed for 115.124.30.119 (deferred)
...
<html>
  ...
  <body>
    <p>Hi Ethan,</p>
    <p>It's really a long patch. I am not sure I fully understand it.</p>
    <pre wrap="" class="moz-quote-pre">Is txn_info_push function a dead code in this patch? I find there is no way to call it.

Could you show the way to use it?

Thanks,
Zhiwei</pre>
    <div class="moz-cite-prefix">On 3/12/25 5:37 PM, Ethan Chen wrote:<br>
    </div>
    <blockquote type="cite"
      cite="mid:20250312093735.1517740-7-ethan84@andestech.com">
      <pre wrap="" class="moz-quote-pre">Support IOPMP specification v0.7.
The specification url:
...
(rwx), the target address space is downstream_as. If the access has
limited permission, the target address space is blocked_ followed by
the lacked permissions.<span style="white-space: pre-wrap">
</span></pre>
    </blockquote>
    <blockquote type="cite"
      cite="mid:20250312093735.1517740-7-ethan84@andestech.com">
      <pre wrap="" class="moz-quote-pre">The operation of a blocked region can trigger an IOPMP interrupt, a bus
error, or it can respond with success and fabricated data, depending on
the value of the IOPMP ERR_CFG register.
...
Signed-off-by: Ethan Chen <a class="moz-txt-link-rfc2396E" href="mailto:ethan84@andestech.com">&lt;ethan84@andestech.com&gt;</a>
---
 hw/misc/Kconfig               |    4 +
 hw/misc/meson.build           |    1 +
 hw/misc/riscv_iopmp.c         | 2157 +++++++++++++++++++++++++++++++++
