...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id D48AFAB8AFE
	for <lists+qemu-devel@lfdr.de>; Thu, 15 May 2025 17:41:22 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1uFah3-0002yp-Ha; Thu, 15 May 2025 11:40:21 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <cohuck@redhat.com>) id 1uFah0-0002wF-JV
 for qemu-devel@nongnu.org; Thu, 15 May 2025 11:40:18 -0400
Received: from us-smtp-delivery-124.mimecast.com ([170.10.129.124])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <cohuck@redhat.com>) id 1uFagu-0005oh-2q
 for qemu-devel@nongnu.org; Thu, 15 May 2025 11:40:18 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1747323610;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=Ywma4e2p1w0e9vqy/A2dn1Y4aTc47c1IW8wydZlajy0=;
 b=i2UU+NoOWXFnjcLCj72h+UnqZIXa6JwXZwnpFK6jPBqBbM0BRustIvrIDfcxPapcYlPyEH
 8y4hzzydatgfl+oKtb+9Hh7HDcYOrtllKc4FIq6+9SWGVGJxgqIvn5JYxc2kT/aECnckzT
 oEJmL34BGt0hQ2g+coaBdvGYO9k/k44=
Received: from mx-prod-mc-03.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-659-UWyrARaNOsWlwGxeFly9oQ-1; Thu,
 15 May 2025 11:40:06 -0400
X-MC-Unique: UWyrARaNOsWlwGxeFly9oQ-1
X-Mimecast-MFC-AGG-ID: UWyrARaNOsWlwGxeFly9oQ_1747323604
Received: from mx-prod-int-04.mail-002.prod.us-west-2.aws.redhat.com
 ...
 id A88AF1955E79; Thu, 15 May 2025 15:40:04 +0000 (UTC)
Received: from gondolin.redhat.com (unknown [10.45.225.145])
 by mx-prod-int-04.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP
 id 541041956066; Thu, 15 May 2025 15:39:58 +0000 (UTC)
...
Subject: [PATCH v7 06/14] arm/cpu: Store aa64dfr0/1 into the idregs array
Date: Thu, 15 May 2025 17:38:59 +0200
Message-ID: <20250515153907.151174-7-cohuck@redhat.com>
...
index a4c8796a87de..a4ae6110d197 100644
--- a/target/arm/cpu.c
+++ b/target/arm/cpu.c
@@ -2354,8 +2354,7 @@ static void arm_cpu_realizefn(DeviceState *dev, Error **errp)
                 cpu);
 #endif
     } else {
...
+        FIELD_DP64_IDREG(isar, ID_AA64DFR0, PMUVER, 0);
         ...
         cpu->pmceid0 = 0;
         cpu->pmceid1 = 0;
@@ -2415,19 +2414,15 @@ static void arm_cpu_realizefn(DeviceState *dev, Error **errp)
...
index c5c6acd9789f..c418446b47d0 100644
--- a/target/arm/cpu.h
+++ b/target/arm/cpu.h
...
index f57725a4fd18..c2da52b5bac2 100644
...
index 660d3a88e070..1e7ebeaa8f60 100644
--- a/target/arm/internals.h
+++ b/target/arm/internals.h
@@ -1176,7 +1176,7 @@ static inline bool regime_using_lpae_format(CPUARMState *env, ARMMMUIdx mmu_idx)
...
@@ -1190,7 +1190,7 @@ static inline int arm_num_brps(ARMCPU *cpu)
...
@@ -1204,7 +1204,7 @@ static inline int arm_num_wrps(ARMCPU *cpu)
...
index f5153f8f7e91..7bc208a0a27d 100644
--- a/target/arm/kvm.c
+++ b/target/arm/kvm.c
