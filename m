...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 77C239C3115
	for <lists+qemu-devel@lfdr.de>; Sun, 10 Nov 2024 07:51:46 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1tA1mE-0007yo-Jk; Sun, 10 Nov 2024 01:50:26 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <akihiko.odaki@daynix.com>)
 id 1tA1l3-0007nV-Qb
 for qemu-devel@nongnu.org; Sun, 10 Nov 2024 01:49:13 -0500
...
Received: by mail-pf1-x436.google.com with SMTP id
 d2e1a72fcca58-720d01caa66so3333309b3a.2
 for <qemu-devel@nongnu.org>; Sat, 09 Nov 2024 22:49:05 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=daynix-com.20230601.gappssmtp.com; s=20230601; t=1731221344; x=1731826144;
 darn=nongnu.org; 
 h=content-transfer-encoding:in-reply-to:from:content-language
 :references:cc:to:subject:user-agent:mime-version:date:message-id
 :from:to:cc:subject:date:message-id:reply-to;
 bh=YvQZrIB3AAiD3i0ecNBs6xKRB+eTnROa2ZTtLsY0A/U=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1731221344; x=1731826144;
 h=content-transfer-encoding:in-reply-to:from:content-language
 :references:cc:to:subject:user-agent:mime-version:date:message-id
 :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
 bh=YvQZrIB3AAiD3i0ecNBs6xKRB+eTnROa2ZTtLsY0A/U=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCW4wMscQIhUT0DlGJcFTsG4/3UFT0aRpGpkfXaPNmicbwNCSzm8hT8SrXOYraYzi2dfC11Wo1LDfbTV@nongnu.org
X-Gm-Message-State: AOJu0YzHtaqLdVJBtgFMkxFdQLE5IrnuJwpgOEbiy8xnjxHBmGEJLM6P
 o+EtDX6L3L02p0cnJVsltf4yCJraBYJLDPH7gse3sTYMnh3TZ14tZsDlBBRmIFw=
X-Google-Smtp-Source: AGHT+IGwnHr8j0INc+56K+WKEO0cQuObmgy0fQRtYjdZpd/gCCYzjgXSHeaeXNH8BSGOh3lhByVc4g==
X-Received: by 2002:a05:6a20:734c:b0:1d9:275b:4ee1 with SMTP id
 adf61e73a8af0-1dc229e0787mr13912961637.24.1731221343581; 
 Sat, 09 Nov 2024 22:49:03 -0800 (PST)
Received: from [157.82.207.107] ([157.82.207.107])
 by smtp.gmail.com with ESMTPSA id
 41be03b00d2f7-7f41f65b5afsm6198619a12.76.2024.11.09.22.48.57
 (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
 Sat, 09 Nov 2024 22:49:03 -0800 (PST)
Message-ID: <4ececf9e-40f1-4dcc-8661-7a24a6e832f4@daynix.com>
Date: Sun, 10 Nov 2024 15:48:55 +0900
MIME-Version: 1.0
...
I suggest merging this function into apple_gfx_task_map_memory(). It 
looks now so trivial that it doesn't require splitting into a function.

Besides, this function has a comment saying "returns false if the region 
is already in the array". It will be clear if we merge this logic into 
apple_gfx_task_map_memory():
...
Pass a real DeviceState * here; passing NULL here makes the console 
labelled as "VGA", which is not correct (especially for apple-gfx-mmio).

> +
> +    qatomic_set(&s->cursor_show, true);

Set before apple_gfx_prepare_display_descriptor(), which creates blocks 
that will refer to s->cursor_show. This doesn't need qatomic_set() as 
other members initialized here don't.
