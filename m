...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id C5ECB89E5EE
	for <lists+qemu-devel@lfdr.de>; Wed, 10 Apr 2024 01:10:00 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1ruKa2-0006Pl-4a; Tue, 09 Apr 2024 19:08:42 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <Michael.Roth@amd.com>)
 id 1ruKZx-0006PI-QL
 for qemu-devel@nongnu.org; Tue, 09 Apr 2024 19:08:37 -0400
...
Subject: [PATCH v1 1/3] i386/sev: Add 'legacy-vm-type' parameter for SEV guest
 objects
