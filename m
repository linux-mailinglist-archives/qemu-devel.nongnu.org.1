...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id EC0747C9626
	for <lists+qemu-devel@lfdr.de>; Sat, 14 Oct 2023 21:58:53 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qrkll-00041F-Fz; Sat, 14 Oct 2023 15:57:53 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <deller@kernel.org>) id 1qrkle-0003yD-AE
 for qemu-devel@nongnu.org; Sat, 14 Oct 2023 15:57:46 -0400
Received: from ams.source.kernel.org ([145.40.68.75])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <deller@kernel.org>) id 1qrklb-0004fE-OW
 for qemu-devel@nongnu.org; Sat, 14 Oct 2023 15:57:45 -0400
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
 by ams.source.kernel.org (Postfix) with ESMTP id C7C7FB80B74;
 Sat, 14 Oct 2023 19:57:39 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 481C0C433C9;
 Sat, 14 Oct 2023 19:57:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=k20201202; t=1697313459;
 bh=rfJauSzi5+tEvjuOKdar2ThVVLGAlGs2JK1Zco781kU=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
From: deller@kernel.org
To: qemu-devel@nongnu.org
Cc: Richard Henderson <richard.henderson@linaro.org>,
 Helge Deller <deller@gmx.de>
Subject: [PATCH 11/12] hw/hppa: Split out machine creation
Date: Sat, 14 Oct 2023 21:57:18 +0200
Message-ID: <20231014195719.151397-12-deller@kernel.org>
...
@@ -494,6 +460,66 @@ static void machine_hppa_init(MachineState *machine)
...
@@ -542,14 +568,14 @@ static void hppa_nmi(NMIState *n, int cpu_index, Error **errp)
     }
 }
...
@@ -563,10 +589,10 @@ static void hppa_machine_init_class_init(ObjectClass *oc, void *data)
...
+    .class_init = HP_B160L_machine_init_class_init,
     .interfaces = (InterfaceInfo[]) {
         { TYPE_NMI },
         { }
@@ -575,7 +601,7 @@ static const TypeInfo hppa_machine_init_typeinfo = {
