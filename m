...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FFAD838BDA
	for <lists+qemu-devel@lfdr.de>; Tue, 23 Jan 2024 11:29:36 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rSE1g-0006oS-Ln; Tue, 23 Jan 2024 05:29:04 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mjt@tls.msk.ru>)
 id 1rSE1e-0006nn-9F; Tue, 23 Jan 2024 05:29:02 -0500
Received: from isrv.corpit.ru ([86.62.121.231])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mjt@tls.msk.ru>)
 id 1rSE1c-0005Ln-9e; Tue, 23 Jan 2024 05:29:01 -0500
Received: from tsrv.corpit.ru (tsrv.tls.msk.ru [192.168.177.2])
 by isrv.corpit.ru (Postfix) with ESMTP id 499F64674E;
 Tue, 23 Jan 2024 13:29:24 +0300 (MSK)
Received: from tls.msk.ru (mjt.wg.tls.msk.ru [192.168.177.130])
 by tsrv.corpit.ru (Postfix) with SMTP id D109569AEA;
 Tue, 23 Jan 2024 13:28:43 +0300 (MSK)
Received: (nullmailer pid 3831713 invoked by uid 1000);
...
Subject: [Stable-8.1.5 15/24] target/i386: pcrel: store low bits of physical
 address in data[0]
Date: Tue, 23 Jan 2024 13:28:29 +0300
Message-Id: <20240123102843.3831660-4-mjt@tls.msk.ru>
...
index f252e336d7..f062c376a2 100644
...
index 2a9f277adb..94898fe9e6 100644
--- a/target/i386/tcg/translate.c
+++ b/target/i386/tcg/translate.c
@@ -7000,7 +7000,6 @@ static void i386_tr_insn_start(DisasContextBase *dcbase, CPUState *cpu)
