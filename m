...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id DF3057711E2
	for <lists+qemu-devel@lfdr.de>; Sat,  5 Aug 2023 21:42:32 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qSN9m-0007ez-TZ; Sat, 05 Aug 2023 15:41:47 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mjt@tls.msk.ru>)
 id 1qSN9k-0007eI-Nj; Sat, 05 Aug 2023 15:41:44 -0400
Received: from isrv.corpit.ru ([86.62.121.231])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mjt@tls.msk.ru>)
 id 1qSN9j-0007t8-5c; Sat, 05 Aug 2023 15:41:44 -0400
Received: from tsrv.corpit.ru (tsrv.tls.msk.ru [192.168.177.2])
 by isrv.corpit.ru (Postfix) with ESMTP id 6416618664;
 Sat,  5 Aug 2023 22:41:51 +0300 (MSK)
Received: from tls.msk.ru (mjt.wg.tls.msk.ru [192.168.177.130])
 by tsrv.corpit.ru (Postfix) with SMTP id 27DDA1BA4A;
 Sat,  5 Aug 2023 22:41:29 +0300 (MSK)
Received: (nullmailer pid 70370 invoked by uid 1000);
 Sat, 05 Aug 2023 19:41:27 -0000
From: Michael Tokarev <mjt@tls.msk.ru>
To: qemu-devel@nongnu.org
Cc: qemu-stable@nongnu.org, Matt Borgerson <contact@mborgerson.com>,
 Paolo Bonzini <pbonzini@redhat.com>, Michael Tokarev <mjt@tls.msk.ru>
Subject: [Stable-8.0.4 71/71] target/i386: Check CR0.TS before enter_mmx
Date: Sat,  5 Aug 2023 22:41:12 +0300
Message-Id: <20230805194127.70304-8-mjt@tls.msk.ru>
...
index 48fefaffdf..e7fa5e9458 100644
--- a/target/i386/tcg/decode-new.c.inc
+++ b/target/i386/tcg/decode-new.c.inc
@@ -1802,16 +1802,18 @@ static void disas_insn_new(DisasContext *s, CPUState *cpu, int b)
         }
         break;
