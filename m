Content-Type: text/plain; charset="UTF-8"
Content-Transfer-Encoding: quoted-printable

On Wed, Aug 23, 2023 at 8:03=E2=80=AFAM Mark Cave-Ayland <
...
>
> You shouldn't access .parent_obj directly, but instead use the appropriat=
e
> QOM cast
> macro.
>
...
> owner should
> be the VirtIOGPURutabaga object since that is the container for the memor=
y
> slots?
>
...
> introduced for the
> virtio-gpu-rutabaga-device: you'll need to nominate someone to receive bu=
g
...
<div dir=3D"ltr" class=3D"gmail_attr">On Wed, Aug 23, 2023 at 8:03=E2=80=AF=
...
&gt;=C2=A0 =C2=A0 =C2=A0 - Disable scanout when appropriate<br>
&gt;=C2=A0 =C2=A0 =C2=A0 - CHECK capset index within range outside loop<br>
&gt;=C2=A0 =C2=A0 =C2=A0 - Add capset_version<br>
&gt; <br>
&gt; v7: Incorporated feedback from Akihiko Odaki:<br>
&gt;=C2=A0 =C2=A0 =C2=A0 - aio_bh_schedule_oneshot_full --&gt; aio_bh_sched=
ule_oneshot<br>
&gt; <br>
&gt;=C2=A0 =C2=A0hw/display/virtio-gpu-pci-rutabaga.c |=C2=A0 =C2=A048 ++<b=
r>
&gt;=C2=A0 =C2=A0hw/display/virtio-gpu-rutabaga.c=C2=A0 =C2=A0 =C2=A0| 1115=
 ++++++++++++++++++++++++++<br>
&gt;=C2=A0 =C2=A0hw/display/virtio-vga-rutabaga.c=C2=A0 =C2=A0 =C2=A0|=C2=
=A0 =C2=A051 ++<br>
&gt;=C2=A0 =C2=A03 files changed, 1214 insertions(+)<br>
...
<br>
QEMU uses C instead of C++ comments.<br>
<br>
&gt; +<br>
...
<br>
The typedef above shouldn&#39;t be required, and why are you using <br>
DECLARE_INSTANCE_CHECKER instead of OBJECT_DECLARE_SIMPLE_TYPE?<br>
<br>
&gt; +struct VirtIOGPURutabagaPCI {<br>
&gt; +=C2=A0 =C2=A0 VirtIOGPUPCIBase parent_obj;<br>
<br>
Missing blank line here.<br>
<br>
...
<br>
The new way to declare QOM types is with the DEFINE_TYPES() macro.<br></blo=
ckquote><div><br></div><div>Done for virtio-gpu-rutabaga.c and virtio-gpu-p=
ci-rutabaga.c.=C2=A0 The vga file has the &quot;have_vga&quot; variable tha=
t prevents the transition.=C2=A0 Incorporated your other suggestions for th=
is patch though in v12.</div><div>=C2=A0</div><blockquote class=3D"gmail_qu=
...
rutabaga.c<br>
&gt; new file mode 100644<br>
&gt; index 0000000000..24977d3993<br>
&gt; --- /dev/null<br>
&gt; +++ b/hw/display/virtio-gpu-rutabaga.c<br>
&gt; @@ -0,0 +1,1115 @@<br>
&gt; +// SPDX-License-Identifier: GPL-2.0<br>
<br>
This should be a C and not a C++ comment.<br>
<br>
&gt; +<br>
&gt; +#include &quot;qemu/osdep.h&quot;<br>
&gt; +#include &quot;qapi/error.h&quot;<br>
...
[i];<br>
<br>
You shouldn&#39;t access .parent_obj directly, but instead use the appropri=
ate QOM cast <br>
macro.<br>
<br>
...
<br>
Same comment here re: parent_obj.<br>
<br>
...
<br>
Here you&#39;re declaring the MemoryRegion so that it doesn&#39;t have an o=
wner, which should <br>
only be required for MemoryRegions that are never destroyed. I think the ow=
ner should <br>
...
<br>
Same comment again re: DEFINE_TYPES.<br>
<br>
...
<br>
Same comment as earlier: you should be able top drop the typedef and use <b=
r>
OBJECT_DECLARE_SIMPLE_TYPE instead of DECLARE_INSTANCE_CHECKER.<br>
<br>
...
<br>
Just out of curiosity has this series passed a run through QEMU&#39;s gitla=
b CI and also <br>
scripts/<a href=3D"http://checkpatch.pl" rel=3D"noreferrer" target=3D"_blan=
k">checkpatch.pl</a>?<br></blockquote><div><br></div><div>I tried to run th=
e CI as per:</div><div><br></div><div><a href=3D"https://wiki.qemu.org/Test=
ing/CI/Integrated" target=3D"_blank">https://wiki.qemu.org/Testing/CI/Integ=
rated</a><br></div><div><br></div><div>It only automatically created a pipe=
line during the first push, and failed since I didn&#39;t have my account v=
alidated.=C2=A0 After I verified my account, it never created a pipeline ag=
ain.=C2=A0 In the pipeline editor, I keep getting &quot;Pipeline will not r=
un for the selected trigger. The rules configuration prevented any jobs fro=
m being added to the pipeline.&quot;=C2=A0 So I gave up.</div><div><br></di=
v><div>For <a href=3D"http://checkpatch.pl" target=3D"_blank">checkpatch.pl=
</a>, I&#39;ve run every version of the series through it.=C2=A0 Interestin=
gly, it doesn&#39;t catch a few things:</div><div><br></div><div>- Licensin=
g regarding GPL2.0 or greater</div><div>- Style of comments if it&#39;s rel=
ated to the licensing.=C2=A0 Other comments, I think it=C2=A0helped with.</=
div><div>- Casting style or unnecessary style</div><div>- The new blank lin=
e after declaration of a &quot;parent_obj&quot; in QOM</div><div><br></div>=
<div>=C2=A0=C2=A0</div><blockquote class=3D"gmail_quote" style=3D"margin:0p=
x 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex">
I don&#39;t see any changes to the MAINTAINERS file for the new files intro=
duced for the <br>
virtio-gpu-rutabaga-device: you&#39;ll need to nominate someone to receive =
bug <br>
reports/respond to patches and update MAINTAINERS accordingly.<br></blockqu=
ote><div><br></div><div><div>virtio-gpu-rutabaga would fall into the purvie=
w of &quot;virtio-gpu&quot; in the=C2=A0MAINTAINERS file.=C2=A0 I don&#39;t=
 expect many QEMU bugs after the initial merge, since most of the bugs will=
 be inside rutabaga or in guest userspace.</div><div><br></div><div>There&#=
39;s no shortage of reviewers, since I&#39;ve gotten a lot of review commen=
ts with this series.=C2=A0 So personally I&#39;m fine with the status quo o=
f &quot;whoever has interest reviews, maintainers do a sanity check&quot;.<=
/div><div>=C2=A0<br></div></div><blockquote class=3D"gmail_quote" style=3D"=
margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-lef=
t:1ex">
Similarly I think you&#39;ll want a patch to include coverage of this in gi=
tlab CI <br>
somewhere as otherwise any build errors may not be noticed by developers wh=
o don&#39;t <br>
have rutabaga installed.</blockquote><div><br></div><div>We do have to buil=
d upstream QEMU in AOSP due to compliance reasons, so downstream testing sh=
ould catch any upstream build failures quickly.=C2=A0 Long-term, I do think=
 it makes sense to add upstream QEMU testing, especially for downstream pro=
ducts who=C2=A0have their own elaborate testing infra (Android Emulator).=
=C2=A0 But the exact form that takes probably requires some more thought, s=
o holding off on any CI patches for now.</div><div>=C2=A0<br></div><blockqu=
