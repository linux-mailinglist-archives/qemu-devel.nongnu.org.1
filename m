...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 6474D7032D6
	for <lists+qemu-devel@lfdr.de>; Mon, 15 May 2023 18:24:28 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1pyaya-0001NR-6b; Mon, 15 May 2023 12:23:08 -0400
...
Received: by mail-wr1-x42e.google.com with SMTP id
 ffacd0b85a97d-306281edf15so12314239f8f.1
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :message-id:reply-to;
 bh=OaJIr35f0SoNree+5+82PsKu8ep7DIZDi9Kkj/M+Vks=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=OaJIr35f0SoNree+5+82PsKu8ep7DIZDi9Kkj/M+Vks=;
 b=
X-Gm-Message-State: AC+VfDxAxlgaPx5lZu1ZNBhYoxwxWWBI3p7dQYa56lclclq86GchNHB+
 K8FuoSmXXOMxy80w44WNMPPSfZriyuzamlZjLCc=
X-Google-Smtp-Source: ACHHUZ67joaQu/rODAOtfvZVEKNfmrHJ1ke56sXLLRmYPYij7F8826h1LOuIUquhLkQ9y2dWrGydgw==
X-Received: by 2002:a05:6000:1148:b0:2fa:88f2:b04c with SMTP id
 d8-20020a056000114800b002fa88f2b04cmr23536182wrx.20.1684167767264; 
...
Subject: [PATCH v3 1/3] docs/interop: Convert qmp-spec.txt to rST
Date: Mon, 15 May 2023 17:22:43 +0100
...
v2->v3: fix up the references elsewhere in the codebase to
   qmp-spec.txt (this includes using section names rather
   than numbers)
---
...
index 5618a80378e..7f78183cd48 100644
...
index 6a7c5af882a..a91fa334079 100644
--- a/qapi/control.json
+++ b/qapi/control.json
@@ -27,7 +27,7 @@
...
index 31e0b364547..6594afba312 100644
...
index 632320d72d5..51341d96e49 100644
...
index de87f878047..da52848d5a7 100644
...
index 9d73ae6e7ad..2a817f9db33 100644
