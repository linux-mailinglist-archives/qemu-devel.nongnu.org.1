...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id A0AE87386D2
	for <lists+qemu-devel@lfdr.de>; Wed, 21 Jun 2023 16:24:40 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qBykt-0003QE-BU; Wed, 21 Jun 2023 10:24:19 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <kbastian@mail.uni-paderborn.de>)
 id 1qBykr-0003Kh-1y
 for qemu-devel@nongnu.org; Wed, 21 Jun 2023 10:24:17 -0400
Received: from hoth.uni-paderborn.de ([2001:638:502:c003::19])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <kbastian@mail.uni-paderborn.de>)
 id 1qBykp-00019Z-FC
 for qemu-devel@nongnu.org; Wed, 21 Jun 2023 10:24:16 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=3VTBczwsGDfBt9rx/iQR7bpPo4ENBqw1pplXdjYU9QY=; b=jyURUtjzRAXw3B9MBtp9Tkygne
...
Subject: [PATCH v4 8/8] target/tricore: Fix ICR.IE offset in RESTORE insn
Date: Wed, 21 Jun 2023 16:23:02 +0200
...
X-Sophos-SenderHistory: ip=79.202.219.6, fs=1202345, da=174966518, mc=139, sc=0,
 hc=139, sp=0, fso=1202345, re=0, sd=0, hd=0
X-IMT-Source: Intern
...
index 71b6209af4..7feab20a7e 100644
--- a/target/tricore/translate.c
+++ b/target/tricore/translate.c
@@ -7956,7 +7956,9 @@ static void decode_sys_interrupts(DisasContext *ctx)
