...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id EC4998C6BA9
	for <lists+qemu-devel@lfdr.de>; Wed, 15 May 2024 19:44:18 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1s7Ifg-0001Rq-Vh; Wed, 15 May 2024 13:44:10 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <chalapathi.v@linux.ibm.com>)
 id 1s7IeP-00014T-Nd; Wed, 15 May 2024 13:42:54 -0400
Received: from mx0a-001b2d01.pphosted.com ([148.163.156.1])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <chalapathi.v@linux.ibm.com>)
 id 1s7Ie9-0006ZG-UE; Wed, 15 May 2024 13:42:47 -0400
Received: from pps.filterd (m0356517.ppops.net [127.0.0.1])
 by mx0a-001b2d01.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id
 44FHapbJ024503; Wed, 15 May 2024 17:42:19 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com;
 h=from : to : cc : subject
 : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding; s=pp1;
 bh=t8vaAO6VLp42dzpqeuFQWY0KBaPFtXaq3/l2waaBs1I=;
 b= 2Q== 
Received: from pps.reinject (localhost [127.0.0.1])
 by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 3y51kug0a0-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Wed, 15 May 2024 17:42:19 +0000
Received: from m0356517.ppops.net (m0356517.ppops.net [127.0.0.1])
 by pps.reinject (8.17.1.5/8.17.1.5) with ESMTP id 44FHgIGf032344;
 Wed, 15 May 2024 17:42:18 GMT
Received: from ppma23.wdc07v.mail.ibm.com
 (5d.69.3da9.ip4.static.sl-reverse.com [169.61.105.93])
 by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 3y51kug09x-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Wed, 15 May 2024 17:42:18 +0000
Received: from pps.filterd (ppma23.wdc07v.mail.ibm.com [127.0.0.1])
 by ppma23.wdc07v.mail.ibm.com (8.17.1.19/8.17.1.19) with ESMTP id
 44FFgTXB005986; Wed, 15 May 2024 17:42:17 GMT
Received: from smtprelay02.fra02v.mail.ibm.com ([9.218.2.226])
 by ppma23.wdc07v.mail.ibm.com (PPS) with ESMTPS id 3y2mgmmvyg-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Wed, 15 May 2024 17:42:17 +0000
Received: from smtpav02.fra02v.mail.ibm.com (smtpav02.fra02v.mail.ibm.com
 [10.20.54.101])
 by smtprelay02.fra02v.mail.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id
 44FHgBjk47972770
 (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
 Wed, 15 May 2024 17:42:13 GMT
Received: from smtpav02.fra02v.mail.ibm.com (unknown [127.0.0.1])
 by IMSVA (Postfix) with ESMTP id F25B820040;
 Wed, 15 May 2024 17:42:10 +0000 (GMT)
Received: from smtpav02.fra02v.mail.ibm.com (unknown [127.0.0.1])
 by IMSVA (Postfix) with ESMTP id D49D320043;
 Wed, 15 May 2024 17:42:08 +0000 (GMT)
...
Subject: [PATCH v3 2/5] ppc/pnv: Extend SPI model
Date: Wed, 15 May 2024 12:41:46 -0500
Message-Id: <20240515174149.17713-3-chalapathi.v@linux.ibm.com>
...
X-TM-AS-GCONF: 00
X-Proofpoint-GUID: Q7lKeZaGpar-u5NlxCYQA4WTSo-vIng3
X-Proofpoint-ORIG-GUID: _dgjoyMyVD1ibxlD91eL1Be9etckjQkW
...
+
 static uint64_t pnv_spi_controller_read(void *opaque, hwaddr addr,
                                  unsigned size)
 {
@@ -49,6 +1115,10 @@ static uint64_t pnv_spi_controller_read(void *opaque, hwaddr addr,
...
+        }
     ...
     case SEQUENCER_OPERATION_REG:
         val = 0;
@@ -120,6 +1190,8 @@ static void pnv_spi_controller_write(void *opaque, hwaddr addr,
...
@@ -155,6 +1227,7 @@ static const MemoryRegionOps pnv_spi_controller_xscom_ops = {
...
@@ -206,6 +1279,7 @@ static void pnv_spi_controller_class_init(ObjectClass *klass, void *data)
...
@@ -115,6 +115,21 @@ pnv_spi_read(uint64_t addr, uint64_t val) "addr 0x%" PRIx64 " val 0x%" PRIx64
