...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E6CA724F7C
	for <lists+qemu-devel@lfdr.de>; Wed,  7 Jun 2023 00:17:22 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1q6eyG-0000lN-OZ; Tue, 06 Jun 2023 18:16:08 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mgalaxy@akamai.com>)
 id 1q6eyE-0000kv-8F
 for qemu-devel@nongnu.org; Tue, 06 Jun 2023 18:16:06 -0400
...
Received: from pps.filterd (m0050093.ppops.net [127.0.0.1])
 ...
 356Ie4rL001889; Tue, 6 Jun 2023 23:15:41 +0100
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=akamai.com;
 h=content-type :
 message-id : date : mime-version : from : subject : to : cc : references :
 in-reply-to; s=jan2016.eng;
 bh=mYKYnYUSCUvF5ek56wYkpbdEQH7BGrVtBwn1WdLy9eQ=;
 b= fA== 
Received: from prod-mail-ppoint3
 (a72-247-45-31.deploy.static.akamaitechnologies.com [72.247.45.31] (may be
 forged))
 by m0050093.ppops.net-00190b01. (PPS) with ESMTPS id 3r2a9gc765-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Tue, 06 Jun 2023 23:15:41 +0100
Received: from pps.filterd (prod-mail-ppoint3.akamai.com [127.0.0.1])
 by prod-mail-ppoint3.akamai.com (8.17.1.19/8.17.1.19) with ESMTP id
 356IvfMA021476; Tue, 6 Jun 2023 18:15:40 -0400
Received: from prod-mail-relay19.dfw02.corp.akamai.com ([172.27.165.173])
 by prod-mail-ppoint3.akamai.com (PPS) with ESMTP id 3r2ahdrta1-1;
 Tue, 06 Jun 2023 18:15:40 -0400
Received: from [100.64.0.1] (prod-aoa-dallas2clt14.dfw02.corp.akamai.com
 [172.27.166.123])
 by prod-mail-relay19.dfw02.corp.akamai.com (Postfix) with ESMTP id CFA14602C1; 
 Tue,  6 Jun 2023 22:15:36 +0000 (GMT)
Content-Type: multipart/alternative;
 boundary="------------eGc0Qvt3RdiwQcu1jPodQdPn"
Message-ID: <ada81103-d4eb-dd02-45a8-176dae06d26c@akamai.com>
Date: Tue, 6 Jun 2023 17:15:36 -0500
MIME-Version: 1.0
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 mlxlogscore=999
 ...
 engine=8.12.0-2305260000 definitions=main-2306060184
X-Proofpoint-ORIG-GUID: qYRqcMyzpAZAeHNtyhOv1rj8F9rXsOJu
X-Proofpoint-GUID: qYRqcMyzpAZAeHNtyhOv1rj8F9rXsOJu
X-Proofpoint-Virus-Version: vendor=baseguard
 engine=ICAP:2.0.254,Aquarius:18.0.957,Hydra:6.0.573,FMLib:17.11.176.26
 definitions=2023-06-06_16,2023-06-06_02,2023-05-22_02
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 spamscore=0
 lowpriorityscore=0
 mlxlogscore=999 bulkscore=0 suspectscore=0 impostorscore=0 malwarescore=0
 clxscore=1011 adultscore=0 mlxscore=0 phishscore=0 priorityscore=1501
 classifier=spam adjust=0 reason=mlx scancount=1 engine=8.12.0-2305260000
 definitions=main-2306060185
...
X-Spam_report: (-2.9 / 5.0 requ) BAYES_00=-1.9, DKIMWL_WL_HIGH=-0.001,
 ...
 HTML_MESSAGE=0.001, NICE_REPLY_A=-0.094, RCVD_IN_DNSWL_LOW=-0.7,
...
<html>
  ...
  <body>
    ...
    line parameter "-migrate-mode-enable cpr-reboot"<br>
    *and* issue the monitor command "migrate_set_parameter mode
    cpr-${mode}".<br>
    <br>
    Is it possible to opt-in to the CPR mode just once over the monitor
    instead of having to specify it twice on the command line?<br>
    This would also match the live migration model: You do not need to
