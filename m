...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 16C1A832FD3
	for <lists+qemu-devel@lfdr.de>; Fri, 19 Jan 2024 21:35:20 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rQvYK-0001hv-RC; Fri, 19 Jan 2024 15:33:24 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from
 <3j9yqZQwKCigREFMLIWXIJERKSSKPI.GSQUIQY-HIZIPRSRKRY.SVK@flex--nabihestefan.bounces.google.com>)
 id 1rQvYJ-0001h2-3l
 for qemu-devel@nongnu.org; Fri, 19 Jan 2024 15:33:23 -0500
Received: from mail-yw1-x114a.google.com ([2607:f8b0:4864:20::114a])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from
 <3j9yqZQwKCigREFMLIWXIJERKSSKPI.GSQUIQY-HIZIPRSRKRY.SVK@flex--nabihestefan.bounces.google.com>)
 id 1rQvYG-0003o4-Pi
 for qemu-devel@nongnu.org; Fri, 19 Jan 2024 15:33:22 -0500
Received: by mail-yw1-x114a.google.com with SMTP id
 00721157ae682-5ff7eabfd94so19070307b3.3
 for <qemu-devel@nongnu.org>; Fri, 19 Jan 2024 12:33:20 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=google.com; s=20230601; t=1705696399; x=1706301199; darn=nongnu.org;
 h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
 :date:from:to:cc:subject:date:message-id:reply-to;
 bh=QSfsvmzLWez37hFav3tyw9t5H5IgMB4LtT429E2D6uc=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1705696399; x=1706301199;
 h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
 :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
 bh=QSfsvmzLWez37hFav3tyw9t5H5IgMB4LtT429E2D6uc=;
 b=
X-Gm-Message-State: AOJu0Yw1/bXBI76Sx3qd9gw8OZb7d5yPj3TY9DcWgGhsKdc172KOVdPi
 u0L7HS3WNIGZEtBnASZgwrM5JdGWyJjhT7Bj0/RhrcJHaStoMSthxB41HMPj3il5k/AL3XL/Kz9
 o248S7l0fNsXi5lfBpJf/o+uVPg==
X-Google-Smtp-Source: AGHT+IFbxYMXqo7p3ivI0KXv/MvXvVW9MYvVwnmX6CCXdqDoz/pPAaDNDSzqKh7h93HuDAC48XgK2/dvkm0V1zLYdvc=
X-Received: from nabihestefan.c.googlers.com
 ([fda3:e722:ac3:cc00:20:ed76:c0a8:2737])
 (user=nabihestefan job=sendgmr) by 2002:a05:6902:2412:b0:dc2:4cf5:9ed0 with
 SMTP id dr18-20020a056902241200b00dc24cf59ed0mr210283ybb.5.1705696399710;
 Fri, 19 Jan 2024 12:33:19 -0800 (PST)
Date: Fri, 19 Jan 2024 20:33:01 +0000
...
Message-ID: <20240119203303.2230984-8-nabihestefan@google.com>
Subject: [PATCH v13 7/9] hw/net: GMAC Rx Implementation
...
Received-SPF: pass client-ip=2607:f8b0:4864:20::114a;
 envelope-from=3j9yqZQwKCigREFMLIWXIJERKSSKPI.GSQUIQY-HIZIPRSRKRY.SVK@flex--nabihestefan.bounces.google.com;
...
index f434530930..b2b9314f5e 100644
...
@@ -189,12 +204,258 @@ static void gmac_update_irq(NPCMGMACState *gmac)
...
+
 ...
 {
     /* Nothing to do yet. */
@@ -303,6 +564,7 @@ static void npcm_gmac_write(void *opaque, hwaddr offset,
         break;
...
@@ -344,6 +606,8 @@ static void npcm_gmac_write(void *opaque, hwaddr offset,
...
@@ -354,6 +618,14 @@ static void npcm_gmac_write(void *opaque, hwaddr offset,
