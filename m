...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 694867B3627
	for <lists+qemu-devel@lfdr.de>; Fri, 29 Sep 2023 16:56:51 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qmErW-0005zg-7r; Fri, 29 Sep 2023 10:53:02 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <kwolf@redhat.com>) id 1qmErT-0005yf-Tk
 for qemu-devel@nongnu.org; Fri, 29 Sep 2023 10:52:59 -0400
Received: from us-smtp-delivery-124.mimecast.com ([170.10.129.124])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <kwolf@redhat.com>) id 1qmEqz-0004lO-L0
 for qemu-devel@nongnu.org; Fri, 29 Sep 2023 10:52:59 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1695999148;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=qNVJzOt8PMqJ91OLGjXPPYTy0sIxvfN+4yp3NJ+DO6k=;
 b=VXdh9VXT9CWyz8DbLID5UuUBmkPsRqsYAaOjy01Y7qmx//OLMGFvpSoXG7NHkobw6kDn2/
 Ur4der5etQqL4BDh6PZqMYBra+S1YhNCSmMerNMv8mAt+WhK5tw7J2gsqL5ZQvKexiOU3J
 AdraHspLiPj5QokCZ9+qBCep6V0CLo0=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-441-4IwE3o2kM1CjbRDDWt5cmQ-1; Fri, 29 Sep 2023 10:52:24 -0400
X-MC-Unique: 4IwE3o2kM1CjbRDDWt5cmQ-1
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.rdu2.redhat.com
 [10.11.54.4])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id C473A8032F6;
 Fri, 29 Sep 2023 14:52:23 +0000 (UTC)
Received: from merkur.fritz.box (unknown [10.39.193.159])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 7A2282026D4B;
...
Subject: [PATCH 14/22] qcow2: Mark qcow2_signal_corruption() and callers
 GRAPH_RDLOCK
Date: Fri, 29 Sep 2023 16:51:49 +0200
...
index 9f6cd5bb8e..39c28a8dde 100644
--- a/block.c
+++ b/block.c
@@ -7249,7 +7249,8 @@ bool bdrv_op_is_blocked(BlockDriverState *bs, BlockOpType op, Error **errp)
 {
...
index c9193ae4b9..0fd1b4a437 100644
...
index 4e20a28cc7..80f3ecea62 100644
...
index db5fe86c5a..1c01de95af 100644
--- a/block/qcow2.c
+++ b/block/qcow2.c
...
@@ -4078,8 +4084,8 @@ qcow2_co_pwrite_zeroes(BlockDriverState *bs, int64_t offset, int64_t bytes,
     return ret;
 }
...
@@ -5019,7 +5025,7 @@ static int qcow2_make_empty(BlockDriverState *bs)
     return ret;
 }
...
+static coroutine_fn GRAPH_RDLOCK int qcow2_co_flush_to_os(BlockDriverState *bs)
 {
     BDRVQcow2State *s = bs->opaque;
     int ret;
@@ -5368,7 +5374,7 @@ qcow2_co_load_vmstate(BlockDriverState *bs, QEMUIOVector *qiov, int64_t pos)
...
@@ -5404,9 +5410,10 @@ static int qcow2_has_compressed_clusters(BlockDriverState *bs)
...
@@ -5514,9 +5521,10 @@ static int qcow2_downgrade(BlockDriverState *bs, int target_version,
...
@@ -5642,11 +5650,10 @@ static void qcow2_amend_helper_cb(BlockDriverState *bs,
...
@@ -5946,8 +5953,6 @@ void qcow2_signal_corruption(BlockDriverState *bs, bool fatal, int64_t offset,
     char *message;
     va_list ap;
...
index 7e0b615805..7d2cec7786 100644
