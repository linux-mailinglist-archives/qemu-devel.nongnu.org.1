...
In-Reply-To: <0a7dfd69-26df-407e-a8cb-543dcefab685@linaro.org>
...
> /usr/bin/ld: tests/unit/test-cutils.p/test-cutils.c.o: in function `test_qemu_hexdump_alignment':
