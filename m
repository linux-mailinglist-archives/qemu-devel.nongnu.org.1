...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id CDE5A810906
	for <lists+qemu-devel@lfdr.de>; Wed, 13 Dec 2023 05:18:31 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rDGgd-0008M4-DH; Tue, 12 Dec 2023 23:17:31 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <maobibo@loongson.cn>)
 id 1rDGgY-0008LU-4Z
 for qemu-devel@nongnu.org; Tue, 12 Dec 2023 23:17:26 -0500
Received: from mail.loongson.cn ([114.242.206.163])
 by eggs.gnu.org with esmtp (Exim 4.90_1)
 (envelope-from <maobibo@loongson.cn>) id 1rDGgR-0002ya-D0
 for qemu-devel@nongnu.org; Tue, 12 Dec 2023 23:17:25 -0500
Received: from loongson.cn (unknown [10.2.5.213])
 by gateway (Coremail) with SMTP id _____8CxO+lCMHllz48AAA--.3468S3;
 Wed, 13 Dec 2023 12:17:06 +0800 (CST)
Received: from localhost.localdomain (unknown [10.2.5.213])
 by localhost.localdomain (Coremail) with SMTP id
 AQAAf8CxXeFBMHllUMoBAA--.12364S4; 
 Wed, 13 Dec 2023 12:17:05 +0800 (CST)
From: Bibo Mao <maobibo@loongson.cn>
To: Song Gao <gaosong@loongson.cn>
Cc: qemu-devel@nongnu.org
Subject: [PATCH v1 2/2] hw/loongarch/virt: Set iocsr address space per-board
 rather percpu
Date: Wed, 13 Dec 2023 12:17:05 +0800
Message-Id: <20231213041705.3331053-3-maobibo@loongson.cn>
X-Mailer: git-send-email 2.39.3
In-Reply-To: <20231213041705.3331053-1-maobibo@loongson.cn>
References: <20231213041705.3331053-1-maobibo@loongson.cn>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-CM-TRANSID: AQAAf8CxXeFBMHllUMoBAA--.12364S4
X-CM-SenderInfo: xpdruxter6z05rqj20fqof0/
X-Coremail-Antispam: 1Uk129KBj9fXoW3ury5Gw1rtw18Kr4DKr1xWFX_yoW8Ar1UAo
 W5AFyFva1rGr4Ivr1qyrZ0vrW7tFZFkrZxAayfZan8Wa18tFW5XayUK3Z0q343J3ZYgr1D
 J34UKFn5Jry7Jrykl-sFpf9Il3svdjkaLaAFLSUrUUUU1b8apTn2vfkv8UJUUUU8wcxFpf
...
@@ -300,27 +311,42 @@ static const VMStateDescription vmstate_ipi_core = {
...
index 4b7dc67a2d..4e3fc6706d 100644
--- a/hw/loongarch/virt.c
+++ b/hw/loongarch/virt.c
@@ -559,36 +559,36 @@ static void loongarch_irq_init(LoongArchMachineState *lams)
...
@@ -733,6 +733,43 @@ static void loongarch_direct_kernel_boot(LoongArchMachineState *lams,
     }
 }
...
+
 ...
 {
     LoongArchCPU *lacpu;
@@ -761,8 +798,17 @@ static void loongarch_init(MachineState *machine)
         exit(1);
     }
     create_fdt(lams);
-    /* Init CPUs */
