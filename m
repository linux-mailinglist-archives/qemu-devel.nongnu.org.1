...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 303E3A4291F
	for <lists+qemu-devel@lfdr.de>; Mon, 24 Feb 2025 18:16:07 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1tmc3M-0007HR-8t; Mon, 24 Feb 2025 12:15:36 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <richard.henderson@linaro.org>)
 id 1tmc3D-00076x-73
 for qemu-devel@nongnu.org; Mon, 24 Feb 2025 12:15:27 -0500
...
Received: by mail-pl1-x631.google.com with SMTP id
 d9443c01a7336-22185cddbffso95456155ad.1
 for <qemu-devel@nongnu.org>; Mon, 24 Feb 2025 09:15:20 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linaro.org; s=google; t=1740417320; x=1741022120; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=i47sEWfVS7RX/4FObxnydtURICxHoBMM4MmPG9C/4LM=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=i47sEWfVS7RX/4FObxnydtURICxHoBMM4MmPG9C/4LM=;
 b=
X-Gm-Message-State: AOJu0YydLbjTLuf0yE2SvHkVQ1kdD4tOJ9Pz2Zvw9K9FN5S8Oa/My4IT
 rYgUpiydNJPWmzQn0cgcp8NbIaQFi4RN0ELKDx634KIhuoHRoPJRIKMb+ujOGs2eYbv0I+DZm0c
 2
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IHKNa5DPbtxpvmEUCXP8mJRxAv0YS+TV3APA3NfkRF1ouTcpn2dG1pfHgcBCdw0p7TdGvXBvg==
X-Received: by 2002:a05:6a00:8219:b0:72a:83ec:b1cb with SMTP id
 d2e1a72fcca58-73413f844bamr26350858b3a.0.1740417316958; 
 Mon, 24 Feb 2025 09:15:16 -0800 (PST)
Received: from stoup.. ([2607:fb90:c9e2:d7e3:c85c:d4f0:c8b8:8fa7])
 by smtp.gmail.com with ESMTPSA id
 d2e1a72fcca58-732425466besm20580780b3a.9.2025.02.24.09.15.13
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 24 Feb 2025 09:15:15 -0800 (PST)
From: Richard Henderson <richard.henderson@linaro.org>
To: qemu-devel@nongnu.org
Cc: laurent@vivier.eu
Subject: [PATCH v4 21/24] target/m68k: Implement packed decimal real loads and
 stores
Date: Mon, 24 Feb 2025 09:14:41 -0800
Message-ID: <20250224171444.440135-22-richard.henderson@linaro.org>
...
index 2bbe0dc032..b3d9d78f80 100644
...
index 2fa0752277..014ee5372a 100644
--- a/target/m68k/fpu_helper.c
+++ b/target/m68k/fpu_helper.c
@@ -193,6 +193,13 @@ static void update_fpsr(CPUM68KState *env, int cc)
...
@@ -709,3 +716,233 @@ void HELPER(fcosh)(CPUM68KState *env, FPReg *res, FPReg *val)
 {
...
index 62e0b05e34..29e64d3908 100644
