...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A163AD8FAD
	for <lists+qemu-devel@lfdr.de>; Fri, 13 Jun 2025 16:36:45 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1uQ5VQ-0002s4-JN; Fri, 13 Jun 2025 10:35:45 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <roy.hopkins@randomman.co.uk>)
 id 1uQ5VB-0002oW-Fv
 for qemu-devel@nongnu.org; Fri, 13 Jun 2025 10:35:30 -0400
Received: from smtp-out-60.livemail.co.uk ([213.171.216.60]
 helo=dkim.livemail.co.uk)
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <roy.hopkins@randomman.co.uk>)
 id 1uQ5V8-0005Yb-E6
 for qemu-devel@nongnu.org; Fri, 13 Jun 2025 10:35:29 -0400
Received: from smtp.livemail.co.uk (unknown [10.44.132.83])
 by dkim.livemail.co.uk (Postfix) with ESMTPS id 0838A1800EC;
 Fri, 13 Jun 2025 15:35:25 +0100 (BST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=randomman.co.uk;
 s=livemail2; t=1749825325;
 bh=hrRgmT5aoq0eHDrLQspv6VRWreqZgMogSVeUFGJqizI=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=Zwc5fkmsOAFXrL9U13VeKboUwk0+rUIJq6nv6s0zD/uZEsoqBw6zwuoWUBCqh+jt3
 LOS1whMHDCEg0T50gQFfQO2VeGWMzlFnlLkepHsRwME5mwhMytQ4e6zmthoEmd8MG2
 MJmfGvE71q2nQ63/DRRFUQ4ThsozTyhcoFq+coIw=
Received: from localhost.localdomain (unknown [145.40.191.116])
 (Authenticated sender: roy.hopkins@randomman.co.uk)
 by smtp.livemail.co.uk (Postfix) with ESMTPSA id 6DF5940304;
 Fri, 13 Jun 2025 15:35:20 +0100 (BST)
...
Subject: [PATCH v8 08/16] i386/sev: Refactor setting of reset vector and
 initial CPU state
Date: Fri, 13 Jun 2025 15:11:48 +0100
Message-ID: <6a923e1cb5cdcc9d8bd3115c60b90f87b49aafa4.1749820158.git.roy.hopkins@randomman.co.uk>
...
+
     ...
     ret = sev_ioctl(SEV_COMMON(sev_guest)->sev_fd, KVM_SEV_LAUNCH_UPDATE_VMSA,
                     NULL, &fw_error);
@@ -1780,40 +1968,110 @@ sev_es_find_reset_vector(void *flash_ptr, uint64_t flash_size,
...
-    SevCommonState *sev_common = SEV_COMMON(MACHINE(qdev_get_machine())->cgs);
     ...
     if (!sev_es_enabled()) {
         return 0;
@@ -1826,14 +2084,12 @@ int sev_es_save_reset_vector(void *flash_ptr, uint64_t flash_size)
         return ret;
     }
...
+        sev_es_set_ap_context(addr);
     ...
     return 0;
@@ -2068,6 +2324,7 @@ sev_common_instance_init(Object *obj)
