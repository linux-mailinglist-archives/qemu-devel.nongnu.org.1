...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id E14527B3B15
	for <lists+qemu-devel@lfdr.de>; Fri, 29 Sep 2023 22:15:26 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qmJsC-0007cK-35; Fri, 29 Sep 2023 16:14:04 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <gurchetansingh@chromium.org>)
 id 1qmJs9-0007bv-K7
 for qemu-devel@nongnu.org; Fri, 29 Sep 2023 16:14:01 -0400
...
Received: by mail-pg1-x533.google.com with SMTP id
 41be03b00d2f7-5859b06509cso1067131a12.2
 for <qemu-devel@nongnu.org>; Fri, 29 Sep 2023 13:13:54 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=chromium.org; s=google; t=1696018433; x=1696623233; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=mVmJd2wKpGqumt5HoBL44gvI+3rXVqW9cYrJR7zddHY=;
 b=BYdqk523UCuwjs5HppiYpEF8XdcvyUhv0L5SSLeQCNd6IV//2KIhbbizkcgmLOL+0S
 DHLI0bSWMwvfdIJMxXeajzgTRExwZOlyGQY9vv7SH37IXB9dUe1umG1S6qLFtuwltbbq
 j51umN/JZftdC5XD2IG66HwwlZw6/YXWpWGPc=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1696018433; x=1696623233;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=mVmJd2wKpGqumt5HoBL44gvI+3rXVqW9cYrJR7zddHY=;
 b=
X-Gm-Message-State: AOJu0YwrXhsEf4PSN5XMZQQauaohtBe+MHjXHurQNia/bMfWIVJ+o9xc
 ABismoM+ZuJifScpDEhpj2JRI56thykdfxnef04=
X-Google-Smtp-Source: AGHT+IGyc12/8D9AScs0c36E23+Pgy/qjQvhzKr+tgTZirJmDzVtMtWlnHvKnanK+ekkH/mPneAg0g==
X-Received: by 2002:a05:6a20:3d90:b0:15f:faab:1bd3 with SMTP id
 s16-20020a056a203d9000b0015ffaab1bd3mr6033962pzi.19.1696018432583; 
 Fri, 29 Sep 2023 13:13:52 -0700 (PDT)
Received: from gurchetansingh0.mtv.corp.google.com
 ([2620:15c:a7:2:18fe:3fb1:d86b:1e68])
 by smtp.gmail.com with ESMTPSA id
 t12-20020aa7938c000000b00686236718d8sm15267033pfe.41.2023.09.29.13.13.51
...
Subject: [PATCH v14 6/9] gfxstream + rutabaga: add initial support for
 gfxstream
Date: Fri, 29 Sep 2023 13:13:38 -0700
Message-Id: <20230929201341.332-7-gurchetansingh@chromium.org>
...
+    }
+
+    if ((vr->capset_mask & (1 << RUTABAGA_CAPSET_GFXSTREAM_GLES)) ||
+        (vr->capset_mask & (1 << RUTABAGA_CAPSET_GFXSTREAM_COMPOSER))) {
+        warn_report("Using an experimental virtio-gpu capability set.");
+    }
+
...
+    DEFINE_PROP_BIT64("gfxstream-gles", VirtIOGPURutabaga, capset_mask,
+                      RUTABAGA_CAPSET_GFXSTREAM_GLES, false),
+    DEFINE_PROP_BIT64("gfxstream-composer", VirtIOGPURutabaga, capset_mask,
