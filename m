...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 006EC8D3C49
	for <lists+qemu-devel@lfdr.de>; Wed, 29 May 2024 18:26:38 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1sCM7U-0001rO-TZ; Wed, 29 May 2024 12:25:44 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <movement@movementarian.org>)
 id 1sCM6u-00018I-HL
 for qemu-devel@nongnu.org; Wed, 29 May 2024 12:25:08 -0400
...
Received: from movement by movementarian.org with local (Exim 4.95)
 (envelope-from <movement@movementarian.org>) id 1sCM6j-006COw-3f;
...
Subject: [PATCH 09/26] vfio-user: introduce vfio-user protocol specification
Date: Wed, 29 May 2024 17:23:02 +0100
Message-Id: <20240529162319.1476680-10-levon@movementarian.org>
...
index 448dc951c5..8744b2d76e 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -4058,11 +4058,13 @@ F: include/semihosting/
...
index 5636e9cf1d..44edd9b149 100644
