...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 2DB0391BAF3
	for <lists+qemu-devel@lfdr.de>; Fri, 28 Jun 2024 11:07:44 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1sN7Z6-0004n0-VW; Fri, 28 Jun 2024 05:06:44 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <shiju.jose@huawei.com>)
 id 1sN7Z5-0004mr-Oa
 for qemu-devel@nongnu.org; Fri, 28 Jun 2024 05:06:43 -0400
...
Subject: [RFC PATCH 3/3 qemu] acpi/ghes: Add a logic to handle block addresses
