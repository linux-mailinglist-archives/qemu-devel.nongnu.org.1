...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 22CB78A340B
	for <lists+qemu-devel@lfdr.de>; Fri, 12 Apr 2024 18:51:21 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rvK6M-00061Y-L3; Fri, 12 Apr 2024 12:50:10 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <edgar.iglesias@gmail.com>)
 id 1rvK6I-000613-7l
 for qemu-devel@nongnu.org; Fri, 12 Apr 2024 12:50:06 -0400
Received: from mail-lf1-x12b.google.com ([2a00:1450:4864:20::12b])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <edgar.iglesias@gmail.com>)
 id 1rvK6B-0004AB-Ue
 for qemu-devel@nongnu.org; Fri, 12 Apr 2024 12:50:04 -0400
Received: by mail-lf1-x12b.google.com with SMTP id
 2adb3069b0e04-516dc51bb72so1179381e87.1
 for <qemu-devel@nongnu.org>; Fri, 12 Apr 2024 09:49:59 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1712940598; x=1713545398; darn=nongnu.org;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:from:to:cc:subject:date
 :message-id:reply-to;
 bh=Xl+hB9muAAZsviu/eRHO/6bWAjLzAtiyeeef8LcKP5E=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1712940598; x=1713545398;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=Xl+hB9muAAZsviu/eRHO/6bWAjLzAtiyeeef8LcKP5E=;
 b=
X-Gm-Message-State: AOJu0YxZ9oRX/MvponRXc+Yd/IBX3AkYDia7J/VHCix0AdMLwGRL5xmU
 jekxOkKwSRz6UOGOaNFbU/iFlCJwG59EkFWjqZI7fTi7FHFyBSqgtHk+I0OEeXpXrDlR8Mfbpgr
 lMrK/lVpnAxE1vef6QyUziliFZ7nXyMgi3wpPSA==
X-Google-Smtp-Source: AGHT+IHcbTxMRhhJSEheDDuARb0mIJzwewWEGn44XE22Bxx14s9jp0tMFJJXaalWx6oZauS+4pb+IRpFQexwfMk2e/c=
X-Received: by 2002:a05:6512:3d08:b0:513:af27:df1c with SMTP id
 d8-20020a0565123d0800b00513af27df1cmr2240274lfv.11.1712940597205; Fri, 12 Apr
 2024 09:49:57 -0700 (PDT)
MIME-Version: 1.0
...
Date: Fri, 12 Apr 2024 18:49:45 +0200
Message-ID: <CAJy5ezq73sp7PzA7Ard2L3H9m+rNDdrahjWUJ2gUFpU1Ydj=VA@mail.gmail.com>
...
On Fri, Apr 12, 2024 at 6:09=E2=80=AFPM Peter Maydell <peter.maydell@linaro=
.org> wrote:
>
...
> @@ -218,7 +218,7 @@ static void npcm7xx_adc_enter_reset(Object *obj, Rese=
tType type)
>      npcm7xx_adc_reset(s);
>  }
>
...
> @@ -272,7 +272,7 @@ static int pxa2xx_pic_post_load(void *opaque, int ver=
sion_id)
>      return 0;
>  }
>
...
>  {
>      PXA2xxPICState *s =3D PXA2XX_PIC(obj);
>
> diff --git a/hw/arm/smmu-common.c b/hw/arm/smmu-common.c
> index c4b540656c1..1ce706bf94b 100644
> --- a/hw/arm/smmu-common.c
> +++ b/hw/arm/smmu-common.c
> @@ -682,7 +682,7 @@ static void smmu_base_realize(DeviceState *dev, Error=
 **errp)
>      }
>  }
>
...
>  {
>      SMMUState *s =3D ARM_SMMU(obj);
>
> diff --git a/hw/arm/smmuv3.c b/hw/arm/smmuv3.c
> index 9eb56a70f39..2d1e0d55ec2 100644
> --- a/hw/arm/smmuv3.c
> +++ b/hw/arm/smmuv3.c
> @@ -1727,13 +1727,13 @@ static void smmu_init_irq(SMMUv3State *s, SysBusD=
evice *dev)
>      }
>  }
>
...
> @@ -394,7 +394,7 @@ static void stellaris_sys_reset_enter(Object *obj, Re=
setType type)
>      s->dcgc[0] =3D 1;
>  }
>
...
>  {
>      ssys_state *s =3D STELLARIS_SYS(obj);
>
...
>  }
>
> @@ -618,7 +618,7 @@ static void stellaris_i2c_reset_enter(Object *obj, Re=
setType type)
...
>      stellaris_i2c_state *s =3D STELLARIS_I2C(obj);
>
> @@ -787,7 +787,7 @@ static void stellaris_adc_trigger(void *opaque, int i=
rq, int level)
>      }
>  }
>
...
>  {
>      StellarisADCState *s =3D STELLARIS_ADC(obj);
>      int n;
...
>  {
>      ASCState *s =3D ASC(obj);
>
> diff --git a/hw/char/cadence_uart.c b/hw/char/cadence_uart.c
> index db31d7cc859..77d9a2a221f 100644
> --- a/hw/char/cadence_uart.c
> +++ b/hw/char/cadence_uart.c
> @@ -525,7 +525,7 @@ static void cadence_uart_reset_init(Object *obj, Rese=
tType type)
...
> @@ -214,7 +214,7 @@ static void sifive_uart_reset_enter(Object *obj, Rese=
tType type)
>      s->rx_fifo_len =3D 0;
>  }
>
...
> --- a/hw/core/reset.c
> +++ b/hw/core/reset.c
> @@ -73,7 +73,7 @@ static ResettableState *legacy_reset_get_state(Object *=
obj)
...
>  {
>      LegacyReset *lr =3D LEGACY_RESET(obj);
>
> diff --git a/hw/core/resettable.c b/hw/core/resettable.c
> index c3df75c6ba8..bebf7f10b26 100644
> --- a/hw/core/resettable.c
> +++ b/hw/core/resettable.c
> @@ -181,7 +181,7 @@ static void resettable_phase_hold(Object *obj, void *=
...
> @@ -204,7 +204,7 @@ static void resettable_phase_exit(Object *obj, void *=
opaque, ResetType type)
>      if (--s->count =3D=3D 0) {
...
> @@ -180,14 +180,14 @@ static void virtio_vga_base_realize(VirtIOPCIProxy =
*vpci_dev, Error **errp)
>      }
>  }
>
...
>  {
>      VirtIOVGABaseClass *klass =3D VIRTIO_VGA_BASE_GET_CLASS(obj);
>      VirtIOVGABase *vvga =3D VIRTIO_VGA_BASE(obj);
>
>      /* reset virtio-gpu */
...
> @@ -352,7 +352,7 @@ static void npcm7xx_gpio_enter_reset(Object *obj, Res=
etType type)
>      s->regs[NPCM7XX_GPIO_ODSC] =3D s->reset_odsc;
>  }
>
> -static void npcm7xx_gpio_hold_reset(Object *obj)
> +static void npcm7xx_gpio_hold_reset(Object *obj, ResetType type)
>  {
>      NPCM7xxGPIOState *s =3D NPCM7XX_GPIO(obj);
>
> diff --git a/hw/gpio/pl061.c b/hw/gpio/pl061.c
> index 86f23836553..d5838b8e98d 100644
> --- a/hw/gpio/pl061.c
> +++ b/hw/gpio/pl061.c
> @@ -484,7 +484,7 @@ static void pl061_enter_reset(Object *obj, ResetType =
type)
>      s->amsel =3D 0;
>  }
>
...
>  {
>      PL061State *s =3D PL061(obj);
>      int i, level;
> diff --git a/hw/gpio/stm32l4x5_gpio.c b/hw/gpio/stm32l4x5_gpio.c
> index 63b8763e9d3..71bf5fddb2a 100644
> --- a/hw/gpio/stm32l4x5_gpio.c
> +++ b/hw/gpio/stm32l4x5_gpio.c
> @@ -70,7 +70,7 @@ static bool is_push_pull(Stm32l4x5GpioState *s, unsigne=
d pin)
...
> @@ -170,7 +170,7 @@ static inline bool allwinner_i2c_interrupt_is_enabled=
(AWI2CState *s)
...
>  {
>      AWI2CState *s =3D AW_I2C(obj);
>
> diff --git a/hw/i2c/npcm7xx_smbus.c b/hw/i2c/npcm7xx_smbus.c
> index 0ea3083bb6e..22d68fc67dd 100644
> --- a/hw/i2c/npcm7xx_smbus.c
> +++ b/hw/i2c/npcm7xx_smbus.c
> @@ -1022,7 +1022,7 @@ static void npcm7xx_smbus_enter_reset(Object *obj, =
ResetType type)
>      s->rx_cur =3D 0;
>  }
>
...
>  {
>      NPCM7xxSMBusState *s =3D NPCM7XX_SMBUS(obj);
>
> diff --git a/hw/input/adb.c b/hw/input/adb.c
> index 98f39b4281a..aff7130fd0f 100644
> --- a/hw/input/adb.c
> +++ b/hw/input/adb.c
> @@ -231,7 +231,7 @@ static const VMStateDescription vmstate_adb_bus =3D {
>      }
>  };
>
...
>  {
>      ADBBusState *adb_bus =3D ADB_BUS(obj);
>
...
>      q->cwptr =3D ccount ? (q->rptr + ccount) & (PS2_BUFFER_SIZE - 1) : -=
1;
>  }
>
...
>  {
>      PS2DeviceClass *ps2dc =3D PS2_DEVICE_GET_CLASS(obj);
>      PS2KbdState *s =3D PS2_KBD_DEVICE(obj);
...
>  {
>      PS2DeviceClass *ps2dc =3D PS2_DEVICE_GET_CLASS(obj);
>      PS2MouseState *s =3D PS2_MOUSE_DEVICE(obj);
...
> @@ -263,7 +263,7 @@ static inline void arm_gic_common_reset_irq_state(GIC=
State *s, int cidx,
>      }
>  }
>
...
>  {
>      GICState *s =3D ARM_GIC_COMMON(obj);
>      int i, j;
...
>  {
>      GICState *s =3D ARM_GIC_COMMON(obj);
>      KVMARMGICClass *kgc =3D KVM_ARM_GIC_GET_CLASS(s);
>
...
> @@ -1950,13 +1950,13 @@ static void gicv3_arm_its_realize(DeviceState *de=
v, Error **errp)
>      }
>  }
>
...
>  {
>      GICv3ITSState *s =3D ARM_GICV3_ITS_COMMON(obj);
...
> @@ -123,7 +123,7 @@ void gicv3_its_init_mmio(GICv3ITSState *s, const Memo=
ryRegionOps *ops,
...
>  {
>      GICv3ITSState *s =3D ARM_GICV3_ITS_COMMON(obj);
>      KVMARMITSClass *c =3D KVM_ARM_ITS_GET_CLASS(s);
>      int i;
>
>      if (c->parent_phases.hold) {
> -        c->parent_phases.hold(obj);
...
> @@ -703,7 +703,7 @@ static void arm_gicv3_icc_reset(CPUARMState *env, con=
st ARMCPRegInfo *ri)
...
>  {
>      GICv3State *s =3D ARM_GICV3_COMMON(obj);
>      KVMARMGICv3Class *kgc =3D KVM_ARM_GICV3_GET_CLASS(s);
...
>  {
>      DJMEMCState *s =3D DJMEMC(obj);
>
> diff --git a/hw/misc/iosb.c b/hw/misc/iosb.c
> index e20305e8013..31927eaedb4 100644
> --- a/hw/misc/iosb.c
> +++ b/hw/misc/iosb.c
> @@ -81,7 +81,7 @@ static const MemoryRegionOps iosb_mmio_ops =3D {
...
>  {
>      IOSBState *s =3D IOSB(obj);
>
> diff --git a/hw/misc/mac_via.c b/hw/misc/mac_via.c
> index db6142b5f41..652395b84fc 100644
> --- a/hw/misc/mac_via.c
> +++ b/hw/misc/mac_via.c
> @@ -1203,7 +1203,7 @@ static int via1_post_load(void *opaque, int version=
_id)
>  }
>
>  /* VIA 1 */
...
>  {
>      MOS6522Q800VIA1State *v1s =3D MOS6522_Q800_VIA1(obj);
>      MOS6522State *ms =3D MOS6522(v1s);
> @@ -1211,7 +1211,7 @@ static void mos6522_q800_via1_reset_hold(Object *ob=
j)
>      ADBBusState *adb_bus =3D &v1s->adb_bus;
>
...
>      }
>
>      ms->timers[0].frequency =3D VIA_TIMER_FREQ;
> @@ -1359,13 +1359,13 @@ static void mos6522_q800_via2_portB_write(MOS6522=
State *s)
>      }
>  }
>
...
>  {
>      MOS6522State *ms =3D MOS6522(obj);
>      MOS6522DeviceClass *mdc =3D MOS6522_GET_CLASS(ms);
>
>      if (mdc->parent_phases.hold) {
> -        mdc->parent_phases.hold(obj);
> +        mdc->parent_phases.hold(obj, type);
...
> @@ -586,13 +586,13 @@ static void mos6522_cuda_portB_write(MOS6522State *=
s)
>      cuda_update(cs);
>  }
>
...
>      }
>
>      ms->timers[0].frequency =3D CUDA_TIMER_FREQ;
...
>  {
>      MOS6522State *ms =3D MOS6522(obj);
>      MOS6522PMUState *mps =3D container_of(ms, MOS6522PMUState, parent_ob=
j);
...
> --- a/hw/misc/mos6522.c
> +++ b/hw/misc/mos6522.c
> @@ -642,7 +642,7 @@ const VMStateDescription vmstate_mos6522 =3D {
>      }
>  };
>
...
> @@ -467,7 +467,7 @@ static void npcm7xx_mft_enter_reset(Object *obj, Rese=
tType type)
>      npcm7xx_mft_reset(s);
>  }
>
...
>  {
>      NPCM7xxMFTState *s =3D NPCM7XX_MFT(obj);
>
> diff --git a/hw/misc/npcm7xx_pwm.c b/hw/misc/npcm7xx_pwm.c
> index fca2dd2e5af..f7f77e30a22 100644
> --- a/hw/misc/npcm7xx_pwm.c
> +++ b/hw/misc/npcm7xx_pwm.c
> @@ -468,7 +468,7 @@ static void npcm7xx_pwm_enter_reset(Object *obj, Rese=
tType type)
>      s->piir =3D 0x00000000;
>  }
>
> -static void npcm7xx_pwm_hold_reset(Object *obj)
> +static void npcm7xx_pwm_hold_reset(Object *obj, ResetType type)
>  {
>      NPCM7xxPWMState *s =3D NPCM7XX_PWM(obj);
>      int i;
...
> @@ -113,13 +113,13 @@ static void clock_mux_reset_enter(Object *obj, Rese=
tType type)
...
> @@ -263,13 +263,13 @@ static void pll_reset_enter(Object *obj, ResetType =
type)
...
> @@ -542,7 +542,7 @@ static void cframe_reg_reset_enter(Object *obj, Reset=
Type type)
>      }
>  }
>
...
> @@ -311,7 +311,7 @@ static void crl_reset_enter(Object *obj, ResetType ty=
pe)
>      }
>  }
>
...
>
> diff --git a/hw/misc/xlnx-versal-pmc-iou-slcr.c b/hw/misc/xlnx-versal-pmc=
-iou-slcr.c
> index 60e13a78ab8..e469c04d763 100644
> --- a/hw/misc/xlnx-versal-pmc-iou-slcr.c
> +++ b/hw/misc/xlnx-versal-pmc-iou-slcr.c
> @@ -1350,7 +1350,7 @@ static void xlnx_versal_pmc_iou_slcr_reset_init(Obj=
ect *obj, ResetType type)
>      }
>  }
>
> -static void xlnx_versal_pmc_iou_slcr_reset_hold(Object *obj)
> +static void xlnx_versal_pmc_iou_slcr_reset_hold(Object *obj, ResetType t=
ype)
>  {
>      XlnxVersalPmcIouSlcr *s =3D XILINX_VERSAL_PMC_IOU_SLCR(obj);
>
...
> @@ -137,7 +137,7 @@ static void xram_ctrl_reset_enter(Object *obj, ResetT=
ype type)
...
> @@ -150,7 +150,7 @@ static void zynqmp_apu_reset_enter(Object *obj, Reset=
Type type)
>      s->cpu_in_wfi =3D 0;
>  }
>
...
> @@ -191,7 +191,7 @@ static void crf_reset_enter(Object *obj, ResetType ty=
pe)
>      }
>  }
>
...
> @@ -416,7 +416,7 @@ static void zynq_slcr_reset_init(Object *obj, ResetTy=
pe type)
...
> @@ -1006,7 +1006,7 @@ static void xlnx_zynqmp_can_reset_init(Object *obj,=
 ResetType type)
...
>  {
>      E1000State *d =3D E1000(obj);
>      E1000BaseClass *edc =3D E1000_GET_CLASS(d);
...
>  {
>      IGBState *s =3D IGB(obj);
>
> diff --git a/hw/net/igbvf.c b/hw/net/igbvf.c
> index 94a4e885f20..21a97d4d61d 100644
> --- a/hw/net/igbvf.c
> +++ b/hw/net/igbvf.c
> @@ -282,7 +282,7 @@ static void igbvf_pci_realize(PCIDevice *dev, Error *=
*errp)
...
>  {
>      PCIDevice *vf =3D PCI_DEVICE(obj);
>
> diff --git a/hw/nvram/xlnx-bbram.c b/hw/nvram/xlnx-bbram.c
> index 0a71a005c69..09575a77d77 100644
> --- a/hw/nvram/xlnx-bbram.c
> +++ b/hw/nvram/xlnx-bbram.c
> @@ -417,7 +417,7 @@ static RegisterAccessInfo bbram_ctrl_regs_info[] =3D =
{
>      }
>  };
>
...
> @@ -658,7 +658,7 @@ static void efuse_ctrl_register_reset(RegisterInfo *r=
eg)
>      register_reset(reg);
>  }
>
...
> @@ -770,7 +770,7 @@ static void zynqmp_efuse_register_reset(RegisterInfo =
*reg)
>      register_reset(reg);
>  }
>
...
> @@ -186,13 +186,13 @@ static void cxl_rp_realize(DeviceState *dev, Error =
**errp)
>                       component_bar);
>  }
>
...
>  {
>      PCIERootPortClass *rpc =3D PCIE_ROOT_PORT_GET_CLASS(obj);
>      CXLRootPort *crp =3D CXL_ROOT_PORT(obj);
>
...
> @@ -43,7 +43,7 @@ static void rp_write_config(PCIDevice *d, uint32_t addr=
ess,
...
>  {
>      PCIDevice *d =3D PCI_DEVICE(obj);
>      DeviceState *qdev =3D DEVICE(obj);
> diff --git a/hw/pci-host/bonito.c b/hw/pci-host/bonito.c
> index 1f0c4353484..1516d0074dd 100644
> --- a/hw/pci-host/bonito.c
> +++ b/hw/pci-host/bonito.c
> @@ -590,7 +590,7 @@ static int pci_bonito_map_irq(PCIDevice *pci_dev, int=
 irq_num)
>      }
>  }
>
...
> @@ -208,7 +208,7 @@ static void pnv_phb_class_init(ObjectClass *klass, vo=
id *data)
...
>  {
>      PCIERootPortClass *rpc =3D PCIE_ROOT_PORT_GET_CLASS(obj);
>      PnvPHBRootPort *phb_rp =3D PNV_PHB_ROOT_PORT(obj);
...
>  {
>      Phb3MsiState *msi =3D PHB3_MSI(obj);
>      ICSStateClass *icsc =3D ICS_GET_CLASS(obj);
>
...
> --- a/hw/pci/pci.c
> +++ b/hw/pci/pci.c
> @@ -64,7 +64,7 @@ bool pci_available =3D true;
>
...
> @@ -998,7 +998,7 @@ static void rtc_reset_enter(Object *obj, ResetType ty=
pe)
>      }
>  }
>
...
>  {
>      MC146818RtcState *s =3D MC146818_RTC(obj);
>
> diff --git a/hw/s390x/css-bridge.c b/hw/s390x/css-bridge.c
> index 34639f21435..8657ff7bf48 100644
> --- a/hw/s390x/css-bridge.c
> +++ b/hw/s390x/css-bridge.c
> @@ -56,7 +56,7 @@ static void ccw_device_unplug(HotplugHandler *hotplug_d=
ev,
>      qdev_unrealize(dev);
>  }
>
...
> @@ -76,7 +76,7 @@ static const uint8_t adm1266_ic_device_id[] =3D {0x03, =
0x41, 0x12, 0x66};
>  static const uint8_t adm1266_ic_device_rev[] =3D {0x08, 0x01, 0x08, 0x07=
, 0x0,
>                                                  0x0, 0x07, 0x41, 0x30};
>
...
>  {
>      ADM1266State *s =3D ADM1266(obj);
>      PMBusDevice *pmdev =3D PMBUS_DEVICE(obj);
> diff --git a/hw/sensor/adm1272.c b/hw/sensor/adm1272.c
> index a19557ec9ea..3fc1e5d0ad9 100644
> --- a/hw/sensor/adm1272.c
> +++ b/hw/sensor/adm1272.c
> @@ -185,7 +185,7 @@ static uint32_t adm1272_direct_to_watts(uint16_t valu=
e)
...
>  {
>      ADM1272State *s =3D ADM1272(obj);
>      PMBusDevice *pmdev =3D PMBUS_DEVICE(obj);
> diff --git a/hw/sensor/isl_pmbus_vr.c b/hw/sensor/isl_pmbus_vr.c
> index e51269f6b83..304a66ea8b0 100644
> --- a/hw/sensor/isl_pmbus_vr.c
> +++ b/hw/sensor/isl_pmbus_vr.c
> @@ -63,7 +63,7 @@ static void isl_pmbus_vr_set(Object *obj, Visitor *v, c=
onst char *name,
...
>  }
>
>  /* The raa228000 uses different direct mode coefficients from most isl d=
evices */
...
9, 0x3c};
>      g_assert(sizeof(ic_device_id) <=3D sizeof(s->ic_device_id));
>
> -    isl_pmbus_vr_exit_reset(obj);
> +    isl_pmbus_vr_exit_reset(obj, type);
>
>      s->ic_device_id_len =3D sizeof(ic_device_id);
...
> @@ -444,7 +444,7 @@ static int max31785_write_data(PMBusDevice *pmdev, co=
nst uint8_t *buf,
>      return 0;
>  }
>
...
>  {
>      PMBusDevice *pmdev =3D PMBUS_DEVICE(obj);
>      MAX31785State *s =3D MAX31785(obj);
> diff --git a/hw/sensor/max34451.c b/hw/sensor/max34451.c
> index 031ae53f594..93b53f3db2f 100644
> --- a/hw/sensor/max34451.c
> +++ b/hw/sensor/max34451.c
> @@ -608,7 +608,7 @@ static inline void *memset_word(void *s, uint16_t c, =
size_t n)
>      return s;
>  }
>
...
> @@ -483,7 +483,7 @@ static void npcm7xx_fiu_enter_reset(Object *obj, Rese=
tType type)
...
> @@ -357,7 +357,7 @@ static void etraxfs_timer_reset_enter(Object *obj, Re=
setType type)
>      t->rw_intr_mask =3D 0;
>  }
>
...
>  {
>      ETRAXTimerState *t =3D ETRAX_TIMER(obj);
>
> diff --git a/hw/timer/npcm7xx_timer.c b/hw/timer/npcm7xx_timer.c
> index 779c6049fab..c55ba022353 100644
> --- a/hw/timer/npcm7xx_timer.c
> +++ b/hw/timer/npcm7xx_timer.c
> @@ -592,7 +592,7 @@ static void npcm7xx_watchdog_timer_expired(void *opaq=
ue)
>      }
>  }
>
...
> --- a/hw/usb/hcd-dwc2.c
> +++ b/hw/usb/hcd-dwc2.c
> @@ -1305,7 +1305,7 @@ static void dwc2_reset_enter(Object *obj, ResetType=
 type)
>      }
>  }
>
...
>  {
>      DWC2Class *c =3D DWC2_USB_GET_CLASS(obj);
>      DWC2State *s =3D DWC2_USB(obj);
...
>      }
>
>      s->hprt0 =3D HPRT0_PWR;
> diff --git a/hw/usb/xlnx-versal-usb2-ctrl-regs.c b/hw/usb/xlnx-versal-usb=
2-ctrl-regs.c
> index 6fc453817ea..66c793a6021 100644
> --- a/hw/usb/xlnx-versal-usb2-ctrl-regs.c
> +++ b/hw/usb/xlnx-versal-usb2-ctrl-regs.c
> @@ -153,7 +153,7 @@ static void usb2_ctrl_regs_reset_init(Object *obj, Re=
setType type)
>      }
>  }
>
...
>  {
>      VersalUsb2CtrlRegs *s =3D XILINX_VERSAL_USB2_CTRL_REGS(obj);
>
...
> --- a/target/arm/cpu.c
> +++ b/target/arm/cpu.c
> @@ -212,7 +212,7 @@ static void cp_reg_check_reset(gpointer key, gpointer=
...
>  {
>      CPUState *cs =3D CPU(obj);
>      CRISCPUClass *ccc =3D CRIS_CPU_GET_CLASS(obj);
...
> @@ -273,14 +273,14 @@ static void hexagon_restore_state_to_opc(CPUState *=
cs,
>      cpu_env(cs)->gpr[HEX_REG_PC] =3D data[0];
>  }
>
...
>  {
>      CPUState *cs =3D CPU(obj);
>      HexagonCPUClass *mcc =3D HEXAGON_CPU_GET_CLASS(obj);
...
> --- a/target/i386/cpu.c
> +++ b/target/i386/cpu.c
> @@ -6693,7 +6693,7 @@ static void x86_cpu_set_sgxlepubkeyhash(CPUX86State=
 *env)
>  #endif
>  }
>
...
>  {
>      CPUState *cs =3D CPU(obj);
>      LoongArchCPUClass *lacc =3D LOONGARCH_CPU_GET_CLASS(obj);
...
> --- a/target/m68k/cpu.c
> +++ b/target/m68k/cpu.c
> @@ -71,7 +71,7 @@ static void m68k_unset_feature(CPUM68KState *env, int f=
eature)
>      env->features &=3D ~BIT_ULL(feature);
>  }
>
...
>  {
>      CPUState *cs =3D CPU(obj);
>      M68kCPUClass *mcc =3D M68K_CPU_GET_CLASS(obj);
...
> @@ -181,7 +181,7 @@ static void microblaze_cpu_set_irq(void *opaque, int =
irq, int level)
>  }
>  #endif
>
...
> --- a/target/mips/cpu.c
> +++ b/target/mips/cpu.c
> @@ -185,7 +185,7 @@ static int mips_cpu_mmu_index(CPUState *cs, bool ifun=
c)
>
...
> @@ -54,7 +54,7 @@ static int nios2_cpu_mmu_index(CPUState *cs, bool ifetc=
h)
...
> @@ -85,14 +85,14 @@ static void openrisc_disas_set_info(CPUState *cpu, di=
sassemble_info *info)
...
>      OpenRISCCPUClass *occ =3D OPENRISC_CPU_GET_CLASS(obj);
>
...
> @@ -7136,7 +7136,7 @@ static int ppc_cpu_mmu_index(CPUState *cs, bool ife=
tch)
...
> @@ -918,7 +918,7 @@ static int riscv_cpu_mmu_index(CPUState *cs, bool ife=
tch)
...
> --- a/target/sh4/cpu.c
> +++ b/target/sh4/cpu.c
> @@ -103,14 +103,14 @@ static int sh4_cpu_mmu_index(CPUState *cs, bool ife=
tch)
>      }
>  }
>
...
>  {
>      CPUState *cs =3D CPU(obj);
>      SuperHCPUClass *scc =3D SUPERH_CPU_GET_CLASS(obj);
>      CPUSH4State *env =3D cpu_env(cs);
>
...
>  {
>      CPUState *cs =3D CPU(obj);
>      SPARCCPUClass *scc =3D SPARC_CPU_GET_CLASS(obj);
>      CPUSPARCState *env =3D cpu_env(cs);
>
>      if (scc->parent_phases.hold) {
> -        scc->parent_phases.hold(obj);
> +        scc->parent_phases.hold(obj, type);
...
>  {
>      CPUState *cs =3D CPU(obj);
>      TriCoreCPUClass *tcc =3D TRICORE_CPU_GET_CLASS(obj);
>
...
>  {
>      CPUState *cs =3D CPU(obj);
>      XtensaCPUClass *xcc =3D XTENSA_CPU_GET_CLASS(obj);
