...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 7102A78CBDA
	for <lists+qemu-devel@lfdr.de>; Tue, 29 Aug 2023 20:10:14 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qb35k-00054Y-AH; Tue, 29 Aug 2023 14:05:30 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <eblake@redhat.com>) id 1qb33p-0002ZK-71
 for qemu-devel@nongnu.org; Tue, 29 Aug 2023 14:03:38 -0400
Received: from us-smtp-delivery-124.mimecast.com ([170.10.133.124])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <eblake@redhat.com>) id 1qb33X-0000Of-LH
 for qemu-devel@nongnu.org; Tue, 29 Aug 2023 14:03:26 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1693332191;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=hJu9wAc12NcblqgxM9+1+zjEmf69iDUc/WXsQBJXGpc=;
 b=gONdQxCx4C5edA4jE6vy2GcVgdphaYBpmj4KfGjO+eq0GHqt7Iss2qtbZImKGOT36aCe5L
 76oeLDXhFFIYRfdRx4t1gsCk3W26ZFZq51bNCXcZVfi4RuFKtD1H8XgJ3xXf4n1wiO7nCZ
 rkl9MZK/H/DGT7EHyp2k+THZjQ6mmJA=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-98-IX6RLSCUMZanS3mQ23-3qA-1; Tue, 29 Aug 2023 14:03:01 -0400
X-MC-Unique: IX6RLSCUMZanS3mQ23-3qA-1
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.rdu2.redhat.com
 [10.11.54.4])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 4888685CCE3;
 Tue, 29 Aug 2023 18:03:01 +0000 (UTC)
Received: from green.redhat.com (unknown [10.2.16.55])
 by smtp.corp.redhat.com (Postfix) with ESMTP id ECE032026D68;
 Tue, 29 Aug 2023 18:03:00 +0000 (UTC)
From: Eric Blake <eblake@redhat.com>
To: qemu-devel@nongnu.org
Cc: qemu-block@nongnu.org,
	vsementsov@yandex-team.ru
Subject: [PATCH v6 09/17] nbd/server: Support 64-bit block status
Date: Tue, 29 Aug 2023 12:58:36 -0500
Message-ID: <20230829175826.377251-28-eblake@redhat.com>
...
index efeb2e12bd2..f5e60b5ab88 100644
--- a/nbd/server.c
+++ b/nbd/server.c
@@ -2115,20 +2115,24 @@ static int coroutine_fn nbd_co_send_sparse_read(NBDClient *client,
 }
...
+    ea->extended = mode >= NBD_MODE_EXTENDED;
     ...
     return ea;
@@ -2147,15 +2151,36 @@ static void nbd_extent_array_convert_to_be(NBDExtentArray *ea)
     int i;
...
+
  ...
  * return -1.
@@ -2166,19 +2191,27 @@ static void nbd_extent_array_convert_to_be(NBDExtentArray *ea)
...
+        if (sum <= UINT32_MAX || ea->extended) {
             ...
             return 0;
@@ -2191,7 +2224,7 @@ static int nbd_extent_array_add(NBDExtentArray *ea,
     }
...
+    ea->extents[ea->count] = (NBDExtent64) {.length = length, .flags = flags};
     ...
     return 0;
@@ -2260,20 +2293,39 @@ nbd_co_send_extents(NBDClient *client, NBDRequest *request, NBDExtentArray *ea,
...
@@ -2282,13 +2334,14 @@ nbd_co_send_extents(NBDClient *client, NBDRequest *request, NBDExtentArray *ea,
 static int
...
@@ -2311,11 +2364,12 @@ static void bitmap_to_extents(BdrvDirtyBitmap *bitmap,
...
+         bdrv_dirty_bitmap_next_dirty_area(bitmap, start, end, bound,
     ...
     {
@@ -2339,12 +2393,13 @@ static int coroutine_fn nbd_co_send_bitmap(NBDClient *client,
                                            NBDRequest *request,
...
@@ -2674,7 +2729,8 @@ static coroutine_fn int nbd_handle_request(NBDClient *client,
