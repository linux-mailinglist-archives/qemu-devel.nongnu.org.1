...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 5AD3C748F77
	for <lists+qemu-devel@lfdr.de>; Wed,  5 Jul 2023 22:59:11 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qH9aJ-0002p8-1s; Wed, 05 Jul 2023 16:58:47 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <i.maximets@ovn.org>)
 id 1qH9a9-0002os-8w
 for qemu-devel@nongnu.org; Wed, 05 Jul 2023 16:58:37 -0400
...
X-GND-Sasl: i.maximets@ovn.org
X-GND-Sasl: i.maximets@ovn.org
Received: by mail.gandi.net (Postfix) with ESMTPSA id C41AEE0004;
 Wed,  5 Jul 2023 20:58:28 +0000 (UTC)
From: Ilya Maximets <i.maximets@ovn.org>
To: Jason Wang <jasowang@redhat.com>
Cc: Paolo Bonzini <pbonzini@redhat.com>, Eric Blake <eblake@redhat.com>,
 Stefan Hajnoczi <stefanha@redhat.com>, qemu-devel@nongnu.org,
 Ilya Maximets <i.maximets@ovn.org>
Subject: [PATCH v2] net: add initial support for AF_XDP network backend
Date: Wed,  5 Jul 2023 22:59:14 +0200
Message-Id: <20230705205914.3457560-1-i.maximets@ovn.org>
