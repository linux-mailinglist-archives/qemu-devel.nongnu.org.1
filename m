...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id A8FEF7D2154
	for <lists+qemu-devel@lfdr.de>; Sun, 22 Oct 2023 08:07:58 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1quRbP-0004kl-BL; Sun, 22 Oct 2023 02:06:19 -0400
...
Received: by mail-pf1-x431.google.com with SMTP id
 d2e1a72fcca58-6b89ab5ddb7so2209304b3a.0
 for <qemu-devel@nongnu.org>; Sat, 21 Oct 2023 23:04:59 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linaro.org; s=google; t=1697954698; x=1698559498; darn=nongnu.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=xg9shQSCsSXjzt9vctIOIFcNcvJVErfH1MJpmRAJyfA=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1697954698; x=1698559498;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=xg9shQSCsSXjzt9vctIOIFcNcvJVErfH1MJpmRAJyfA=;
 b=
X-Gm-Message-State: AOJu0Yze0Ko+fWsFbUltkpBGgOYhHqHmwVeJn4RdojldtPk9GPWgGo82
 LhQbSqGJqtP7xXhvZMfpcq55K8dd4PLi7dJE284=
X-Google-Smtp-Source: AGHT+IFQslHsBjhR7HbeRKHtLCOwVaR1fa6SxKqrzd90e1t3hLW3Fbd6f0Lmbo9NgBugdGDgxj+FRg==
X-Received: by 2002:a05:6a00:2345:b0:68f:bb02:fdf with SMTP id
 j5-20020a056a00234500b0068fbb020fdfmr6759455pfj.27.1697954697941; 
 Sat, 21 Oct 2023 23:04:57 -0700 (PDT)
Received: from stoup.. ([71.212.149.95]) by smtp.gmail.com with ESMTPSA id
 fb13-20020a056a002d8d00b0068a46cd4120sm4007373pfb.199.2023.10.21.23.04.57
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Sat, 21 Oct 2023 23:04:57 -0700 (PDT)
From: Richard Henderson <richard.henderson@linaro.org>
To: qemu-devel@nongnu.org
Cc: mark.cave-ayland@ilande.co.uk
Subject: [PATCH v4 67/90] target/sparc: Move gen_ne_fop_DDD insns to decodetree
Date: Sat, 21 Oct 2023 23:00:08 -0700
Message-Id: <20231022060031.490251-68-richard.henderson@linaro.org>
...
index 1944936760..51f96d2253 100644
...
-
 ...
 {
@@ -5028,6 +5023,46 @@ TRANS(FXNORs, VIS1, do_fff, a, tcg_gen_eqv_i32)
...
+
 #define CHECK_IU_FEATURE(dc, FEATURE)                      \
     if (!((dc)->def->features & CPU_FEATURE_ ## FEATURE))  \
         goto illegal_insn;
@@ -5414,6 +5449,29 @@ static void disas_sparc_legacy(DisasContext *dc, unsigned int insn)
...
@@ -5471,34 +5529,6 @@ static void disas_sparc_legacy(DisasContext *dc, unsigned int insn)
...
@@ -5525,34 +5555,10 @@ static void disas_sparc_legacy(DisasContext *dc, unsigned int insn)
                     CHECK_FPU_FEATURE(dc, VIS1);
...
@@ -5565,46 +5571,6 @@ static void disas_sparc_legacy(DisasContext *dc, unsigned int insn)
