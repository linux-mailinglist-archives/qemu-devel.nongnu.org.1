...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 5991DC4FDE5
	for <lists+qemu-devel@lfdr.de>; Tue, 11 Nov 2025 22:34:45 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1vIvzO-0006u3-Rp; Tue, 11 Nov 2025 16:33:22 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <kwolf@redhat.com>) id 1vIvzM-0006sl-Fj
 for qemu-devel@nongnu.org; Tue, 11 Nov 2025 16:33:21 -0500
Received: from us-smtp-delivery-124.mimecast.com ([170.10.129.124])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <kwolf@redhat.com>) id 1vIvzJ-0001qQ-PQ
 for qemu-devel@nongnu.org; Tue, 11 Nov 2025 16:33:20 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1762896797;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=zghK8OsAu9+QGUgj06ZPB7erCE71CI4Vp/mVFBGHgZA=;
 b=h2SXzcaR6HsaCci6swGnreHyNs1t80oy1tXheEE32qUwWEdsjm9lqNd2lAvv7aQvLp1AWY
 NbFZOG5oIpMEL6yZnqexlZ/tKVR6uQGTL+7QmT2jac6UbXKNbIrbaQ0o6nTSAgPoCjqtvu
 Jklvc8TNSPxwWIiZCrQr0uhSTjLyUq4=
Received: from mx-prod-mc-05.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-27-nJaoeHZZPe2mc9fUJw533Q-1; Tue,
 11 Nov 2025 16:33:13 -0500
X-MC-Unique: nJaoeHZZPe2mc9fUJw533Q-1
X-Mimecast-MFC-AGG-ID: nJaoeHZZPe2mc9fUJw533Q_1762896793
Received: from mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com
 ...
 id 008251956089; Tue, 11 Nov 2025 21:33:13 +0000 (UTC)
Received: from merkur.redhat.com (unknown [10.45.225.214])
 by mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP
 id 5846E30044E5; Tue, 11 Nov 2025 21:33:11 +0000 (UTC)
From: Kevin Wolf <kwolf@redhat.com>
To: qemu-block@nongnu.org
Cc: kwolf@redhat.com,
	richard.henderson@linaro.org,
	qemu-devel@nongnu.org
Subject: [PULL v2 06/28] aio-posix: integrate fdmon into glib event loop
Date: Tue, 11 Nov 2025 22:32:16 +0100
Message-ID: <20251111213238.181992-7-kwolf@redhat.com>
...
---
 ...
 meson.build           |  2 +
 9 files changed, 224 insertions(+), 63 deletions(-)

diff --git a/include/block/aio.h b/include/block/aio.h
index 99ff48420b..aef43f9c51 100644
...
index a736d2cd0d..83f1e73e34 100644
--- a/util/async.c
+++ b/util/async.c
...
index 3d8638b0e5..2460ac1556 100644
...
+
     io_uring_for_each_cqe(ring, head, cqe) {
         if (process_cqe(ctx, ready_list, cqe)) {
             num_ready++;
@@ -274,6 +281,30 @@ static int process_cq_ring(AioContext *ctx, AioHandlerList *ready_list)
     return num_ready;
 }
...
+
 static int fdmon_io_uring_wait(AioContext *ctx, AioHandlerList *ready_list,
                                int64_t timeout)
 {
@@ -339,12 +370,17 @@ static const FDMonOps fdmon_io_uring_ops = {
...
index 48c1795b0f..df4460035c 100644
--- a/meson.build
+++ b/meson.build
@@ -2745,6 +2745,8 @@ endif
