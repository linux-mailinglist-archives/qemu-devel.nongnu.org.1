...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id AA11275E9C7
	for <lists+qemu-devel@lfdr.de>; Mon, 24 Jul 2023 04:33:54 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qNlNv-0006if-H5; Sun, 23 Jul 2023 22:33:19 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <alistair23@gmail.com>)
 id 1qNlNt-0006hl-51; Sun, 23 Jul 2023 22:33:17 -0400
Received: from mail-yb1-xb2c.google.com ([2607:f8b0:4864:20::b2c])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <alistair23@gmail.com>)
 id 1qNlNo-0003rc-L4; Sun, 23 Jul 2023 22:33:16 -0400
Received: by mail-yb1-xb2c.google.com with SMTP id
 3f1490d57ef6-cfd4ea89978so4257913276.2; 
 Sun, 23 Jul 2023 19:33:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20221208; t=1690165991; x=1690770791;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:from:to:cc:subject:date
 :message-id:reply-to;
 bh=6UW65+pCpwgEdxLbFNWoZcPictsWQRdoAO/m6ij31BU=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20221208; t=1690165991; x=1690770791;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=6UW65+pCpwgEdxLbFNWoZcPictsWQRdoAO/m6ij31BU=;
 b=
X-Gm-Message-State: ABy/qLav+AmiQBD+7dxsoGh32SvlkEJDTUT4z7SqXYUvGNyWDSwIrSVB
 VrDkDVbVRcTJPa1WyzPRHMm6MbBi5zafW1XzbcE=
X-Google-Smtp-Source: APBJJlEG8ShAMpHEhWmhywchEt0pJiv2v43NTjmcpzDwEqYm+FPIAI5o5K/xPOukDTTMI16SmIxx1AcCDvqSku159KQ=
X-Received: by 2002:a25:2983:0:b0:d07:f1ed:51f7 with SMTP id
 p125-20020a252983000000b00d07f1ed51f7mr5419030ybp.43.1690165990445; Sun, 23
 Jul 2023 19:33:10 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <16cf403dcaa44903c6148c5027b18bd9b6bff6a2.1689819031.git.tjeznach@rivosinc.com>
From: Alistair Francis <alistair23@gmail.com>
Date: Mon, 24 Jul 2023 12:32:43 +1000
Message-ID: <CAKmqyKN77KSqaozQMxVCN7suLikL5Qa-CLzV9y3idsK1bmjHYw@mail.gmail.com>
...
Received-SPF: pass client-ip=2607:f8b0:4864:20::b2c;
 envelope-from=alistair23@gmail.com; helo=mail-yb1-xb2c.google.com
X-Spam_score_int: -18
X-Spam_score: -1.9
X-Spam_bar: -
...
On Thu, Jul 20, 2023 at 12:34=E2=80=AFPM Tomasz Jeznach <tjeznach@rivosinc.=
com> wrote:
>
...
> The patch add device emulation for RISC-V IOMMU which supports device and=
 process
> context lookups, command and fault queue interfaces, two stage address tr=
anslation
> logic with Sv32, Sv39, Sv48, Sv57 addressing modes, address translation c=
ache,
...
>
> Hardware interface definition file is shared with Linux kernel driver imp=
lementation,
> available in the maintainer's branch riscv_iommu_v1 at https://github.com=
/tjeznach/linux.
>
...
> + * register on the RISC-V MMU), and PDTP holds the process directory tab=
le,
> + * used to select a first stage page table based on a process id (for de=
vices
...
> +/* dword1 is the address, 4K-alligned and shifted to the right by two bi=
ts. */
> +
...
> +/* dword1 is the address, word-size alligned and shifted to the right by=
 two bits. */
> +
...
> +
> +    /* Support MSI only */
> +    cap =3D set_field(cap, RISCV_IOMMU_CAP_IGS, RISCV_IOMMU_CAP_IGS_MSI)=
;
...
> +
> +/* interrupt delivery callback */
> +static void riscv_iommu_sys_notify(RISCVIOMMUState *iommu, unsigned vect=
or)
> +{
...
> +
> +    /* Support WSI only */
> +    cap =3D set_field(cap, RISCV_IOMMU_CAP_IGS, RISCV_IOMMU_CAP_IGS_WSI)=
;
...
> +}
> +
> +static void riscv_iommu_fault(RISCVIOMMUState *s, struct riscv_iommu_fq_=
record *ev)
> +{
...
> +
> +    if (head =3D=3D next) {
> +        riscv_iommu_reg_mod32(s, RISCV_IOMMU_REG_FQCSR, RISCV_IOMMU_FQCS=
R_FQOF, 0);
> +    } else {
...
> +            riscv_iommu_reg_mod32(s, RISCV_IOMMU_REG_FQCSR, RISCV_IOMMU_=
FQCSR_FQMF, 0);
> +        } else {
...
> +
> +    if (head =3D=3D next) {
> +        riscv_iommu_reg_mod32(s, RISCV_IOMMU_REG_PQCSR, RISCV_IOMMU_PQCS=
R_PQOF, 0);
> +    } else {
> +        dma_addr_t addr =3D s->pq_addr + tail * sizeof(*pr);
> +        if (dma_memory_write(s->target_as, addr, pr, sizeof(*pr),
> +                             MEMTXATTRS_UNSPECIFIED) !=3D MEMTX_OK) {
> +            riscv_iommu_reg_mod32(s, RISCV_IOMMU_REG_PQCSR, RISCV_IOMMU_=
PQCSR_PQMF, 0);
> +        } else {
...
> +            riscv_iommu_reg_mod32(s, RISCV_IOMMU_REG_IOCOUNTOVF, BIT(ctr=
_idx + 1), 0);
...
> +}
> +
> +static void riscv_iommu_hpm_incr_ctr(RISCVIOMMUState *s, RISCVIOMMUConte=
xt *ctx,
> +    unsigned event_id)
> +{
> +    const uint32_t inhibit =3D riscv_iommu_reg_get32(s, RISCV_IOMMU_REG_=
IOCOUNTINH);
> +    uint32_t did_gscid;
> +    uint32_t pid_pscid;
> +    uint32_t ctr_idx;
...
tion has
> +             * a valid process_id, counter increments if device_id match=
es
...
> +                if (!(s->cap &
> +                    (pass ? RISCV_IOMMU_CAP_G_SV32 : RISCV_IOMMU_CAP_S_S=
V32))) {
...
> +                if (!(s->cap &
> +                    (pass ? RISCV_IOMMU_CAP_G_SV39 : RISCV_IOMMU_CAP_S_S=
V39))) {
> +                    return RISCV_IOMMU_FQ_CAUSE_DDT_MISCONFIGURED;
> +                }
> +                sc[pass].levels    =3D 3;
...
> +                if (!(s->cap &
> +                    (pass ? RISCV_IOMMU_CAP_G_SV48 : RISCV_IOMMU_CAP_S_S=
V48))) {
> +                    return RISCV_IOMMU_FQ_CAUSE_DDT_MISCONFIGURED;
> +                }
> +                sc[pass].levels    =3D 4;
...
> +                if (!(s->cap &
> +                    (pass ? RISCV_IOMMU_CAP_G_SV57 : RISCV_IOMMU_CAP_S_S=
V57))) {
> +                    return RISCV_IOMMU_FQ_CAUSE_DDT_MISCONFIGURED;
> +                }
> +                sc[pass].levels    =3D 5;
...
> +            return RISCV_IOMMU_FQ_CAUSE_DDT_INVALID; /* invalid director=
y entry */
> +        }
> +        if (de & ~(RISCV_IOMMU_DDTE_PPN | RISCV_IOMMU_DDTE_VALID)) {
> +            return RISCV_IOMMU_FQ_CAUSE_DDT_INVALID; /* reserved bits se=
t. */
> +        }
...
d);
> +        pr.payload =3D (iotlb->iova & TARGET_PAGE_MASK) | RISCV_IOMMU_PR=
EQ_PAYLOAD_M;
...
> +    struct riscv_iommu_command *cmd)
> +{
> +    unsigned resp_code =3D get_field(cmd->dword1, RISCV_IOMMU_CMD_ATS_PR=
GR_RESP_CODE);
...
> +
> +        if (res !=3D MEMTX_OK) {
> +            riscv_iommu_reg_mod32(s, RISCV_IOMMU_REG_CQCSR, RISCV_IOMMU_=
CQCSR_CQMF, 0);
> +            goto fault;
> +        }
> +
...
> +
> +        switch (get_field(cmd.dword0, RISCV_IOMMU_CMD_OPCODE | RISCV_IOM=
MU_CMD_FUNC)) {
> +        case RISCV_IOMMU_CMD(RISCV_IOMMU_CMD_IOFENCE_FUNC_C,
> +                             RISCV_IOMMU_CMD_IOFENCE_OPCODE):
> +            res =3D riscv_iommu_iofence(s, cmd.dword0 & RISCV_IOMMU_CMD_=
IOFENCE_AV,
> +                cmd.dword1, get_field(cmd.dword0, RISCV_IOMMU_CMD_IOFENC=
E_DATA));
> +
> +            if (res !=3D MEMTX_OK) {
...
> +            RISCV_IOMMU_TR_RESPONSE_FAULT | (RISCV_IOMMU_FQ_CAUSE_DMA_DI=
SABLED << 10));
> +    } else {
...
te the
> +         * clock snapshot value to point to the current time to make sur=
e
...
> +         */
> +        s->hpmcycle_val =3D s->hpmcycle_val + (__get_cycles() - s->hpmcy=
cle_prev);
...
> +    gpointer data;
> +
> +    /* If EventID field is RISCV_IOMMU_HPMEVENT_INVALID remove the curre=
nt mapping. */
> +    if (event_id =3D=3D RISCV_IOMMU_HPMEVENT_INVALID) {
> +        data =3D g_hash_table_find(s->hpm_event_ctr_map, __hpm_event_equ=
al, pair);
> +
...
er. */
> +    if (get_field(ovf, BIT(ctr_idx + 1)) && !get_field(val, RISCV_IOMMU_=
IOHPMEVT_OF)) {
> +        /* +1 to offset CYCLE register OF bit. */
> +        riscv_iommu_reg_mod32(s, RISCV_IOMMU_REG_IOCOUNTOVF, 0, BIT(ctr_=
idx + 1));
> +    }
> +
> +    if (!__check_valid_event_id(get_field(val, RISCV_IOMMU_IOHPMEVT_EVEN=
T_ID))) {
...
> +{
> +    const uint64_t cycle =3D riscv_iommu_reg_get64(s, RISCV_IOMMU_REG_IO=
HPMCYCLES);
> +    const uint32_t inhibit =3D riscv_iommu_reg_get32(s, RISCV_IOMMU_REG_=
IOCOUNTINH);
...
> +        /*
> +         * Software can read RISCV_IOMMU_REG_IOCOUNTOVF before timer cal=
lback completes.
> +         * In which case CY_OF bit in RISCV_IOMMU_IOHPMCYCLES_OVF would =
be 0. Here we
> +         * take the CY_OF bit state from RISCV_IOMMU_REG_IOHPMCYCLES reg=
ister as it's
> +         * not dependent over the timer callback and is computed from cy=
cle
> +         * overflow.
> +         */
...
> +        break;
> +    default:
> +        error_setg(errp, "can't support requested IGS mode: cap: %" PRIx=
64,
> +            s->cap);
> +        return;
> +    }
...
> +    s->cap =3D set_field(s->cap, RISCV_IOMMU_CAP_PAS, TARGET_PHYS_ADDR_S=
PACE_BITS);
> +
...
> +        stl_le_p(&s->regs_ro[RISCV_IOMMU_REG_IOCOUNTINH], ~((2 << s->hpm=
_cntrs) - 1));
> +        stq_le_p(&s->regs_ro[RISCV_IOMMU_REG_IOHPMCYCLES], 0);
> +        memset(&s->regs_ro[RISCV_IOMMU_REG_IOHPMCTR_BASE], 0x00, s->hpm_=
cntrs * 8);
> +        memset(&s->regs_ro[RISCV_IOMMU_REG_IOHPMEVT_BASE], 0x00, s->hpm_=
cntrs * 8);
> +    }
...
> +    pthread_rwlock_t ht_lock;      /* Lock used for hpm_event_ctr_map up=
dates */
> +
