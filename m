...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 762A27E4104
	for <lists+qemu-devel@lfdr.de>; Tue,  7 Nov 2023 14:49:50 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1r0MSB-00086j-Ni; Tue, 07 Nov 2023 08:49:15 -0500
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <kwolf@redhat.com>) id 1r0MS6-0007yh-5h
 for qemu-devel@nongnu.org; Tue, 07 Nov 2023 08:49:11 -0500
Received: from us-smtp-delivery-124.mimecast.com ([170.10.129.124])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <kwolf@redhat.com>) id 1r0MRy-0007Nj-Ja
 for qemu-devel@nongnu.org; Tue, 07 Nov 2023 08:49:06 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1699364941;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=sSv2i15i579/KCuDTINwxGQbK6Z9nfCzTYTS3zqF80o=;
 b=Yj4uWUkSuNxO0tU+SlSyWsjmWRyM6SdehvbuwMrBPo0oW9j3bO8n2C4XJwCFpC1NsdyHdI
 DdkLoH2z6rY2OwTzhpCplyPBxhx8TWHg2XOv41f5ba42YyTyOtHTEC+12xhBF58YWjCL1w
 i8S+Rx+JiMAYgt+fs7WTGEkpRR8/vFo=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-625-yxCgfQ26MVaUd7_pfQQADg-1; Tue, 07 Nov 2023 08:48:54 -0500
X-MC-Unique: yxCgfQ26MVaUd7_pfQQADg-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.rdu2.redhat.com
 [10.11.54.7])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
 (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 1569B811001
 for <qemu-devel@nongnu.org>; Tue,  7 Nov 2023 13:48:54 +0000 (UTC)
Received: from merkur.fritz.box (unknown [10.39.194.197])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 932BA1C060AE;
 Tue,  7 Nov 2023 13:48:53 +0000 (UTC)
From: Kevin Wolf <kwolf@redhat.com>
To: qemu-devel@nongnu.org
Cc: kwolf@redhat.com
Subject: [PULL 11/11] qdev: Rework array properties based on list visitor
Date: Tue,  7 Nov 2023 14:48:28 +0100
Message-ID: <20231107134828.35909-12-kwolf@redhat.com>
...
index 7fa2fdb7c9..256d9e5024 100644
...
+#include "qapi/visitor.h"
 ...
 /**
  * Property:
@@ -61,7 +62,7 @@ extern const PropertyInfo qdev_prop_size;
...
@@ -115,8 +116,6 @@ extern const PropertyInfo qdev_prop_link;
                 .bitmask    = (_bitmask),                     \
                 .set_default = false)
...
@@ -127,28 +126,46 @@ extern const PropertyInfo qdev_prop_link;
...
index 950ef48e01..4f3e1152be 100644
