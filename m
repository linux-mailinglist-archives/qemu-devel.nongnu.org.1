...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 72BA97BBBF2
	for <lists+qemu-devel@lfdr.de>; Fri,  6 Oct 2023 17:43:38 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qomyF-0006nk-2V; Fri, 06 Oct 2023 11:42:31 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <vsementsov@yandex-team.ru>)
 id 1qomy4-0006j1-Rp; Fri, 06 Oct 2023 11:42:21 -0400
Received: from forwardcorp1c.mail.yandex.net
 ([2a02:6b8:c03:500:1:45:d181:df01])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <vsementsov@yandex-team.ru>)
 id 1qomxy-0003ds-Hk; Fri, 06 Oct 2023 11:42:20 -0400
Received: from mail-nwsmtp-smtp-corp-main-62.myt.yp-c.yandex.net
 (mail-nwsmtp-smtp-corp-main-62.myt.yp-c.yandex.net
 [IPv6:2a02:6b8:c12:3a8c:0:640:ec94:0])
 by forwardcorp1c.mail.yandex.net (Yandex) with ESMTP id 7BB6D5F152;
 Fri,  6 Oct 2023 18:42:12 +0300 (MSK)
Received: from vsementsov-lin.. (unknown [2a02:6b8:b081:a512::1:22])
 by mail-nwsmtp-smtp-corp-main-62.myt.yp-c.yandex.net (smtpcorp/Yandex) with
 ESMTPSA id VfbK2W5OrKo0-iQdwooGd; Fri, 06 Oct 2023 18:42:07 +0300
X-Yandex-Fwd: 1
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=yandex-team.ru;
 s=default; t=1696606930;
 bh=t7H+rZROHdQdfmpQ18vk1+xZNWPky77B3o/zGBlmKaY=;
 h=Message-Id:Date:In-Reply-To:Cc:Subject:References:To:From;
 b=Xod3/JFLHFRVFwN1KRttKBggwC1FHa01UGGSAAFTQ5LVZLSFygVTb3eBQHVuk2xuy
 ivIpuFHP34lUGe7EeLM8HsOpVEFWz0ecSK+c062yF4KSKqyybllaEtfTfINc4ID0tF
 lS69jEXTLEmMdqgJRaevpJhawqoSlEgXtpxF1xMc=
...
Subject: [PATCH v7 15/15] python: use vm.cmd() instead of vm.qmp() where
 appropriate
Date: Fri,  6 Oct 2023 18:41:25 +0300
...
---
 ...
 44 files changed, 988 insertions(+), 1462 deletions(-)
...
index 2ffe092b31..d5dde4525e 100755
--- a/tests/qemu-iotests/tests/copy-before-write
+++ b/tests/qemu-iotests/tests/copy-before-write
@@ -49,7 +49,7 @@ class TestCbwError(iotests.QMPTestCase):
         self.vm.launch()
...
@@ -79,14 +79,12 @@ class TestCbwError(iotests.QMPTestCase):
                 }
             }
         })
-        self.assert_qmp(result, 'return', {})
...
@@ -130,14 +128,13 @@ read 1048576/1048576 bytes at offset 0
 """)
...
+        self.vm.cmd('blockdev-add', {
             ...
             'driver': 'copy-before-write',
             'on-cbw-error': on_cbw_error,
@@ -161,14 +158,12 @@ read 1048576/1048576 bytes at offset 0
                 }
             }
         })
-        self.assert_qmp(result, 'return', {})
