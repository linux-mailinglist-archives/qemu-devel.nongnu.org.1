...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A110ABC2A1
	for <lists+qemu-devel@lfdr.de>; Mon, 19 May 2025 17:38:07 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1uH2Ym-0006mC-MJ; Mon, 19 May 2025 11:37:48 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <alireza.sanaee@huawei.com>)
 id 1uH2Yj-0006kn-OY; Mon, 19 May 2025 11:37:45 -0400
Received: from [185.176.79.56] (helo=frasgout.his.huawei.com)
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <alireza.sanaee@huawei.com>)
 id 1uH2Yg-0007Qr-CS; Mon, 19 May 2025 11:37:44 -0400
Received: from mail.maildlp.com (unknown [172.18.186.31])
 by frasgout.his.huawei.com (SkyGuard) with ESMTP id 4b1MDk5wNbz6L4t7;
 Mon, 19 May 2025 23:34:30 +0800 (CST)
Received: from frapeml500003.china.huawei.com (unknown [7.182.85.28])
 by mail.maildlp.com (Postfix) with ESMTPS id 314E1140136;
 Mon, 19 May 2025 23:37:36 +0800 (CST)
Received: from a2303103017.china.huawei.com (10.203.177.99) by
 frapeml500003.china.huawei.com (7.182.85.28) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.39; Mon, 19 May 2025 17:37:35 +0200
...
Subject: [PATCH v11 2/6] arm/virt.c: add cache hierarchy to device tree
Date: Mon, 19 May 2025 16:36:28 +0100
Message-ID: <20250519153632.537-3-alireza.sanaee@huawei.com>
...
index a96452f17a..cc1ab28622 100644
--- a/hw/arm/virt.c
+++ b/hw/arm/virt.c
...
+
 ...
 {
     struct {
@@ -421,13 +547,105 @@ static void fdt_add_timer_nodes(const VirtMachineState *vms)
     }
 }
...
@@ -456,9 +674,14 @@ static void fdt_add_cpu_nodes(const VirtMachineState *vms)
...
@@ -488,6 +711,137 @@ static void fdt_add_cpu_nodes(const VirtMachineState *vms)
...
@@ -3193,6 +3547,11 @@ static void virt_machine_class_init(ObjectClass *oc, void *data)
...
index 495a5c30ff..ed1184d3fa 100644
--- a/hw/cpu/core.c
+++ b/hw/cpu/core.c
...
index c8e94e6aed..fedd949804 100644
...
+
 enum {
     VIRT_FLASH,
     VIRT_MEM,
@@ -189,6 +192,8 @@ OBJECT_DECLARE_TYPE(VirtMachineState, VirtMachineClass, VIRT_MACHINE)
...
index 98ab91647e..8e69170c4e 100644
