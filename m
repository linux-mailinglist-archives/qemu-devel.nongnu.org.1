...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 5BA61933BF2
	for <lists+qemu-devel@lfdr.de>; Wed, 17 Jul 2024 13:12:39 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1sU2TT-0005pF-Nh; Wed, 17 Jul 2024 07:05:31 -0400
...
Subject: [PATCH v2 5/8] hw/display/apple-gfx: Replaces magic number with
 queried MMIO length
Date: Wed, 17 Jul 2024 13:03:23 +0200
Message-Id: <20240717110326.45230-6-phil@philjordan.eu>
