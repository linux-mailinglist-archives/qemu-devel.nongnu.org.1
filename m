...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id BCBA27187C5
	for <lists+qemu-devel@lfdr.de>; Wed, 31 May 2023 18:51:04 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1q4P1h-0004QA-6z; Wed, 31 May 2023 12:50:21 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <ldoktor@redhat.com>)
 id 1q4P1d-0004PF-KY
 for qemu-devel@nongnu.org; Wed, 31 May 2023 12:50:18 -0400
Received: from us-smtp-delivery-124.mimecast.com ([170.10.129.124])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <ldoktor@redhat.com>)
 id 1q4P1a-0001Xj-By
 for qemu-devel@nongnu.org; Wed, 31 May 2023 12:50:17 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1685551811;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
 bh=w16UyU+IhcU8xf377fzMdgcZawVWSImJIrV4yNcR+DY=;
 b=ZNrF2zIzCpJOSm491TvYw/hYjVRA/ymkjvhW01NqCznwhDGfqmLMtJUlGIV0WAUqrUkQUt
 L19zo1OtKgMYDslRqmi+X2mOnPADn5lPW3EfaQaCcDq47ojn/j6OdgvEFt3PsP90tq9PmY
 SHz18vNz/uKoAKmraja+VjSjnFkyvkg=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-65-NW4agkprONOBt_mU4lIHXA-1; Wed, 31 May 2023 12:50:07 -0400
X-MC-Unique: NW4agkprONOBt_mU4lIHXA-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.rdu2.redhat.com
 [10.11.54.5])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id C934A8030DE;
 Wed, 31 May 2023 16:50:06 +0000 (UTC)
Received: from [10.45.224.6] (unknown [10.45.224.6])
 by smtp.corp.redhat.com (Postfix) with ESMTP id D3EB4421C5;
 Wed, 31 May 2023 16:50:05 +0000 (UTC)
Message-ID: <3584ed8c-e60c-54bd-1abe-8294e985119a@redhat.com>
Date: Wed, 31 May 2023 18:50:05 +0200
MIME-Version: 1.0
...
Content-Type: multipart/signed; micalg=pgp-sha256;
 ...
 boundary="------------nIRy3KDV1mypVewm1JeNd6if"
...
--------------nIRy3KDV1mypVewm1JeNd6if
Content-Type: multipart/mixed; boundary="------------endwfmiarNAusXDcuFZcPUfL";
...
--------------endwfmiarNAusXDcuFZcPUfL
Content-Type: multipart/mixed; boundary="------------cu9Aj12B0yhgIHCq0XDVZyAb"

--------------cu9Aj12B0yhgIHCq0XDVZyAb
...
st poll handlers - as a performance improvement when using multiple concu=
rrent jobs and 4k (22%) as well as 1024k (63%) blocks on aarch64 (on a sl=
ow rotational disk).
>>>>
...
ovement just not in read but rather in write instead and only for 4k bloc=
ks (~40%). For 1024k blocks I can see it scoring a bit better (~1.5%). Re=
ads are too jittery to really tell anything on that machine. Anyway I hav=
e not done any thorough testing, just a bisection with the most significa=
nt setting.
>>
>> From around the same time I can see a NVMe regression in 4k writes, bu=
t first bisection job showed nothing. I'll increase the range and try aga=
...
rites with jobs=3D10 and iodepth=3D4 I can see a 50% regression on my mac=
hine:
...

=B6Yl
-----END PGP SIGNATURE-----
