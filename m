...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 92498AABDE5
	for <lists+qemu-devel@lfdr.de>; Tue,  6 May 2025 10:55:03 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1uCE42-0004Oi-6c; Tue, 06 May 2025 04:54:10 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <cohuck@redhat.com>) id 1uCE3o-00044d-Tw
 for qemu-devel@nongnu.org; Tue, 06 May 2025 04:53:57 -0400
Received: from us-smtp-delivery-124.mimecast.com ([170.10.133.124])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <cohuck@redhat.com>) id 1uCE3k-0007NJ-PE
 for qemu-devel@nongnu.org; Tue, 06 May 2025 04:53:56 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1746521632;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=MmnHQurDVEs7robD8ogcm+XHMiDb/AL1eMmLr2j7O1A=;
 b=Hb+WKrleyAjZ6jHT+4E6kAz6tECxYJF/SMOJeDYB2R0k5iKuVIIaSx0vkQCZxRFqEVv5KN
 7UDID36pZhylN/Tf83cd9i6kSLUi2mcEWv/lD+kJJqZkGbil2DwslaEUo/Z1o/w8QUXV8J
 3fCtRDnJjzHl7FLkdIvUstQJgSPj/lI=
Received: from mx-prod-mc-04.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-214-jztBxgFpPKCF5TJ-_u4iKg-1; Tue,
 06 May 2025 04:53:47 -0400
X-MC-Unique: jztBxgFpPKCF5TJ-_u4iKg-1
X-Mimecast-MFC-AGG-ID: jztBxgFpPKCF5TJ-_u4iKg_1746521624
Received: from mx-prod-int-02.mail-002.prod.us-west-2.aws.redhat.com
 ...
 id 5A49D1955D5D; Tue,  6 May 2025 08:53:44 +0000 (UTC)
Received: from gondolin.str.redhat.com (dhcp-192-216.str.redhat.com
 [10.33.192.216])
 by mx-prod-int-02.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP
 id C0E4C1956094; Tue,  6 May 2025 08:53:37 +0000 (UTC)
...
Subject: [PATCH v6 08/14] arm/cpu: Store id_isar0-7 into the idregs array
Date: Tue,  6 May 2025 10:52:28 +0200
Message-ID: <20250506085234.855779-9-cohuck@redhat.com>
...
index 83ff74f899f6..fdb7f58e3678 100644
...
index 2622f8748199..4e785970286c 100644
--- a/target/arm/cpu.c
+++ b/target/arm/cpu.c
@@ -2134,10 +2134,10 @@ static void arm_cpu_realizefn(DeviceState *dev, Error **errp)
...
@@ -2189,20 +2189,20 @@ static void arm_cpu_realizefn(DeviceState *dev, Error **errp)
...
+        SET_IDREG(isar, ID_ISAR6, u);
         ...
         if (!arm_feature(env, ARM_FEATURE_M)) {
             u = cpu->isar.mvfr1;
@@ -2240,19 +2240,17 @@ static void arm_cpu_realizefn(DeviceState *dev, Error **errp)
...
index e8f2fd14e874..9d071fabb3c8 100644
--- a/target/arm/cpu.h
+++ b/target/arm/cpu.h
@@ -1053,13 +1053,6 @@ struct ArchCPU {
...
index ce8cf45dd44f..1df5db6c3647 100644
...
index 1f540d5e7fdd..0e4adc4f9ba6 100644
--- a/target/arm/helper.c
+++ b/target/arm/helper.c
@@ -7832,32 +7832,32 @@ void register_cp_regs_for_features(ARMCPU *cpu)
...
+              .resetvalue = GET_IDREG(isar, ID_ISAR5) },
             { .name = "ID_MMFR4", .state = ARM_CP_STATE_BOTH,
               ...
               .access = PL1_R, .type = ARM_CP_CONST,
@@ -7867,7 +7867,7 @@ void register_cp_regs_for_features(ARMCPU *cpu)
...
index 9fdfbd4c4458..7b1aa01ae05c 100644
--- a/target/arm/kvm.c
+++ b/target/arm/kvm.c
@@ -385,22 +385,15 @@ static bool kvm_arm_get_host_cpu_features(ARMHostCPUFeatures *ahcf)
...
index b34b65785740..c22ce7aa498f 100644
...
index 2c45b7eddda7..937a72b12c9b 100644
...
index 80b1196aae93..283739bfcf0f 100644
