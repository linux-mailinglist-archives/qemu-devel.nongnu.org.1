...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C31875ABC0
	for <lists+qemu-devel@lfdr.de>; Thu, 20 Jul 2023 12:14:51 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1qMQfa-0006oo-B7; Thu, 20 Jul 2023 06:14:03 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mail@maciej.szmigiero.name>)
 id 1qMQfW-0006na-JX
 for qemu-devel@nongnu.org; Thu, 20 Jul 2023 06:13:58 -0400
Received: from vps-vb.mhejs.net ([37.28.154.113])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <mail@maciej.szmigiero.name>)
 id 1qMQfR-0003cT-MS
 for qemu-devel@nongnu.org; Thu, 20 Jul 2023 06:13:57 -0400
Received: from MUA by vps-vb.mhejs.net with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <mail@maciej.szmigiero.name>)
 id 1qMQfL-0003cR-0E; Thu, 20 Jul 2023 12:13:47 +0200
...
Subject: [PATCH v6 6/6] Add a Hyper-V Dynamic Memory Protocol driver
 (hv-balloon)
Date: Thu, 20 Jul 2023 12:13:03 +0200
Message-ID: <8dfecd08927f2363c54918deba57b4185917d812.1689786474.git.maciej.szmigiero@oracle.com>
...
---
 ...
 10 files changed, 2345 insertions(+), 1 deletion(-)
...
index 000000000000..a8350844de1e
--- /dev/null
...
+        }
+
+        name = g_strdup_printf(name, "memslot-%u", idx);
...
+}
+
+static OurRangeMemslots *our_range_memslots_new(uint64_t addr,
...
+}
+
+static void our_range_memslots_free(OurRangeMemslots *our_range)
+{
+    OurRangeMemslotsSlots *memslots = &our_range->slots;
...
+}
+
+G_DEFINE_AUTOPTR_CLEANUP_FUNC(OurRangeMemslots, our_range_memslots_free)
+
+static void our_range_memslots_ensure_mapped(OurRangeMemslots *our_range,
+                                             uint64_t map_size)
+{
+    OurRangeMemslotsSlots *memslots = &our_range->slots;
+    unsigned int idx;
...
+
+    /*
+     * Activate all memslots covered by the newly added region in a single transaction.
+     */
+    memory_region_transaction_begin();
+    for ( ; idx < memslots->count;
+          idx++, offset += memslots->size_each) {
+        /*
+         * If this memslot starts beyond or at the end of the range to map so does
+         * every next one.
+         */
+        if (offset >= map_size) {
+            break;
...
+        assert(!memory_region_is_mapped(&memslots->slots[idx]));
+        memory_region_add_subregion(our_range->mr, offset, &memslots->slots[idx]);
+
...
+
+    our_range_memslots = our_range_memslots_new(balloon->addr,
...
+    }
+
+    our_range_memslots_ensure_mapped(balloon->our_range,
+                                     (our_range->added + hot_add_range->count) *
...
+{
+    g_clear_pointer(&balloon->our_range, our_range_memslots_free);
+}
+
...
+}
+
+static void hv_balloon_set_suggested_memslot_limit(MemoryDeviceState *md,
+                                                   unsigned int limit)
+{
+    HvBalloon *balloon = HV_BALLOON(md);
+    MemoryRegion *hostmem_mr;
...
+    mdc->set_suggested_memslot_limit = hv_balloon_set_suggested_memslot_limit;
...
index b4c35ca8e377..7963c215b1c5 100644
...
index 3109d5e0e035..75453136a2e4 100644
--- a/hw/i386/pc.c
+++ b/hw/i386/pc.c
@@ -28,6 +28,7 @@
...
@@ -1491,6 +1493,21 @@ static void pc_memory_unplug(HotplugHandler *hotplug_dev,
...
+
 static void pc_machine_device_pre_plug_cb(HotplugHandler *hotplug_dev,
                                           DeviceState *dev, Error **errp)
 {
@@ -1521,6 +1538,8 @@ static void pc_machine_device_pre_plug_cb(HotplugHandler *hotplug_dev,
             return;
         }
         pcms->iommu = dev;
...
@@ -1533,6 +1552,8 @@ static void pc_machine_device_plug_cb(HotplugHandler *hotplug_dev,
...
@@ -1574,6 +1595,7 @@ static HotplugHandler *pc_get_hotplug_handler(MachineState *machine,
...
index 5fcdb37a7136..c0242ca4e0a7 100644
--- a/meson.build
+++ b/meson.build
@@ -1340,6 +1340,30 @@ if not get_option('glusterfs').auto() or have_block
   endif
 endif
...
@@ -4299,6 +4324,7 @@ if targetos == 'windows'
 endif
...
index bbb5c7e88634..1f6dcd44db57 100644
--- a/meson_options.txt
+++ b/meson_options.txt
...
index 7dd5709ef40e..7043c4bfbff3 100644
--- a/scripts/meson-buildoptions.sh
+++ b/scripts/meson-buildoptions.sh
@@ -111,6 +111,7 @@ meson_options_help() {
...
@@ -316,6 +317,8 @@ _meson_option_parse() {
