...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id D3A1FA91831
	for <lists+qemu-devel@lfdr.de>; Thu, 17 Apr 2025 11:42:41 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1u5LlG-0007oe-I6; Thu, 17 Apr 2025 05:42:22 -0400
...
Received: from mail-pl1-x62a.google.com ([2607:f8b0:4864:20::62a])
 ...
 (Exim 4.90_1) (envelope-from <akihiko.odaki@daynix.com>)
 id 1u5Ll4-0007wg-9C
 for qemu-devel@nongnu.org; Thu, 17 Apr 2025 05:42:14 -0400
Received: by mail-pl1-x62a.google.com with SMTP id
 d9443c01a7336-224019ad9edso9223225ad.1
 for <qemu-devel@nongnu.org>; Thu, 17 Apr 2025 02:42:09 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=daynix-com.20230601.gappssmtp.com; s=20230601; t=1744882928; x=1745487728;
 darn=nongnu.org; 
 h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
 :mime-version:subject:date:from:from:to:cc:subject:date:message-id
 :reply-to; bh=s1uVPVljvkIQtNRusqALXRBIbeVKCABhO+qziJGICvQ=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1744882928; x=1745487728;
 h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
 :mime-version:subject:date:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=s1uVPVljvkIQtNRusqALXRBIbeVKCABhO+qziJGICvQ=;
 b=
X-Gm-Message-State: AOJu0YytR7RUEQMLNpUaCNJiz4cfBdIq+b1nfy75pIjZT/lccWCqfSRb
 qUM4STfbcihkLdL0ZhOCASBEGfdU7gcGug+V4/RkaoK05cxh5WiQnpdY1X1vcxjgR8dNWRRi7lx
 V5Q0=
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IE0HC6sH3FudWShtaubfUq/hvVBX1rQ2kvIJOpp3Uqj9c7RwTm8bVdEITz5WDw8djos1VeXyQ==
X-Received: by 2002:a17:903:41cd:b0:220:d078:eb33 with SMTP id
 d9443c01a7336-22c3596f812mr72821985ad.36.1744882927895; 
 Thu, 17 Apr 2025 02:42:07 -0700 (PDT)
Received: from localhost ([2400:4050:b783:b00:9e36:5f4c:928c:4ec2])
 by smtp.gmail.com with UTF8SMTPSA id
 d9443c01a7336-22c33fccafcsm29111135ad.205.2025.04.17.02.42.06
 (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
 Thu, 17 Apr 2025 02:42:07 -0700 (PDT)
From: Akihiko Odaki <akihiko.odaki@daynix.com>
Date: Thu, 17 Apr 2025 18:42:00 +0900
Subject: [PATCH 1/2] ui/vnc: Introduce the VncWorker type
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20250417-zlib-v1-1-34fad73b843b@daynix.com>
...
index 9241caaad96b..ce0538f3654f 100644
--- a/ui/vnc.c
+++ b/ui/vnc.c
@@ -1308,8 +1308,6 @@ static void vnc_disconnect_start(VncState *vs)
...
@@ -1352,18 +1350,13 @@ void vnc_disconnect_finish(VncState *vs)
     }
...
@@ -2133,8 +2126,8 @@ static void set_encodings(VncState *vs, int32_t *encodings, size_t n_encodings)
...
+                vs->worker->tight.quality = (enc & 0x0F);
             ...
             break;
         default:
@@ -2965,7 +2958,7 @@ void vnc_sent_lossy_rect(VncState *vs, int x, int y, int w, int h)
...
@@ -2988,11 +2981,11 @@ static int vnc_refresh_lossy_rect(VncDisplay *vd, int x, int y)
             continue;
         }
...
@@ -3244,11 +3237,9 @@ static void vnc_connect(VncDisplay *vd, QIOChannelSocket *sioc,
 {
...
@@ -3256,23 +3247,23 @@ static void vnc_connect(VncDisplay *vd, QIOChannelSocket *sioc,
...
@@ -3289,11 +3280,6 @@ static void vnc_connect(VncDisplay *vd, QIOChannelSocket *sioc,
