...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id D85C3AC017A
	for <lists+qemu-devel@lfdr.de>; Thu, 22 May 2025 02:44:28 +0200 (CEST)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1uHu2F-0006HO-0J; Wed, 21 May 2025 20:43:47 -0400
Received: from eggs.gnu.org ([2001:470:142:3::10])
 by lists.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
 (Exim 4.90_1) (envelope-from <alistair23@gmail.com>)
 id 1uHu2A-0006Gq-TT; Wed, 21 May 2025 20:43:43 -0400
Received: from mail-vk1-xa2c.google.com ([2607:f8b0:4864:20::a2c])
 by eggs.gnu.org with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
 (Exim 4.90_1) (envelope-from <alistair23@gmail.com>)
 id 1uHu25-0006JN-NH; Wed, 21 May 2025 20:43:42 -0400
Received: by mail-vk1-xa2c.google.com with SMTP id
 71dfb90a1353d-5240764f7c1so2201686e0c.2; 
 Wed, 21 May 2025 17:43:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1747874616; x=1748479416; darn=nongnu.org;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:from:to:cc:subject:date
 :message-id:reply-to;
 bh=S02YQpe32mGKRJj1bsi87bYDcL3Pjdq5Z7mgH3DR1AI=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1747874616; x=1748479416;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=S02YQpe32mGKRJj1bsi87bYDcL3Pjdq5Z7mgH3DR1AI=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCVmq7/avk4fc0XvJD/qYsZYmNCb+damQGHlgc+QRtLkU1yJu/HAb9G6biEVpHexSOO41OOWsWZ2sJX9@nongnu.org
X-Gm-Message-State: AOJu0Yyig76dm6Ooi9PAnujMvezJOILAEqHC0A7V4MOD6igXVAQjRRw0
 HoRwltt74iL9x4Atc7/n46XEVMHtxuhCGEF4/RlIf0bt5B2ta52rFWhE67+XIVgnKsiYDVyqrOG
 DBIsMxQzcPvbufUMqxwWhtc5DpLHbV/U=
X-Gm-Gg: ASbGnct7y2jWn2OKIutWVxMRfwncbaWctMpdEHyigKuwFax4kq9I8Xm+D1+Op5uVkts
 X81xLLZ7PL72myF51+Ovl/84C8etHcBAfVMAybIl8ZSoSs92n5BJ+ERIgoxJvI0PSKDFGVy94yu
 CtXs5g2S1maP+6RyczxNEVg7hzpiiC276Ee35668jRDQNJvH6QZfr/XHqHXfF82eg=
X-Google-Smtp-Source: AGHT+IHwSyJxkf8IcruO0HT1fzAB6XtX7NBXmmZw+AgJ/MP7Vs4AtWq8ng5zdQ1K5+xAzQSY6ylSCaxJlEdCtvmZhDc=
X-Received: by 2002:a05:6122:1d48:b0:529:1a6a:cd48 with SMTP id
 71dfb90a1353d-52dba964347mr22793576e0c.6.1747874615508; Wed, 21 May 2025
 17:43:35 -0700 (PDT)
MIME-Version: 1.0
References: <20250312093735.1517740-1-ethan84@andestech.com>
 <20250312093735.1517740-7-ethan84@andestech.com>
In-Reply-To: <20250312093735.1517740-7-ethan84@andestech.com>
From: Alistair Francis <alistair23@gmail.com>
Date: Thu, 22 May 2025 10:43:09 +1000
X-Gm-Features: AX0GCFtFveEy-sgtClO7oe4-Rx4F2zoEFb7EUJvYr5p9nQM9PU92Gv98xD6E4yI
Message-ID: <CAKmqyKPo8OcbbOGZzR329tSKOe7GoFCDngHoxuUqX_zdZ8Bvfw@mail.gmail.com>
...
On Wed, Mar 12, 2025 at 7:41=E2=80=AFPM Ethan Chen via <qemu-devel@nongnu.o=
rg> wrote:
>
...
v10 of the series supported v0.9.2RC3 [1], why is this now 0.7?

We should be targeting the latest version of a draft spec

1: https://patchew.org/QEMU/20250122083617.3940240-1-ethan84@andestech.com/=
...
> +        rz =3D FIELD_DP32(rz, VERSION, SPECVER, SPECVER_0_7_0);
> +        break;
...
> +static inline void apply_extend_perms(RISCVIOPMPState *s, int rrid, int =
md,
> +                                      int *cfg)
> +{
> +    if (s->sps_en) {
...
> +}
> +
> +static inline bool addr_in_entry(RISCVIOPMPState *s, hwaddr addr, int id=
x)
> +{
> +    return addr >=3D s->entry_addr[idx].sa && addr <=3D s->entry_addr[id=
x].ea;
> +}
> +
> +/*
...
> + * iopmp_tlb_size: If the entire TLB shares the same permission, the val=
ue is
> + *                 set to TARGET_PAGE_SIZE, indicating that the cached
> + *                 translation result can be reused. Otherwise, the valu=
e is 1,
> + *                 meaning the address must be translated for each acces=
s.
> + */
> +static IOPMPEntryHit match_entry_range(RISCVIOPMPState *s, int rrid,
> +                                       GSList *entry_range_list, hwaddr =
addr,
> +                                       hwaddr sa, hwaddr ea,
...
> +{
> +    EntryRange *range;
> +    IOPMPEntryHit result =3D IOPMP_ENTRY_NO_HIT;
...
> +    int curr_cfg;
> +    /*
> +     * Although a transaction may require multiple TLBs, consider the TL=
B of
> +     * the current translated address instead of the transaction's start=
 and
> +     * end address.
> +     */
...
> +        range =3D (EntryRange *)entry_range_list->data;
...
> +                        ((s->entry_addr[i].sa >=3D tlb_sa &&
> +                          s->entry_addr[i].sa <=3D tlb_ea) ||
> +                         (s->entry_addr[i].ea >=3D tlb_sa &&
> +                          s->entry_addr[i].ea <=3D tlb_ea))) {
> +                        /*
> +                         * A higher-priority entry exists within the TLB=
 page
> +                         * but does not cover the entire page. This mean=
s
> +                         * that at least two kinds of permissions are pr=
esent
> +                         * within the TLB page.
> +                         */
> +                        *iopmp_tlb_size =3D 1;
...
> +                    if (*iopmp_tlb_size !=3D 1 && addr_in_entry(s, tlb_s=
a, i) &&
...
> +                        }
> +                    }
> +                    if ((*cfg & 0x7) =3D=3D 0x7 && *iopmp_tlb_size =3D=
=3D 1) {
> +                        /*
> +                         * Already have RWX permission and a higher prio=
rity
...
> +        }
> +    }
> +    result =3D match_entry_range(s, rrid, entry_range_list, addr, start_=
addr,
> +                               end_addr, match_entry_idx, cfg, iopmp_tlb=
_size);
...
> +        end_addr =3D addr;
> +    }
> +    result =3D match_entry_srcmd(s, rrid, addr, start_addr, end_addr, &e=
ntry_idx,
...
> +    result =3D match_entry_srcmd(s, rrid, addr, start_addr, end_addr,
> +                               &entry_idx, &match_cfg,
> +                               &iopmp_tlb_size);
> +    if (result =3D=3D IOPMP_ENTRY_HIT) {
...
> +                                  IOPMP_ACCESS_FETCH);
> +    }
> +    /* Use read reaction for fetch if chk_x =3D=3D 0 */
> +    return iopmp_handle_block(opaque, addr, pdata, size, attrs,
> +                              IOPMP_ACCESS_READ);
> +}
> +
...
> +    }
> +
> +    s->regs.entry =3D g_malloc0(s->entry_num * sizeof(RISCVIOPMPEntryReg=
s));
> +    s->entry_addr =3D g_malloc0(s->entry_num * sizeof(RISCVIOPMPEntryAdd=
r));
...
> +                            size_t len, bool eop)
> +{
> +    RISCVIOPMPStreamSink *ss =3D RISCV_IOPMP_STREAMSINK(txn_info_sink);
> +    RISCVIOPMPState *s =3D RISCV_IOPMP(container_of(ss, RISCVIOPMPState,
> +                                      txn_info_sink));
> +    RISCVIOPMPTxnInfo *signal;
> +    uint32_t rrid;
> +
> +    if (len !=3D sizeof(RISCVIOPMPTxnInfo)) {
> +        return 0;
> +    }
> +    signal =3D (RISCVIOPMPTxnInfo *)buf;
> +    rrid =3D signal->rrid;
> +
> +    if (s->transaction_state[rrid].running) {
> +        if (eop) {
...
> +    .instance_size =3D sizeof(RISCVIOPMPStreamSink),
...
> @@ -395,3 +395,7 @@ ivshmem_flat_interrupt_peer(uint16_t peer_id, uint16_=
t vector_id) "Interrupting
...
> +
> +/*
> + * Transaction(txn) information to identify whole transaction length, en=
abling
...
> +
> +    /*
> +     * AddressSpace for full permission and no requirements forward tran=
saction
