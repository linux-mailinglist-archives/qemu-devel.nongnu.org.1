...
Received: from lists.gnu.org (lists.gnu.org [209.51.188.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 29F72809F0B
	for <lists+qemu-devel@lfdr.de>; Fri,  8 Dec 2023 10:15:31 +0100 (CET)
Received: from localhost ([::1] helo=lists1p.gnu.org)
	by lists.gnu.org with esmtp (Exim 4.90_1)
	(envelope-from <qemu-devel-bounces@nongnu.org>)
	id 1rBWvw-00014W-9T; Fri, 08 Dec 2023 04:14:08 -0500
...
Received: from mail.loongson.cn ([114.242.206.163])
 ...
 (envelope-from <gaosong@loongson.cn>) id 1rBWvb-0008EW-Oy
 for qemu-devel@nongnu.org; Fri, 08 Dec 2023 04:13:51 -0500
Received: from loongson.cn (unknown [10.2.5.185])
 by gateway (Coremail) with SMTP id _____8Dx_7tD3nJlouw_AA--.3315S3;
 Fri, 08 Dec 2023 17:13:39 +0800 (CST)
Received: from localhost.localdomain (unknown [10.2.5.185])
 by localhost.localdomain (Coremail) with SMTP id
 AQAAf8AxH91A3nJlrE5YAA--.822S3; 
 Fri, 08 Dec 2023 17:13:38 +0800 (CST)
From: Song Gao <gaosong@loongson.cn>
To: qemu-devel@nongnu.org
Cc: richard.henderson@linaro.org, philmd@linaro.org, peter.maydell@linaro.org,
 maobibo@loongson.cn
Subject: [PATCH v1 01/17] hw/loongarch: Move boot fucntions to boot.c
Date: Fri,  8 Dec 2023 17:00:26 +0800
Message-Id: <20231208090042.2672425-2-gaosong@loongson.cn>
...
X-CM-TRANSID: AQAAf8AxH91A3nJlrE5YAA--.822S3
...
index 4b7dc67a2d..05e70ef3ae 100644
--- a/hw/loongarch/virt.c
+++ b/hw/loongarch/virt.c
@@ -376,31 +376,6 @@ static void memmap_add_entry(uint64_t address, uint64_t length, uint32_t type)
     memmap_entries++;
 }
...
-
 ...
 {
     DeviceState *dev;
@@ -668,69 +643,6 @@ static void loongarch_firmware_init(LoongArchMachineState *lams)
...
@@ -750,7 +662,6 @@ static void loongarch_init(MachineState *machine)
...
@@ -844,24 +755,8 @@ static void loongarch_init(MachineState *machine)
...
@@ -886,6 +781,9 @@ static void loongarch_init(MachineState *machine)
     fdt_base = 1 * MiB;
